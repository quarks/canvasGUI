...
a.uPMatrix.set(g);b.enable(b.DEPTH_TEST);this._p.pop()}}static announce(){GUI._announced||(console.log("================================================"),console.log(`  canvasGUI (${CANVAS_GUI_VERSION})   \u00A9 2023 Peter Lager`),console.log("================================================"),GUI._announced=!0)}static get(a,b=p5.instance){GUI.announce();if(GUI._guis[b])return GUI._guis[b];let c=new GUI(a,b);c._name=a.toString();return GUI._guis[b]=c}static getNamed(a,b,c=p5.instance){GUI.announce();
if(GUI._guis[a])return GUI._guis[a];c=new GUI(b,c);c._name=b.toString();return GUI._guis[a]=c}}GUI._guis={};GUI._announced=!1;
...
break;case "mousemove":this._active&&(c=this._norm01(c-10,0,this._buffer.width-20),this._s2ticks&&(c=this._nearestTickT(c)),this._t01!=c&&(this._t01=c,this.action({source:this,p5Event:a,value:this.value(),final:!1})),this.invalidateBuffer())}return!1}_handleTouch(a){var b=this.getAbsXY();const c=this._gui._canvas.getBoundingClientRect();var d=a.changedTouches[0];let e=d.clientX-c.left-b.x;b=d.clientY-c.top-b.y;b=this._orientation.xy(e,b,this._w,this._h);e=b.x;b=b.y;this._pover=this._over;this._over=
this._whereOver(e,b,20);this._bufferInvalid=this._bufferInvalid||this._pover!=this._over;console.log(`##  ${this._name} Touch type: ${a.type}      Touch # "${d.identifier}"  at  [${e}, ${b}]   over ${this._over} }`);switch(a.type){case "touchstart":0<this._over&&(this._active=!0,this.invalidateBuffer());break;case "touchend":this._active&&(this.action({source:this,p5Event:a,value:this.value(),final:!0}),this._active=!1,this.invalidateBuffer());break;case "touchmove":this._active&&(d=this._norm01(e-
10,0,this._buffer.width-20),this._s2ticks&&(d=this._nearestTickT(d)),this._t01!=d&&(this._t01=d,this.action({source:this,p5Event:a,value:this.value(),final:!1})),this.invalidateBuffer())}}_nearestTickT(a){let b=0<this._minorTicks?this._minorTicks*this._majorTicks:this._majorTicks;return 0<b?Math.round(a*b)/b:a}_updateControlVisual(){let a=this._buffer,b=this._scheme||this._gui.scheme();var c=a.width-20,d=b.COLOR_3,e=b.GREY_9;const f=b.GREY_6,g=b.GREY_1,h=b.COLOR_14,k=b.COLOR_10;a.push();a.clear();
...
a.stroke(h);a.rect(c-6,-6,12,12,this._c[0],this._c[1],this._c[2],this._c[3]);this._enabled||this._disable_hightlight(a,b,0,-this._h/2,this._w-20,this._h);a.pop();a.updatePixels();this._bufferInvalid=!1}_minControlSize(){return{w:this._w,h:20}}}
...
this._s2ticks&&(c=this._nearestTickT(c)),this._t[this._tIdx]!=c&&(this._t[this._tIdx]=c,c=Math.max(this._t[0],this._t[1]),this.action({source:this,p5Event:a,low:this._t2v(Math.min(this._t[0],this._t[1])),high:this._t2v(c),final:!1})),this.invalidateBuffer())}return!1}_handleTouch(a){var b=this.getAbsXY();const c=this._gui._canvas.getBoundingClientRect(),d=a.changedTouches[0];var e=d.clientX-c.left-b.x;b=d.clientY-c.top-b.y;b=this._orientation.xy(e,b,this._w,this._h);e=b.x;b=b.y;this._pover=this._over;
this._over=this._whereOver(e,b,20);this._tIdx=this._active?this._tIdx:this._over-1;this._bufferInvalid=this._bufferInvalid||this._pover!=this._over;this._tooltip&&this._tooltip._updateState(this,this._pover,this._over);switch(a.type){case "touchstart":0<this._over&&(this._active=!0,this._tIdx=this._over-1,this.invalidateBuffer());break;case "touchend":this._active&&(e=Math.min(this._t[0],this._t[1]),b=Math.max(this._t[0],this._t[1]),this._t[0]=e,this._t[1]=b,this._tIdx=-1,this.action({source:this,
p5Event:a,low:this._t2v(e),high:this._t2v(b),final:!0}),this._active=!1,this.invalidateBuffer());break;case "touchmove":this._active&&(e=this._norm01(e-10,0,this._buffer.width-20),this._s2ticks&&(e=this._nearestTickT(e)),this._t[this._tIdx]!=e&&(this._t[this._tIdx]=e,e=Math.max(this._t[0],this._t[1]),this.action({source:this,p5Event:a,low:this._t2v(Math.min(this._t[0],this._t[1])),high:this._t2v(e),final:!1})),this.invalidateBuffer())}}_updateControlVisual(){let a=this._buffer,b=this._scheme||this._gui.scheme(),
