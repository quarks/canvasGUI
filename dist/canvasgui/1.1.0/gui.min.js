...
d,e))}option(a,b,c,d,e){return this.addControl(new CvsOption(this,a,b,c,d,e))}label(a,b,c,d,e){return this.addControl(new CvsLabel(this,a,b,c,d,e))}viewer(a,b,c,d,e){return this.addControl(new CvsViewer(this,a,b,c,d,e))}joystick(a,b,c,d,e){return this.addControl(new CvsJoystick(this,a,b,c,d,e))}knob(a,b,c,d,e){return this.addControl(new CvsKnob(this,a,b,c,d,e))}__scroller(a,b,c,d,e){return this.addControl(new CvsScroller(this,a,b,c,d,e))}__tooltip(a){return this.addControl(new CvsTooltip(this,a))}pane(a,
b,c){switch(b){case "north":a=new CvsPaneNorth(this,a,c);break;case "south":a=new CvsPaneSouth(this,a,c);break;case "west":a=new CvsPaneWest(this,a,c);break;default:a=new CvsPaneEast(this,a,c)}return this.addControl(a)}grid(a,b,c,d){return new GridLayout(a,b,c,d)}name(){return this._name}show(){this._visible=!0;return this}hide(){this._visible=!1;return this}isVisible(){return this._visible}enable(){this._enabled=!0;return this}disable(){this._enabled=!1;return this}isEnabled(){return this._enabled}stopEventHandling(){this._eventsAllowed=
!1}startEventHandling(){this._eventsAllowed=!0}_addFocusHandlers(){let a=this._canvas;a.addEventListener("focusout",b=>{this._handleFocusEvents(b)});a.addEventListener("focusin",b=>{this._handleFocusEvents(b)})}_addMouseEventHandlers(){if(!this._mouseEventsEnabled){let a=this._canvas;a.addEventListener("mousemove",b=>{this._handleMouseEvents(b)});a.addEventListener("mousedown",b=>{this._handleMouseEvents(b)});a.addEventListener("mouseup",b=>{this._handleMouseEvents(b)});a.addEventListener("wheel",
b=>{this._handleMouseEvents(b)});a.addEventListener("mouseout",b=>{this._handleMouseEvents(b)});a.addEventListener("mouseenter",b=>{this._handleMouseEvents(b)});this._mouseEventsEnabled=!0}}_addKeyEventHandlers(){this._keyEventsEnabled||(this._target.setAttribute("tabindex","0"),this._target.focus(),this._target.addEventListener("keydown",a=>{this._handleKeyEvents(a);return!1}),this._target.addEventListener("keyup",a=>{this._handleKeyEvents(a);return!1}),this._keyEventsEnabled=!0)}_addTouchEventHandlers(){if(!this._touchEventsEnabled){let a=
this._canvas;a.addEventListener("touchstart",b=>{this._handleTouchEvents(b)});a.addEventListener("touchend",b=>{this._handleTouchEvents(b)});a.addEventListener("touchcancel",b=>{this._handleTouchEvents(b)});a.addEventListener("touchmove",b=>{this._handleTouchEvents(b)});this._touchEventsEnabled=!0}}_handleTouchEvents(a){if(this._eventsAllowed&&this._enabled&&this.isVisible()){let b;for(let c of this._ctrls)if(b=void 0,c.isActive()){b=c;c._handleTouch(a);break}if(void 0==b)for(let c of this._ctrls)c.isEnabled()&&
c.isVisible()&&c._handleTouch(a)}}_handleFocusEvents(a){switch(a.type){case "focusout":for(let b of this._ctrls)b.isActive()&&(b._deactivate?.(),b.validate?.())}}_handleKeyEvents(a){if(this._eventsAllowed&&this._enabled&&this.isVisible())for(let b of this._ctrls)if(b.isActive()){b._handleKey(a);break}return!1}_handleMouseEvents(a){if(this._eventsAllowed&&this._enabled&&this.isVisible()){let b;for(let c of this._ctrls)if(c.isActive()){b=c;c._handleMouse(a);break}if(void 0==b)for(let c of this._ctrls)c.isEnabled()&&
c.isVisible()&&c._handleMouse(a)}return!1}_selectDrawMethod(){this.draw=(this._is3D=void 0!=this._renderer.GL&&null!=this._renderer.GL)?this._drawControlsWEBGL:this._drawControlsP2D}$(a){return"string"===typeof a?this._controls.get(a):a}addControl(a){console.assert(!this._controls.has(a.name()),`Control '${a.name()}' already exists and will be replaced.`);this._controls.set(a.name(),a);this._ctrls=[...this._controls.values()];this._ctrls.sort((b,c)=>b.z()-c.z());return a}listControls(){console.log("List of controls");
for(let a of this._ctrls)console.log(a.name());console.log("--------------------------------------------------------------")}getOptionGroup(a){this._optionGroups.has(a)||this._optionGroups.set(a,new CvsOptionGroup(a));return this._optionGroups.get(a)}textSize(a){if(!Number.isFinite(a))return this._textSize;this._textSize=a;this._controls.forEach(b=>{b.invalidateBuffer()});return this}tipTextSize(a){return a?(this._tipTextSize=a,this):this._tipTextSize}canvasWidth(){return this._renderer.width}canvasHeight(){return this._renderer.height}corners(a){Array.isArray(a)&&
4==a.length&&(this._corners=[...a]);return[...this._corners]}context(){return this._renderer}is3D(){return this._is3D}_closePanes(){for(let a of this._panesEast)a.close();for(let a of this._panesWest)a.close();for(let a of this._panesSouth)a.close();for(let a of this._panesNorth)a.close()}hidePanes(){this._closePanes();for(let a of this._panesEast)a.hide();for(let a of this._panesWest)a.hide();for(let a of this._panesSouth)a.hide();for(let a of this._panesNorth)a.hide()}showPanes(){for(let a of this._panesEast)a.show();
for(let a of this._panesWest)a.show();for(let a of this._panesSouth)a.show();for(let a of this._panesNorth)a.show()}validateTabsEast(){let a=this._panesEast,b=a.length,c=2*(b-1);a.forEach(e=>c+=e.tab()._w);let d=(this.canvasHeight()-c)/2;for(let e=0;e<b;e++){let f=a[e].tab(),g=-f._h,h=d;d+=f._w+2;f._x=g;f._y=h}}validateTabsWest(){let a=this._panesWest,b=a.length,c=2*(b-1);a.forEach(f=>c+=f.tab()._w);let d=(this.canvasHeight()-c)/2;for(let f=0;f<b;f++){var e=a[f];let g=e.tab();e=e.depth();let h=d;
d+=g._w+2;g._x=e;g._y=h}}validateTabsSouth(){let a=this._panesSouth,b=a.length,c=2*(b-1);a.forEach(e=>c+=e.tab()._w);let d=(this.canvasWidth()-c)/2;for(let e=0;e<b;e++){let f=a[e].tab(),g=d,h=-f._h;d+=f._w+2;f._x=g;f._y=h}}validateTabsNorth(){let a=this._panesNorth,b=a.length,c=2*(b-1);a.forEach(f=>c+=f.tab()._w);let d=(this.canvasWidth()-c)/2;for(let f=0;f<b;f++){var e=a[f];let g=e.tab(),h=d;e=e.depth();d+=g._w+2;g._x=h;g._y=e}}_initColorSchemes(){this._schemes=[];this._schemes.blue=new BlueScheme;
this._schemes.green=new GreenScheme;this._schemes.red=new RedScheme;this._schemes.cyan=new CyanScheme;this._schemes.yellow=new YellowScheme;this._schemes.purple=new PurpleScheme;this._schemes.orange=new OrangeScheme;this._schemes.light=new LightScheme;this._schemes.dark=new DarkScheme;this._scheme=this._schemes.blue}scheme(a){if(!a)return this._scheme;this._schemes[a]?(this._scheme=this._schemes[a],this._controls.forEach(b=>{b.scheme()||b.invalidateBuffer()})):console.error(`'${a}' is not a valid color scheme`);
return this}_getScheme(a){if(a&&this._schemes[a])return Object.assign({},this._schemes[a]);console.warn(`Unable to retrieve color scheme '${a}'`)}addScheme(a,b){"string"!==typeof a||b||(this._schemes[a]?console.error(`Cannot add scheme '${a}' because it already exists.'`):this._schemes[a]=b);return this}draw(){}_drawControlsP2D(){if(this._visible){this._p.push();for(let a of this._ctrls)a.getParent()||a._renderP2D();this._p.pop()}}_drawControlsWEBGL(){if(this._visible){this._p.push();let a=this._renderer,
b=a.drawingContext,c=a.width,d=a.height,e=Number.MAX_VALUE;b.flush();let f=a.uMVMatrix.copy(),g=a.uPMatrix.copy();b.disable(b.DEPTH_TEST);a.resetMatrix();a._curCamera.ortho(0,c,-d,0,-e,e);for(let h of this._ctrls)h.getParent()||h._renderWEBGL();b.flush();a.uMVMatrix.set(f);a.uPMatrix.set(g);b.enable(b.DEPTH_TEST);this._p.pop()}}static announce(){GUI._announced||(console.log("================================================"),console.log(`  canvasGUI (${CANVAS_GUI_VERSION})   \u00A9 2025 Peter Lager`),
console.log("================================================"),GUI._announced=!0)}static get(a,b=p5.instance){GUI.announce();if(GUI._guis.has(a))return GUI._guis.get(a);b=new GUI(a,b);GUI._guis.set(a,b);return b}static getNamed(a,b,c=p5.instance){GUI.announce();if("string"===typeof a&&0<a.length){if(GUI._guis.has(a))return GUI._guis.get(a);b=new GUI(b,c);b._name=a;GUI._guis.set(a,b);return b}}static find(a){return GUI._guis.get(a)}}GUI._guis=new Map;GUI._announced=!1;
