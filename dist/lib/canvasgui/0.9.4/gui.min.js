...
"0"),this._target.focus(),this._target.addEventListener("keydown",a=>{this._handleKeyEvents(a);return!1}),this._target.addEventListener("keyup",a=>{this._handleKeyEvents(a);return!1}),this._keyEventsEnabled=!0)}_handleFocusEvents(a){switch(a.type){case "focusout":for(let b of this._ctrls)b.isActive()&&(b._deactivate?.(),b.validate?.())}}_handleKeyEvents(a){if(this._eventsAllowed&&this._enabled&&this.isVisible())for(let b of this._ctrls)if(b.isActive()){b._handleKey(a);break}return!1}_handleMouseEvents(a){if(this._eventsAllowed&&
this._enabled&&this.isVisible()){let b=void 0;for(let c of this._ctrls)if(c.isActive()){b=c;c._handleMouse(a);break}if(void 0==b)for(let c of this._ctrls)c.isEnabled()&&c.isVisible()&&c._handleMouse(a)}return!1}_selectDrawMethod(){this.draw=(this._is3D=void 0!=this._renderer.GL&&null!=this._renderer.GL)?this._drawControlsWEBGL:this._drawControlsP2D}$(a){return"string"===typeof a?this._controls.get(a):a}addControl(a){console.assert(!this._controls.has(a.name()),`Control '${a.name()}' already exists and will be replaced.`);
...
c+=f.tab()._w);let d=(this.canvasWidth()-c)/2;for(let f=0;f<b;f++){var e=a[f];let g=e.tab(),h=d;e=e.depth();d+=g._w+2;g._x=h;g._y=e}}_initColorSchemes(){this._schemes=[];this._schemes.blue=new BlueScheme;this._schemes.green=new GreenScheme;this._schemes.red=new RedScheme;this._schemes.cyan=new CyanScheme;this._schemes.yellow=new YellowScheme;this._schemes.purple=new PurpleScheme;this._schemes.orange=new OrangeScheme;this._scheme=this._schemes.blue}scheme(a){if(!a)return this._scheme;this._schemes[a]?
(this._scheme=this._schemes[a],this._controls.forEach(b=>{b.scheme()||b.invalidateBuffer()})):console.error(`'${a}' is not a valid color scheme`);return this}_getScheme(a){if(a&&this._schemes[a])return Object.assign({},this._schemes[a]);console.warn(`Unable to retrieve color scheme '${a}'`)}addScheme(a,b){"string"!==typeof a||b||(this._schemes[a]?console.error(`Cannot add scheme '${a}' because it already exists.'`):this._schemes[a]=b);return this}draw(){}_drawControlsP2D(){if(this._visible){this._p.push();
for(let a of this._ctrls)a.getParent()||a._renderP2D();this._p.pop()}}_drawControlsWEBGL(){if(this._visible){this._p.push();let a=this._renderer,b=a.drawingContext,c=a.width,d=a.height,e=Number.MAX_VALUE;b.flush();let f=a.uMVMatrix.copy(),g=a.uPMatrix.copy();b.disable(b.DEPTH_TEST);a.resetMatrix();a._curCamera.ortho(0,c,-d,0,-e,e);for(let h of this._ctrls)h.getParent()||h._renderWEBGL();b.flush();a.uMVMatrix.set(f);a.uPMatrix.set(g);b.enable(b.DEPTH_TEST);this._p.pop()}}static announce(){GUI._announced||
(console.log("================================================"),console.log(`  canvasGUI (${CANVAS_GUI_VERSION})   \u00A9 2023 Peter Lager`),console.log("================================================"),GUI._announced=!0)}static get(a,b=p5.instance){GUI.announce();if(GUI._guis[b])return GUI._guis[b];let c=new GUI(a,b);c._name=a.toString();return GUI._guis[b]=c}static getNamed(a,b,c=p5.instance){GUI.announce();if(GUI._guis[a])return GUI._guis[a];c=new GUI(b,c);c._name=b.toString();return GUI._guis[a]=
c}}GUI._guis={};GUI._announced=!1;
...
break;case "mousemove":this._active&&(c=this._norm01(c-10,0,this._buffer.width-20),this._s2ticks&&(c=this._nearestTickT(c)),this._t01!=c&&(this._t01=c,this.action({source:this,p5Event:a,value:this.value(),final:!1})),this.invalidateBuffer())}return!1}_nearestTickT(a){let b=0<this._minorTicks?this._minorTicks*this._majorTicks:this._majorTicks;return 0<b?Math.round(a*b)/b:a}_updateControlVisual(){let a=this._buffer,b=this._scheme||this._gui.scheme();var c=a.width-20,d=b.COLOR_3,e=b.GREY_9;const f=b.GREY_6,
g=b.GREY_1,h=b.COLOR_14,k=b.COLOR_10;a.push();a.clear();this._opaque&&(a.noStroke(),a.fill(d),a.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));a.translate(10,a.height/2);a.stroke(e);a.strokeWeight(1);d=this._majorTicks*this._minorTicks;if(2<=d){e=c/d;for(var l=0;l<=d;l++){var m=l*e;a.line(m,-7,m,7)}}d=this._majorTicks;if(2<=d)for(e=c/d,l=0;l<=d;l++)m=l*e,a.line(m,-10,m,10);a.fill(f);a.rect(0,-4,c,8);c*=this._t01;a.fill(g);a.rect(0,-4,c,8,this._c[0],this._c[1],this._c[2],this._c[3]);
a.fill(k);a.noStroke();if(this._active||0<this._over)a.strokeWeight(2),a.stroke(h);a.rect(c-6,-6,12,12,this._c[0],this._c[1],this._c[2],this._c[3]);this._enabled||this._disable_hightlight(a,b,0,-this._h/2,this._w-20,this._h);a.pop();a.updatePixels();this._bufferInvalid=!1}_minControlSize(){return{w:this._w,h:20}}}
...
this._pover,this._over);switch(a.type){case "mousedown":0<this._over&&(this._active=!0,this._tIdx=this._over-1,this.invalidateBuffer());break;case "mouseout":case "mouseup":this._active&&(c=Math.min(this._t[0],this._t[1]),b=Math.max(this._t[0],this._t[1]),this._t[0]=c,this._t[1]=b,this._tIdx=-1,this.action({source:this,p5Event:a,low:this._t2v(c),high:this._t2v(b),final:!0}),this._active=!1,this.invalidateBuffer());break;case "mousemove":this._active&&(c=this._norm01(c-10,0,this._buffer.width-20),
this._s2ticks&&(c=this._nearestTickT(c)),this._t[this._tIdx]!=c&&(this._t[this._tIdx]=c,c=Math.max(this._t[0],this._t[1]),this.action({source:this,p5Event:a,low:this._t2v(Math.min(this._t[0],this._t[1])),high:this._t2v(c),final:!1})),this.invalidateBuffer())}return!1}_updateControlVisual(){let a=this._buffer,b=this._scheme||this._gui.scheme(),c=a.width-20;var d=b.COLOR_3,e=b.GREY_9,f=b.GREY_6,g=b.GREY_1;const h=b.COLOR_14,k=b.COLOR_10;a.push();a.clear();this._opaque&&(a.noStroke(),a.fill(d),a.rect(0,
...
a.noStroke(),(this._active||0<this._over)&&g==this._tIdx&&(a.strokeWeight(2),a.stroke(h)),a.rect(this._t[g]*c-6,-6,12,12,this._c[0],this._c[1],this._c[2],this._c[3]);this._enabled||this._disable_hightlight(a,b,0,-this._h/2,this._w-20,this._h);a.pop();a.updatePixels();this._bufferInvalid=!1}}
...
let c=this._p.mouseX-b.x;b=this._p.mouseY-b.y;b=this._orientation.xy(c,b,this._w,this._h);c=b.x;b=b.y;this._pover=this._over;this._over=this._whereOver(c,b);this._pover!=this._over&&this.invalidateBuffer();this._tooltip&&this._tooltip._updateState(this,this._pover,this._over);switch(a.type){case "mousedown":0<this._over&&(this._active=!0,this._s_value=this._value,this._s_mx=c,this.invalidateBuffer());break;case "mouseout":case "mouseup":this._active&&(this.action({source:this,p5Event:a,value:this._value,
used:this._used,final:!0}),this._active=!1,this.invalidateBuffer());break;case "mousemove":this._active&&(this.update(this._s_value+(c-this._s_mx)/this._TLENGTH),this.action({source:this,p5Event:a,value:this._value,used:this._used,final:!1}),this.invalidateBuffer())}return!1}_updateControlVisual(){let a=this._buffer,b=this._scheme||this._gui.scheme(),c=Math.max(this._used*this._TLENGTH,this._MIN_THUMB_WIDTH),d=this._THUMB_HEIGHT,e=this._dvalue*this._TLENGTH;const f=b.COLOR_3,g=b.GREY_8,h=b.GREY_4,
...
20,this._h);a.pop();a.updatePixels();this._bufferInvalid=!1}_minControlSize(){return{w:this._w,h:20}}}
...
Number(this._textSize||this._gui.textSize());return this._w-2*this._gap-a/2}_handleKey(a){let b=this._maxTextWidthPixels(),c=this._getLine(),d=this._prevCsrIdx!=this._currCsrIdx,e=!(!this._linkIndex||d||0!=this._currCsrIdx),f=!!(this._linkIndex&&!d&&this._currCsrIdx>=c.length);if("keydown"==a.type){if(1==a.key.length)return this._prevCsrIdx!=this._currCsrIdx&&(c=this._removeSelectedText(c)),c=c.substring(0,this._currCsrIdx)+a.key+c.substring(this._currCsrIdx),this._buffer.textWidth(c)<b&&(this._currCsrIdx++,
this._prevCsrIdx++,this._lines[0]=c),this.invalidateBuffer(),!0;switch(a.key){case "ArrowLeft":e?(this._activateNext(-1),this.action({source:this,p5Event:a,value:c})):0<this._currCsrIdx&&(!a.shiftKey&&d?this._currCsrIdx=Math.min(this._currCsrIdx,this._prevCsrIdx):this._currCsrIdx--,a.shiftKey||(this._prevCsrIdx=this._currCsrIdx));break;case "ArrowRight":f?(this._activateNext(1),this.action({source:this,p5Event:a,value:c})):this._currCsrIdx<=c.length&&(!a.shiftKey&&d?this._currCsrIdx=Math.max(this._currCsrIdx,
...
c=this._removeSelectedText(c):0<this._currCsrIdx&&(c=c.substring(0,this._currCsrIdx-1)+c.substring(this._currCsrIdx),this._currCsrIdx--,this._prevCsrIdx=this._currCsrIdx);this._lines[0]=c;break;case "Delete":this._prevCsrIdx!=this._currCsrIdx?c=this._removeSelectedText(c):this._currCsrIdx<c.length&&(c=c.substring(0,this._currCsrIdx)+c.substring(this._currCsrIdx+1)),this._lines[0]=c}this.invalidateBuffer();return!1}return!0}_removeSelectedText(a){let b=Math.min(this._prevCsrIdx,this._currCsrIdx),c=
Math.max(this._prevCsrIdx,this._currCsrIdx);this._prevCsrIdx=this._currCsrIdx=b;return a.substring(0,b)+a.substring(c)}_updateControlVisual(){var a=Number(this._textSize||this._gui.textSize());let b=this._scheme||this._gui.scheme(),c=this._buffer;c.textSize(a);let d=0<this._lines.length?this._lines[0]:"";var e=this._textInvalid;let f=2*this._gap,g=b.COLOR_0,h=b.COLOR_14,k=b.BLACK,l=b.COLOR_14,m=b.COLOR_4;c.push();c.background(b.WHITE);c.noStroke();if(!this._active)g=e?b.COLOR_14:b.COLOR_0,h=e?b.COLOR_2:
