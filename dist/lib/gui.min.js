...
c,d,e){return this.addControl(new CvsRanger(this,a,b,c,d,e))}button(a,b,c,d,e){return this.addControl(new CvsButton(this,a,b,c,d,e))}checkbox(a,b,c,d,e){return this.addControl(new CvsCheckbox(this,a,b,c,d,e))}option(a,b,c,d,e){return this.addControl(new CvsOption(this,a,b,c,d,e))}label(a,b,c,d,e){return this.addControl(new CvsLabel(this,a,b,c,d,e))}viewer(a,b,c,d,e){return this.addControl(new CvsViewer(this,a,b,c,d,e))}__tooltip(a){return this.addControl(new CvsTooltip(this,a))}pane(a,b,c){switch(b){case "north":a=
new CvsPaneNorth(this,a,c);break;case "south":a=new CvsPaneSouth(this,a,c);break;case "west":a=new CvsPaneWest(this,a,c);break;default:a=new CvsPaneEast(this,a,c)}return this.addControl(a)}getControl(a){return"string"===typeof a?this._controls.get(a):a}$(a){return"string"===typeof a?this._controls.get(a):a}addControl(a){console.assert(!this._controls.has(a._name),`Control '${a._name}' already exists and will be replaced.`);this._controls.set(a._name,a);this._ctrls=[...this._controls.values()];this._ctrls.sort((b,
c)=>b.z()-c.z());return a}listControls(){console.log("List of controls");for(let a of this._ctrls)console.log(a.name());console.log("--------------------------------------------------------------")}getOptionGroup(a){this._optionGroups.has(a)||this._optionGroups.set(a,new CvsOptionGroup(a));return this._optionGroups.get(a)}textSize(a){if(!Number.isFinite(a))return this._textSize;this._textSize=a;this._controls.forEach(b=>{b.invalidateBuffer()});return this}tipTextSize(a){return a?(this._tipTextSize=
...
c)/2;for(let f=0;f<b;f++){var e=a[f];let g=e.tab(),h=d;e=e.size();d+=g._w+2;g._x=h;g._y=e}}_initColorSchemes(){this._schemes=[];this._schemes.blue=new BlueScheme;this._schemes.green=new GreenScheme;this._schemes.red=new RedScheme;this._schemes.cyan=new CyanScheme;this._schemes.yellow=new YellowScheme;this._schemes.purple=new PurpleScheme;this._schemes.orange=new OrangeScheme;this._scheme=this._schemes.blue}scheme(a){if(!a)return this._scheme;this._schemes[a]?(this._scheme=this._schemes[a],this._controls.forEach(b=>
{b.scheme()||b.invalidateBuffer()})):console.error(`'${a}' is not a valid color scheme`);return this}getScheme(a){if(a&&this._schemes[a])return Object.assign({},this._schemes[a]);console.warn(`Unable to retrieve color scheme '${a}'`)}addScheme(a,b){"string"!==typeof a||b||(this._schemes[a]?console.error(`Cannot add scheme '${a}' because it already exists.'`):this._schemes[a]=b);return this}_initMouseEventHandlers(a){let b=a.canvas;b.addEventListener("mousemove",c=>{this._handleMouseEvents(c)});b.addEventListener("mousedown",
c=>{this._handleMouseEvents(c)});b.addEventListener("mouseup",c=>{this._handleMouseEvents(c)});b.addEventListener("wheel",c=>{this._handleMouseEvents(c)});b.addEventListener("mouseout",c=>{this._handleMouseEvents(c)});this.draw=(this._is3D=void 0!=a.GL&&null!=a.GL)?this._drawControlsWEBGL:this._drawControlsP2D}_handleMouseEvents(a){let b=void 0;for(let c of this._ctrls)if(c.isActive()){b=c;c._handleMouse(a);break}if(void 0==b)for(let c of this._ctrls)c.isEnabled()&&c._handleMouse(a)}draw(){}_drawControlsP2D(){this._p.push();
for(let a of this._ctrls)a.getParent()||a._renderP2D();this._p.pop()}_drawControlsWEBGL(){this._p.push();let a=this._renderer,b=a.drawingContext,c=a.width,d=a.height,e=Number.MAX_VALUE;b.flush();let f=a.uMVMatrix.copy(),g=a.uPMatrix.copy();b.disable(b.DEPTH_TEST);a.resetMatrix();a._curCamera.ortho(0,c,-d,0,-e,e);for(let h of this._ctrls)h.getParent()||h._renderWEBGL();b.flush();a.uMVMatrix.set(f);a.uPMatrix.set(g);b.enable(b.DEPTH_TEST);this._p.pop()}static get(a,b=p5.instance){GUI.announce();if(GUI._guis.has(b))return GUI._guis.get(b);
a=new GUI(a,b);GUI._guis.set(b,a);return a}static announce(){GUI._announced||(console.log("================================================"),console.log("  canvasGUI (0.0.1)   \u00a9 2022 Peter Lager"),console.log("================================================"),GUI._announced=!0)}}GUI._guis=new Map;GUI._announced=!1;
...
class CvsBaseControl{constructor(a,b,c,d,e,f){this._h=this._w=this._y=this._x=0;this._gui=a;this._p=this._gui._p;this._name=b;this._x=c;this._y=d;this._w=e;this._h=f;this._children=[];this._parent=void 0;this._enabled=this._visible=!0;this._scheme=void 0;this._Z=0;this._orientation=CvsBaseControl.EAST;this._dragging=!1;this._bufferInvalid=!0;this._pover=this._over=0;this._clickAllowed=!1;this._c=a.corners(void 0);this._active=!1;this._opaque=!0;this.setAction(g=>{console.warn(`No action set for control '${null===
...
class CvsText extends CvsBufferedControl{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||80,f||16);this._lines=[];this._textSize=void 0;this._textAlign=this._p.CENTER;this._tbox={w:0,h:0};this._gap=2}text(a,b){if(void 0==a)return{text:this._text,icon:void 0};if(Array.isArray(a))this._lines=a;else{a=a.toString().split("\n");this._lines=[];for(let c of a)this._lines.push(c)}this.textAlign(b);b=this._minControlSize();this._w=Math.max(this._w,b.w);this._h=Math.max(this._h,b.h);this._bufferInvalid=!0;
return this}textAlign(a){!a||a!=this._p.LEFT&&a!=this._p.CENTER&&a!=this._p.RIGHT||(this._textAlign=a);return this}noText(){this._lines=[];this._textAlign=this._p.CENTER;this._tbox={w:0,h:0};return this}textSize(a){a=Number(a);let b=this._textSize||this._gui.textSize();if(Number.isNaN(a)||0==a)return b;a!=b&&(this._textSize=a,a=this._minControlSize(),this._w=Math.max(this._w,a.w),this._h=Math.max(this._h,a.h),this._bufferInvalid=!0);return this}_minControlSize(){let a=this._buffer,b=this._lines,c=
this._textSize||this._gui.textSize(),d=this._tbox,e=0,f=0,g=this._gap;0<b.length&&(a||this._validateBuffer(),a.textSize(c),d.w=c+b.map(h=>a.textWidth(h)).reduce((h,k)=>h>k?h:k),d.h=(b.length-1)*a.textLeading()+a.textAscent()+a.textDescent(),g+=this._gap);e+=d.w+g;f=Math.max(d.h,f)+2*g;return{w:e,h:f}}}
class CvsTextIcon extends CvsText{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||80,f||16);this._icon=void 0;this._iconAlign=this._p.LEFT}icon(a,b){if(!a)return{text:this._text,icon:this._icon};this._icon=a;!b||b!=this._p.LEFT&&b!=this._p.RIGHT||(this._iconAlign=b);a=this._minControlSize();this._w=Math.max(this._w,a.w);this._h=Math.max(this._h,a.h);this._bufferInvalid=!0;return this}noIcon(){this._icon=void 0;this._iconAlign=this._p.LEFT;this._bufferInvalid=!0;return this}_minControlSize(){let a=
...
!1;var c=this.getAbsXY();let d=this._p.mouseX-c.x;c=this._p.mouseY-c.y;c=this._orientation.xy(d,c,this._w,this._h);d=c.x;c=c.y;this._pover=this._over;this._over=this._whereOver(d,c);this._bufferInvalid=this._bufferInvalid||this._pover!=this._over;this._tooltip&&this._tooltip._updateState(this._pover,this._over);switch(a.type){case "mousedown":0<this._over&&(b=this._bufferInvalid=this._active=this._dragging=this._clickAllowed=!0);break;case "mouseout":case "mouseup":this._active&&(this._clickAllowed&&
(this._selected=!this._selected,this.action({source:this,p5Event:a,selected:this._selected})),this._over=0,this._active=this._dragging=this._clickAllowed=!1,b=this._bufferInvalid=!0);break;case "mousemove":this._clickAllowed=!1}return b}_updateControlVisual(){var a=this._textSize||this._gui.textSize();let b=this._scheme||this._gui.scheme(),c=this._buffer;var d=this._iconAlign,e=this._p.constrain(.7*Number(a),12,16);let f=this._textAlign,g=this._lines,h=this._gap;var k=b.COLOR_3;let l=b.COLOR_13,m=
...
return this}isSelected(){return this._selected}group(a){this._optGroup=this._gui.getOptionGroup(a);this._optGroup.add(this);return this}_handleMouse(a){let b=!1;var c=this.getAbsXY();let d=this._p.mouseX-c.x;c=this._p.mouseY-c.y;c=this._orientation.xy(d,c,this._w,this._h);d=c.x;c=c.y;this._pover=this._over;this._over=this._whereOver(d,c);this._bufferInvalid=this._bufferInvalid||this._pover!=this._over;this._tooltip&&this._tooltip._updateState(this._pover,this._over);switch(a.type){case "mousedown":0<
this._over&&(b=this._bufferInvalid=this._active=this._dragging=this._clickAllowed=!0);break;case "mouseout":case "mouseup":this._active&&this._clickAllowed&&!this._selected&&this._optGroup&&(this.select(),this.action({source:this,p5Event:a,selected:!0}));this._over=0;this._active=this._dragging=this._clickAllowed=!1;b=this._bufferInvalid=!0;break;case "mousemove":this._clickAllowed=!1}return b}_updateControlVisual(){var a=this._textSize||this._gui.textSize();let b=this._scheme||this._gui.scheme(),
c=this._buffer,d=this._p;var e=this._iconAlign,f=d.constrain(.7*Number(a),12,16);let g=this._textAlign,h=this._lines,k=this._gap;var l=b.COLOR_3;let m=b.COLOR_13,n=b.COLOR_14;c.push();c.clear();this._opaque&&(c.noStroke(),c.fill(l),c.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));c.push();c.translate(e==d.RIGHT?this._w-k-f/2:k+f/2,c.height/2);c.stroke(m);c.fill(b.WHITE);c.strokeWeight(1.5);c.ellipse(0,0,f,f);this._selected&&(c.fill(m),c.noStroke(),c.ellipse(0,0,f/2,f/2));c.pop();
if(0<h.length){c.textSize(a);a=k;l=this._w-k;let p=0;e==d.LEFT&&(a+=f+k);e==d.RIGHT&&(l-=f+k);e=l-a;f=this._tbox.h;f=c.textAscent()+(this._h-f)/2;c.fill(m);for(let q of h){switch(g){case d.LEFT:p=a;break;case d.CENTER:p=a+(e-c.textWidth(q))/2;break;case d.RIGHT:p=l-c.textWidth(q)-k}c.text(q,p,f);f+=c.textLeading()}}0<this._over&&(c.stroke(n),c.strokeWeight(2),c.noFill(),c.rect(1,1,this._w-2,this._h-2,this._c[0],this._c[1],this._c[2],this._c[3]));this._enabled||this._disable_hightlight(c,b,0,0,this._w,
this._h);c.pop();c.updatePixels();this._bufferInvalid=!1}_minControlSize(){let a=this._buffer,b=this._lines,c=this._tbox,d=0;var e=0;e=this._gap;var f=this._textSize||this._gui.textSize();f=this._p.constrain(.7*Number(f),12,16);if(0<b.length){a||this._validateBuffer();let g=this._textSize||this._gui.textSize();a.textSize(g);c.w=g+b.map(h=>a.textWidth(h)).reduce((h,k)=>h>k?h:k);c.h=(b.length-1)*a.textLeading()+a.textAscent()+a.textDescent()}d+=c.w+e+f;e=Math.max(this._tbox.h,f+e)+2*e;return{w:d,h:e}}}
...
class CvsScroller extends CvsBufferedControl{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||100,f||20);this._updateTrackInfo();this._capacity=1;this._used=.3;this._minV=this._used/2;this._maxV=1-this._used/2;this._value=.5;this._c=a.corners();this._opaque=!0;this._my1=this._my0=this._mx1=this._mx0=this._mdelta=0}_updateTrackInfo(){this._BORDER=10;this._TLENGTH=this._w-2*this._BORDER;this._THEIGHT=10}value(a){if(!Number.isFinite(a))return this._value*this._capacity;this._validateValue(a/this._capacity);
return this}used(a){if(!Number.isFinite(a))return this._used*this._capacity;a/=this._capacity;a=this._p.constrain(a,0,1);this._bufferInvalid=this._bufferInvalid||this._neq(a,this._used);this._used=a;this._minV=this._used/2;this._maxV=1-this._used/2;1<=this._used?this.hide():this.show();this._validateValue(this._value);return this}_validateValue(a){a=this._p.constrain(a,this._minV,this._maxV);a!=this._value&&(this._value=a,this.action({source:this,value:this.value(),final:!0}),this._bufferInvalid=
!0)}capacity(a){if(!Number.isFinite(a))return this._capacity;this._capacity=a;this._bufferInvalid=this._bufferInvalid||this._neq(a,this._capacity);return this}_whereOver(a,b){let c=this._h/2;return Math.abs(this._BORDER+this._value*this._TLENGTH-a)<=Math.max(this._used*this._TLENGTH,12)/2&&Math.abs(c-b)<=this._THEIGHT/2?1:0}_handleMouse(a){let b=!1;var c=this.getAbsXY(),d=this._p.mouseX-c.x;c=this._p.mouseY-c.y;c=this._orientation.xy(d,c,this._w,this._h);d=c.x;c=c.y;this._pover=this._over;this._over=
this._whereOver(d,c);this._bufferInvalid=this._bufferInvalid||this._pover!=this._over;this._tooltip&&this._tooltip._updateState(this._pover,this._over);switch(a.type){case "mousedown":0<this._over&&(this._bufferInvalid=this._active=!0,this._mdelta=d-(this._value*this._TLENGTH+this._BORDER));break;case "mouseout":case "mouseup":this._active&&(this.action({source:this,p5Event:a,value:this.value(),final:!0}),this._active=!1,b=this._bufferInvalid=!0);break;case "mousemove":this._active&&(d=(d-this._mdelta-
this._BORDER)/this._TLENGTH,this._value=d=this._p.constrain(d,this._minV,this._maxV),this.action({source:this,p5Event:a,value:this.value(),final:!1}),this._bufferInvalid=!0)}return b}_updateControlVisual(){let a=this._buffer,b=this._scheme||this._gui.scheme(),c=Math.max(this._used*this._TLENGTH,12),d=this._value*this._TLENGTH;const e=b.COLOR_3,f=b.GREY_8,g=b.GREY_4,h=b.COLOR_14,k=b.COLOR_10;a.push();a.clear();this._opaque&&(a.noStroke(),a.fill(e),a.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],
this._c[3]));a.translate(this._BORDER,a.height/2);a.fill(g);a.stroke(f);a.strokeWeight(1);a.rect(0,-this._THEIGHT/2,this._TLENGTH,this._THEIGHT);a.fill(k);a.noStroke();if(this._active||0<this._over)a.strokeWeight(2),a.stroke(h);a.rect(d-c/2,-7,c,14,this._c[0],this._c[1],this._c[2],this._c[3]);this._enabled||this._disable_hightlight(a,b,0,-this._h/2,this._w-20,this._h);a.pop();a.updatePixels();this._bufferInvalid=!1}_minControlSize(){return{w:this._w,h:20}}}
...
CvsPane._tabID=1;
class CvsPaneNorth extends CvsPane{constructor(a,b,c){super(a,b,0,-c,a.canvasWidth(),c);this._size=c;this._status="closed";b=this._tab=this._gui.button("Tab "+CvsPane._tabID++);b.text(b._name).setAction(this._tabAction);c=b._minControlSize();b._w=c.w+CvsPane._wExtra;b._c=[0,0,this._cornerRadius,this._cornerRadius];this.addChild(b);a._panesNorth.push(this);this._gui.validateTabsNorth()}_opening(){let a=this._y+CvsPane._dO;0<a&&(a=0,clearInterval(this._timer),this._status="open");this._y=a}_closing(){let a=
this._y-CvsPane._dC;a<-this._size&&(a=-this._size,clearInterval(this._timer),this._status="closed");this._y=a}validateTabs(){this._gui.validateTabsNorth();return this}}
class CvsPaneSouth extends CvsPane{constructor(a,b,c){super(a,b,0,a.canvasHeight(),a.canvasWidth(),c);this._size=c;this._status="closed";a=this._tab=this._gui.button("Tab "+CvsPane._tabID++);a.text(a._name).setAction(this._tabAction);b=a._minControlSize();a._w=b.w+CvsPane._wExtra;a._c=[this._cornerRadius,this._cornerRadius,0,0];this.addChild(a);this._gui._panesSouth.push(this);this._gui.validateTabsSouth()}_opening(){let a=this._y-CvsPane._dO;a<this._gui.canvasHeight()-this._size&&(a=this._gui.canvasHeight()-
this._size,clearInterval(this._timer),this._status="open");this._y=a}_closing(){let a=this._y+CvsPane._dC;a>this._gui.canvasHeight()&&(a=this._gui.canvasHeight(),clearInterval(this._timer),this._status="closed");this._y=a}validateTabs(){this._gui.validateTabsSouth();return this}}
class CvsPaneEast extends CvsPane{constructor(a,b,c){super(a,b,a.canvasWidth(),0,c,a.canvasHeight());this._size=c;this._status="closed";a=this._tab=this._gui.button("Tab "+CvsPane._tabID++);a.text(a._name).orient("north").setAction(this._tabAction);b=a._minControlSize();a._w=b.w+CvsPane._wExtra;a._c=[this._cornerRadius,this._cornerRadius,0,0];this.addChild(a);this._gui._panesEast.push(this);this._gui.validateTabsEast()}_opening(){let a=this._x-CvsPane._dO;a<this._gui.canvasWidth()-this._size&&(a=
this._gui.canvasWidth()-this._size,clearInterval(this._timer),this._status="open");this._x=a}_closing(){let a=this._x+CvsPane._dC;a>this._gui.canvasWidth()&&(a=this._gui.canvasWidth(),clearInterval(this._timer),this._status="closed");this._x=a}validateTabs(){this._gui.validateTabsEast();return this}}
class CvsPaneWest extends CvsPane{constructor(a,b,c){super(a,b,-c,0,c,a.canvasHeight());this._size=c;this._status="closed";a=this._tab=this._gui.button("Tab "+CvsPane._tabID++);a.text(a._name).orient("south").setAction(this._tabAction);b=a._minControlSize();a._w=b.w+CvsPane._wExtra;a._c=[this._cornerRadius,this._cornerRadius,0,0];this.addChild(a);this._gui._panesWest.push(this);this._gui.validateTabsWest()}_opening(){let a=this._x+CvsPane._dO;0<a&&(a=0,clearInterval(this._timer),this._status="open");
this._x=a}_closing(){let a=this._x-CvsPane._dC;a<-this._size&&(a=-this._size,clearInterval(this._timer),this._status="closed");this._x=a}validateTabs(){this._gui.validateTabsWest();return this}};
