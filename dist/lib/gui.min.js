...
b,c,d,e){return this.addControl(new CvsViewer(this,a,b,c,d,e),!0)}joystick(a,b,c,d,e){return this.addControl(new CvsJoystick(this,a,b,c,d,e),!0)}knob(a,b,c,d,e){return this.addControl(new CvsKnob(this,a,b,c,d,e),!0)}__scroller(a,b,c,d,e){return this.addControl(new CvsScroller(this,a,b,c,d,e),!0)}__tooltip(a){return this.addControl(new CvsTooltip(this,a),!1)}pane(a,b,c){c=Math.round(c);switch(b){case "north":a=new CvsPaneNorth(this,a,c);break;case "south":a=new CvsPaneSouth(this,a,c);break;case "west":a=
new CvsPaneWest(this,a,c);break;default:a=new CvsPaneEast(this,a,c)}return this.addControl(a,!1)}grid(a,b,c,d){return new GridLayout(a,b,c,d)}name(){return this._uid}show(){this._visible=!0;return this}hide(){this._visible=!1;return this}isVisible(){return this._visible}enable(){this._enabled=!0;return this}disable(){this._enabled=!1;return this}isEnabled(){return this._enabled}tooltipTimes(a=TT_SHOW_TIME,b=TT_REPEAT_TIME){this._show_time=a;this._repeat_time=b;return this}_addFocusHandlers(){this._canvas.addEventListener("focusout",
a=>{this._processFocusEvent(a)})}_addMouseEventHandlers(){if(!this._mouseListenersCreated){let a=this._canvas;a.addEventListener("mousedown",b=>{this._processMouseEvent(b)});a.addEventListener("mouseup",b=>{this._processMouseEvent(b)});a.addEventListener("mousemove",b=>{this._processMouseEvent(b)});a.addEventListener("wheel",b=>{this._processMouseEvent(b)});a.addEventListener("mouseout",b=>{this._processMouseEvent(b)});a.addEventListener("mouseenter",b=>{this._processMouseEvent(b)});this._mouseListenersCreated=
!0}}_addKeyEventHandlers(){this._keyListenersCreated||(this._target.setAttribute("tabindex","0"),this._target.focus(),this._target.addEventListener("keydown",a=>{this._processKeyEvent(a);return!1}),this._target.addEventListener("keyup",a=>{this._processKeyEvent(a);return!1}),this._keyListenersCreated=!0)}_addTouchEventHandlers(){if(!this._touchListenersCreated){let a=this._canvas;a.addEventListener("touchstart",b=>{this._processTouchEvent(b)});a.addEventListener("touchend",b=>{this._processTouchEvent(b)});
a.addEventListener("touchmove",b=>{this._processTouchEvent(b)});a.addEventListener("touchcancel",b=>{this._processTouchEvent(b)});this._touchListenersCreated=!0}}_processMouseEvent(a){if(this._visible&&this._enabled){const b=this._canvas.getBoundingClientRect();this._processEvent(a,a.clientX-b.left,a.clientY-b.top)}}_processTouchEvent(a){if(this._visible&&this._enabled){const b=this._canvas.getBoundingClientRect(),c=a.changedTouches[0];this._processEvent(a,c.clientX-b.left,c.clientY-b.top)}}_processEvent(a,
b,c){if(!(this._activeCtrl instanceof CvsTextField)){var d=this.getPicked(b,c),e=(this._currOver=d.control)&&this._currOver!=this._prevOver;this._activeCtrl?this._activeCtrl=this._activeCtrl._doEvent(a,b,c,d,e):"mousemove"==a.type||"touchmove"==a.type?(this._prevOver?._doEvent(a,b,c,d,!1),this._currOver?._doEvent(a,b,c,d,e)):this._activeCtrl=this._currOver?._doEvent(a,b,c,d,e);this._prevOver=this._currOver}}_processKeyEvent(a){this._visible&&this._enabled&&this._activeCtrl instanceof CvsTextField&&
(this._activeCtrl=this._activeCtrl._doKeyEvent(a))}_processFocusEvent(a){switch(a.type){case "focusout":this._activeCtrl instanceof CvsTextField&&(this._activeCtrl.validate(),this._activeCtrl._deactivate(),this._activeCtrl=null)}}$(a){return"string"===typeof a?this._controls.get(a):a}addControl(a,b=!1){CASSERT(!this._controls.has(a.id),`Control '${a.id}' already exists and will be replaced.`);this._controls.set(a.id,a);this._ctrls=[...this._controls.values()];this.setRenderOrder();b&&this.register(a);
return a}setRenderOrder(){this._ctrls.sort((a,b)=>a.z-b.z)}register(a){a&&!this._ctrlKey.has(a)&&(this._ctrlKey.set(a,this._NEXT_COLOR),this._colorKey.set(this._NEXT_COLOR,a),this._NEXT_COLOR+=this._COLOR_STEP)}deregister(a){if(a&&this._ctrlKey.has(a)){let b=this._ctrlKey.get(a);this._ctrlKey.delete(a);this._colorKey.delete(b)}}pickColor(a){if(this._ctrlKey.has(a))return a=this._ctrlKey.get(a),{r:a>>16&255,g:a>>8&255,b:a&255}}showBuffer(a,b=this._pickbuffer){var c=document.getElementById(a);c||(c=
document.createElement("canvas"),c.setAttribute("id",a),document.getElementsByTagName("body")[0].append(c));c.setAttribute("width",`${b.width}`);c.setAttribute("height",`${b.height}`);c.setAttribute("padding","3px");c.style.border="2px solid #000000";if(c instanceof HTMLCanvasElement){a=window.devicePixelRatio;let [d,e,f]=[b.canvas,b.width*a,b.height*a];b=c.getContext("2d");c=b.canvas;b.drawImage(d,0,0,e,f,0,0,c.width,c.height)}}listControls(){CLOG("--------------------   List of controls   --------------------");
this._ctrls.forEach(a=>{let b=`${a.id}                               `.substring(0,15),c=`${a.constructor.name}                   `.substring(0,15),d=`Z: ${a.z}      `.substring(0,10);a=`Color key: ${this._ctrlKey.get(a)}`;CLOG(b+c+d+a)});CLOG("--------------------------------------------------------------")}getOptionGroup(a){this._optionGroups.has(a)||this._optionGroups.set(a,new CvsOptionGroup(a));return this._optionGroups.get(a)}textSize(a){if(!Number.isFinite(a))return this._textSize;this._textSize=
a;this._controls.forEach(b=>{b.invalidateBuffer()});return this}tipTextSize(a){return a?(this._tipTextSize=a,this):this._tipTextSize}canvasWidth(){return this._renderer.width}canvasHeight(){return this._renderer.height}corners(a){Array.isArray(a)&&4==a.length&&(this._corners=[...a]);return[...this._corners]}context(){return this._renderer}_closePanes(){for(let a of this._panesEast)a.close();for(let a of this._panesWest)a.close();for(let a of this._panesSouth)a.close();for(let a of this._panesNorth)a.close()}hidePanes(){this._closePanes();
for(let a of this._panesEast)a.hide();for(let a of this._panesWest)a.hide();for(let a of this._panesSouth)a.hide();for(let a of this._panesNorth)a.hide()}showPanes(){for(let a of this._panesEast)a.show();for(let a of this._panesWest)a.show();for(let a of this._panesSouth)a.show();for(let a of this._panesNorth)a.show()}validateTabsEast(){let a=this._panesEast,b=a.length,c=2*(b-1);a.forEach(e=>c+=e.tab()._w);let d=(this.canvasHeight()-c)/2;for(let e=0;e<b;e++){let f=a[e].tab(),h=-f._h,g=d;d+=f._w+2;
f._x=h;f._y=g}}validateTabsWest(){let a=this._panesWest,b=a.length,c=2*(b-1);a.forEach(f=>c+=f.tab()._w);let d=(this.canvasHeight()-c)/2;for(let f=0;f<b;f++){var e=a[f];let h=e.tab();e=e.depth();let g=d;d+=h._w+2;h._x=e;h._y=g}}validateTabsSouth(){let a=this._panesSouth,b=a.length,c=2*(b-1);a.forEach(e=>c+=e.tab()._w);let d=(this.canvasWidth()-c)/2;for(let e=0;e<b;e++){let f=a[e].tab(),h=d,g=-f._h;d+=f._w+2;f._x=h;f._y=g}}validateTabsNorth(){let a=this._panesNorth,b=a.length,c=2*(b-1);a.forEach(f=>
c+=f.tab()._w);let d=(this.canvasWidth()-c)/2;for(let f=0;f<b;f++){var e=a[f];let h=e.tab(),g=d;e=e.depth();d+=h._w+2;h._x=g;h._y=e}}_initColorSchemes(){this._schemes=[];this._schemes.blue=new BlueScheme;this._schemes.green=new GreenScheme;this._schemes.red=new RedScheme;this._schemes.cyan=new CyanScheme;this._schemes.yellow=new YellowScheme;this._schemes.purple=new PurpleScheme;this._schemes.orange=new OrangeScheme;this._schemes.light=new LightScheme;this._schemes.dark=new DarkScheme;this._scheme=
this._schemes.blue}scheme(a){if(!a)return this._scheme;this._schemes[a]?(this._scheme=this._schemes[a],this._controls.forEach(b=>{b.scheme()||b.invalidateBuffer()})):CERROR(`'${a}' is not a valid color scheme`);return this}_getScheme(a){if(a&&this._schemes[a])return Object.assign({},this._schemes[a]);CWARN(`Unable to retrieve color scheme '${a}'`)}addScheme(a,b){"string"!==typeof a||b||(this._schemes[a]?CERROR(`Cannot add scheme '${a}' because it already exists.'`):this._schemes[a]=b);return this}draw(){this._hud.clear();
this._pickbuffer.clear();if(this._visible){this._p.push();for(let a of this._ctrls)a.getParent()||a._draw(this._hud,this._pickbuffer);this._p.pop();this._drawHud()}}_drawHudP2D(){this._p.push();this._p.image(this._hud,0,0);this._p.pop()}_drawHudWEBGL(){this._p.push();let a=this._renderer,b=a.drawingContext,c=a.width,d=a.height,e=Number.MAX_VALUE;b.flush();let f=a.uMVMatrix.copy(),h=a.uPMatrix.copy();b.disable(b.DEPTH_TEST);a.resetMatrix();this._getCamera().ortho(0,c,-d,0,-e,e);this._p.image(this._hud,
0,0);b.flush();a.uMVMatrix.set(f);a.uPMatrix.set(h);b.enable(b.DEPTH_TEST);this._p.pop()}getPicked(a,b){let c=this._pickbuffer,d={control:null,part:-1};0<=a&&a<c.width&&0<=b&&b<c.height&&(a=c.get().get(a,b),a=(a[0]<<16)+(a[1]<<8)+a[2],d.control=this._colorKey.get(a&this._COLOR_MASK),d.part=a&this._PART_MASK);return d}static ANNOUNCE_CANVAS_GUI(){0==GUI._guis.size&&(CLOG("================================================"),CLOG(`  canvasGUI (${CANVAS_GUI_VERSION})   \u00A9 2025 Peter Lager`),CLOG("================================================"))}static create(a,
b,c=p5.instance){GUI.ANNOUNCE_CANVAS_GUI();if(GUI._guis.has(a))return CWARN(`You already have a  GUI called '${a} it will not be replaced`),GUI._guis.get(a);b=new GUI(b,c);GUI._guis.set(a,b);return b}static get(a){return GUI._guis.get(a)}}GUI._guis=new Map;const createGUI=function(a,b,c=p5.instance){return GUI.create(a,b,c)},getGUI=function(a){return GUI.get(a)};
...
b=0,c=0,d,e){let f=this.getAbsXY();[b]=this._orientation.xy(b-f.x,c-f.y,this._w,this._h);switch(a.type){case "mousedown":case "touchstart":if(0==d.part||1==d.part)this.isActive=!0,this._tIdx=d.part,this.isOver=!0;break;case "mouseout":case "mouseup":case "touchend":this.isActive&&(d=Math.min(this._t[0],this._t[1]),e=Math.max(this._t[0],this._t[1]),this._t[0]=d,this._t[1]=e,this._tIdx=-1,this.action({source:this,p5Event:a,low:this._t2v(d),high:this._t2v(e),final:!0}),this.isActive=!1,this.invalidateBuffer());
...
this._scheme||this._gui.scheme();var b=a.C_3,c=a.G_7,d=a.G_3,e=a.G_1;const f=a.C_9,h=a.C_6;let g=this._uiBfr,l=g.width-20,p=Math.round(g.height/2);g.push();g.clear();this._opaque&&(g.noStroke(),g.fill(b),g.rect(0,0,this._w,this._h,...this._c));g.translate(10,p);g.stroke(c);g.strokeWeight(1);c=this._majorTicks*this._minorTicks;if(2<=c){b=l/c;for(var k=0;k<=c;k++){var q=k*b;g.line(q,-7,q,7)}}c=this._majorTicks;if(2<=c)for(b=l/this._majorTicks,k=0;k<=c;k++)q=k*b,g.line(q,-10,q,10);g.fill(d);g.rect(0,
...
this._w-e.width-h}0==f.length&&(g=(this._w-e.width)/2);k.image(this._icon,g,(this._h-e.height)/2)}if(0<f.length){k.textSize(a);a=h;g=this._w-h;let q=0;e&&c==this._p.LEFT&&(a+=e.width);e&&c==this._p.RIGHT&&(g-=e.width);c=g-a;e=this._tbox.h;e=k.textAscent()+(this._h-e)/2;k.fill(l);for(let n of f){switch(d){case this._p.LEFT:q=a;break;case this._p.CENTER:q=a+(c-k.textWidth(n))/2;break;case this._p.RIGHT:q=g-k.textWidth(n)-h}k.text(n,q,e);e+=k.textLeading()}}this._isOver&&(k.stroke(p),k.strokeWeight(2),
k.noFill(),k.rect(1,1,this._w-2,this._h-2,...this._c));this._enabled||this._disable_hightlight(k,b,0,0,this._w,this._h);this._updateRectControlPB();k.pop();this._bufferInvalid=!1;this._parent instanceof CvsPane&&this._parent.validateTabs()}_doEvent(a,b,c,d,e){switch(a.type){case "mousedown":case "touchstart":this.isOver=this._clickAllowed=this.isActive=!0;break;case "mouseout":case "mouseup":case "touchend":this.isActive&&(this._clickAllowed&&this.action({source:this,p5Event:a}),this.isOver=this._clickAllowed=
this.isActive=!1);break;case "mousemove":case "touchmove":this._clickAllowed=!1,this.isOver=this==d.control,this._tooltip?._updateState(e)}return this.isActive?this:null}}
...
this._gui.getOptionGroup(a);this._optGroup.add(this);return this}_doEvent(a,b,c,d,e){switch(a.type){case "mousedown":case "touchstart":this.isOver=this._clickAllowed=this.isActive=!0;break;case "mouseout":case "mouseup":case "touchend":this.isActive&&this._clickAllowed&&!this._selected&&this._optGroup&&(this.select(),this.action({source:this,p5Event:a,selected:!0}));this.isOver=this._clickAllowed=this.isActive=!1;break;case "mousemove":case "touchmove":this._clickAllowed=!1,this.isOver=this==d.control,
...
c.RIGHT?this._w-g-d/2:g+d/2,m.height/2);m.stroke(q);m.fill(k);m.strokeWeight(1.5);m.ellipse(0,0,d,d);this._selected&&(m.fill(q),m.noStroke(),m.ellipse(0,0,d/2,d/2));m.pop();if(0<h.length){m.textSize(a);a=g;l=this._w-g;k=0;e==c.LEFT&&(a+=d+g);e==c.RIGHT&&(l-=d+g);d=l-a;e=this._tbox.h;e=m.textAscent()+(this._h-e)/2;m.fill(p);for(let t of h){switch(f){case c.LEFT:k=a;break;case c.CENTER:k=a+(d-m.textWidth(t))/2;break;case c.RIGHT:k=l-m.textWidth(t)-g}m.text(t,k,e);e+=m.textLeading()}}this.isOver&&(m.stroke(n),
...
d,e){switch(a.type){case "mousedown":case "touchstart":this.isOver=this._clickAllowed=this.isActive=!0;break;case "mouseout":case "mouseup":case "touchend":this.isActive&&this._clickAllowed&&(this._selected=!this._selected,this.action({source:this,p5Event:a,selected:this._selected}));this.isOver=this._clickAllowed=this.isActive=!1;break;case "mousemove":case "touchmove":this._clickAllowed=!1,this.isOver=this==d.control,this._tooltip?._updateState(e)}return this.isActive?this:null}_updateControlVisual(){var a=
this._textSize||this._gui.textSize();let b=this._scheme||this._gui.scheme(),c=this._p;var d=c.constrain(.7*Number(a),12,16),e=this._iconAlign;let f=this._textAlign,h=this._lines,g=this._gap;var l=b.C_3;const p=b.C_8;var k=b.G_0;const q=b.G_9,n=b.C_9;let m=this._uiBfr;m.push();m.clear();this._opaque&&(m.noStroke(),m.fill(l),m.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));m.push();m.translate(e==c.RIGHT?this._w-g-d/2:g+d/2,m.height/2);m.stroke(q);m.fill(k);m.strokeWeight(1.5);
m.rect(-d/2,-d/2,d,d,3);this._selected&&(m.strokeWeight(2.5),m.line(-.281*d,0,-.188*d,.313*d),m.line(.27*d,-.27*d,-.188*d,.313*d));m.pop();if(0<h.length){m.textSize(a);a=g;l=this._w-g;k=0;e==c.LEFT&&(a+=d+g);e==c.RIGHT&&(l-=d+g);d=l-a;e=this._tbox.h;e=m.textAscent()+(this._h-e)/2;m.fill(p);for(let t of h){switch(f){case c.LEFT:k=a;break;case c.CENTER:k=a+(d-m.textWidth(t))/2;break;case c.RIGHT:k=l-m.textWidth(t)-g}m.text(t,k,e);e+=m.textLeading()}}this._isOver&&(m.stroke(n),m.strokeWeight(2),m.noFill(),
...
0>h&&g>this._lw?a=this._lw/2:this._xor(0>h,g>this._lw)&&(a=0>h?a-h:a+(this._lw-g));f||0>l&&d>this._lh?b=this._lh/2:this._xor(0>l,d>this._lh)&&(b=0>l?b-l:b+(this._lh-d));this.view(a,b);this.invalidateBuffer()}_updateControlVisual(){var a=this._scheme||this._gui.scheme();let [b,c,d]=[this._wscale,this._wcx,this._wcy],[e,f,h,g]=[this._w,this._h,this._lw,this._lh];var l=a.C_2;a=a.C_7;let p=this._uiBfr;p.push();this._opaque?p.background(l):p.clear();l=Math.round(.5*e/b);var k=Math.round(.5*f/b);l=this._overlap(0,
0,h,g,c-l,d-k,c+l,d+k);let [q,n]=[Math.round(l.offsetX*b),Math.round(l.offsetY*b)],[m,t]=[Math.round(l.width*b),Math.round(l.height*b)];if(l.valid)for(let r=0,u=this._layers.length;r<u;r++)!this._hidden.has(r)&&this._layers[r]&&(k=this._layers[r].get(l.left,l.top,l.width,l.height),.01<Math.abs(b-1)&&k.resize(m,t),p.image(k,l.offsetX*b,l.offsetY*b,k.width,k.height));0<this._frameWeight&&(p.noFill(),p.stroke(a),p.strokeWeight(this._frameWeight),p.rect(0,0,p.width,p.height));this._updateViewerPickBuffer(q,
n,m,t);p.pop()}_updateViewerPickBuffer(a,b,c,d){let e=this._gui.pickColor(this),f=this._pkBfr;f.push();f.clear();f.noStroke();f.fill(e.r,e.g,e.b);f.rect(a,b,c,d);f.pop()}_overlap(a,b,c,d,e,f,h,g){var l=Math.min(b,d);b=Math.max(b,d);d=Math.min(a,c);c=Math.max(a,c);a=Math.min(f,g);g=Math.max(f,g);f=Math.min(e,h);h=Math.max(e,h);if(b<=a||g<=l||c<=f||h<=d)return{valid:!1};e=d<f?f:d;h=c>h?h:c;b=b>g?g:b;l=l<a?a:l;d=h-e;g=b-l;f=e-f;a=l-a;this._scrH.update(void 0,d/this._lw);this._scrV.update(void 0,g/this._lh);
return{valid:!0,left:e,right:h,top:l,bottom:b,width:d,height:g,offsetX:f,offsetY:a}}_xor(a,b){return(a||b)&&!(a&&b)}_minControlSize(){return{w:this._w,h:this._h}}}
...
2*this._gap-a/2}_removeSelectedText(a){let b=Math.min(this._prevCsrIdx,this._currCsrIdx),c=Math.max(this._prevCsrIdx,this._currCsrIdx);this._prevCsrIdx=this._currCsrIdx=b;return a.substring(0,b)+a.substring(c)}_updateControlVisual(){var a=Number(this._textSize||this._gui.textSize());let b=this._scheme||this._gui.scheme(),c=0<this._lines.length?this._lines[0]:"";var d=this._textInvalid;let e=2*this._gap;const f=b.G_9,h=b.C_9,g=b.C_3;let l=b.C_1,p=b.C_9,k=this._uiBfr;k.push();k.textSize(a);k.background(b.G_0);
k.noStroke();if(!this.isActive)l=d?b.C_9:b.C_1,p=d?b.C_3:b.C_9,k.stroke(p),k.strokeWeight(1.5),k.fill(l),k.rect(0,0,this._w,this._h);else if(this._currCsrIdx!=this._prevCsrIdx){d=this._cursorX(k,c,this._prevCsrIdx);let q=this._cursorX(k,c,this._currCsrIdx);k.noStroke();k.fill(g);k.rect(e+Math.min(d,q),1,Math.abs(d-q),this._h-2)}k.fill(l);k.textSize(a);k.textAlign(this._p.LEFT,this._p.TOP);k.noStroke();k.fill(p);k.text(c,e,(this._h-a)/2);this._activate&&this._cursorOn&&(a=this._cursorX(k,c,this._currCsrIdx),
k.stroke(f),k.strokeWeight(1.5),k.line(e+a,4,e+a,this._h-5));this.isOver&&(k.stroke(h),k.strokeWeight(2),k.noFill(),k.rect(1,1,this._w-2,this._h-2,this._c[0],this._c[1],this._c[2],this._c[3]));this._enabled||this._disable_hightlight(k,b,0,0,this._w,this._h);this._updateRectControlPB();k.pop();this._bufferInvalid=!1}}
...
Math.cos(this._ang),this._mag*Math.sin(this._ang)]}_validateThumbPosition(a,b){let c=this._p.constrain(Math.sqrt(a*a+b*b),0,this._pr1);a=Math.atan2(b,a);a+=0>a?2*Math.PI:0;b=c<=this._pr0;let d=-1,e;switch(this._mode){case "X4":e=Math.PI/2;d=Math.floor((a+e/2)/e)%4;a=e*d;d*=2;break;case "X8":e=Math.PI/4,d=Math.floor((a+e/2)/e)%8,a=e*d}[this._mag,this._ang,this._dir,this._dead]=[c,a,d,b]}_doEvent(a,b=0,c=0,d,e){function f(k,q,n){return{source:k,p5Event:q,final:n,mag:(k._mag-k._pr0)/(k._pr1-k._pr0),
angle:k._ang,dir:k._dir,dead:k._dead}}let [h,g,l,p]=this._orientation.xy(b-this._x,c-this._y,this.w,this.h);h-=l/2;g-=p/2;switch(a.type){case "mousedown":case "touchstart":this.isOver=this.isActive=!0;break;case "mouseout":case "mouseup":case "touchend":this._validateThumbPosition(h,g);this.action(f(this,a,!0));this.isActive=!1;this.invalidateBuffer();this._tmrID||(this._tmrID=setInterval(()=>{this._mag-=.07*this._size;0>=this._mag&&(clearInterval(this._tmrID),this._tmrID=void 0,this._mag=0);this.invalidateBuffer()},
25));break;case "mousemove":case "touchmove":this.isActive&&(this._validateThumbPosition(h,g),this.action(f(this,a,!1))),this.isOver=this==d.control,this._tooltip?._updateState(e),this.invalidateBuffer()}return this.isActive?this:null}_updateControlVisual(){var a=this._scheme||this._gui.scheme();let [b,c]=[this._mag*Math.cos(this._ang),this._mag*Math.sin(this._ang)];var d=a.C_3,e=a.C_1,f=a.T_0;const h=a.C_9,g=a.C_9,l=a.C_4,p=a.C_6,k=a.C_7;var q=a.C_8;a=a.T_5;let n=this._uiBfr;n.push();n.clear();this._opaque&&
...
4;n.push();n.strokeWeight(1);for(e=0;8>e;e++)n.line(f,0,d,0),n.rotate(q);n.pop();case "X4":f=this._pr0;d=this._pr1;q=Math.PI/2;n.push();n.strokeWeight(1.5);for(e=0;4>e;e++)n.line(f,0,d,0),n.rotate(q);n.pop()}n.stroke(h);n.strokeWeight(Math.max(3,.025*this._size));n.noFill();n.ellipse(0,0,2*this._pr1,2*this._pr1);n.fill(a);n.noStroke();n.ellipse(0,0,2*this._pr0,2*this._pr0);n.stroke(k);n.strokeWeight(.05*this._size);n.line(0,0,b,c);n.strokeWeight(2);n.stroke(g);this.isActive||this.isOver?n.fill(p):
n.fill(l);n.ellipse(b,c,2*this._tSize,2*this._tSize);this._updateJoystickPickBuffer(b,c,this._tSize);n.pop();this._bufferInvalid=!1}_updateJoystickPickBuffer(a,b,c){let d=this._gui.pickColor(this),e=this._pkBfr;e.push();e.clear();e.translate(e.width/2,e.height/2);e.noStroke();e.fill(d.r,d.g,d.b);e.ellipse(a,b,2*c,2*c);e.pop()}}
...
h;this.isOver=this.isActive=!0;this.invalidateBuffer();break;case "mouseout":case "mouseup":case "touchend":b=this._tFromXY(f,h);this._t01=this._s2ticks?this._nearestTickT(b.t):b.t;this.action({source:this,p5Event:a,value:this.value(),final:!0});this.isActive=!1;this.invalidateBuffer();break;case "mousemove":case "touchmove":this.isActive&&(b=this._tFromXY(f,h),b=this._s2ticks?this._nearestTickT(b.t):b.t,this._t01!=b&&(this._prevX=f,this._prevY=h,this._t01=b,this.action({source:this,p5Event:a,value:this.value(),
final:!1}))),this.isOver=this==d.control,this._tooltip?._updateState(e),this.invalidateBuffer()}return this.isActive?this:null}_updateControlVisual(){var a=this._scheme||this._gui.scheme(),b=a.C_3,c=a.C_7;const d=a.C_8,e=a.C_3,f=a.C_9;var h=a.C_3,g=a.C_1,l=a.G_8;const p=a.G_2,k=a.T_1;a=this._uiBfr;a.clear();this._opaque&&(a.noStroke(),a.fill(b),a.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));b=this._turnArc;var q=(2*Math.PI-b)/2;let n=this._gRad,m=2*this._kRad,t=2*n;a.push();
a.translate(a.width/2,a.height/2);a.rotate(this._gapPos+q);a.noStroke();a.fill(h);a.ellipse(0,0,m,m);a.fill(g);a.arc(0,0,m,m,0,this._turnArc);h=this._majorTicks*this._minorTicks;if(2<=h){g=this._tw;q=.65*g;a.stroke(l);l=b/h;a.push();a.strokeWeight(.9);for(let r=0;r<=h;r++)a.line(n,0,n+q,0),a.rotate(l);a.pop();h=this._majorTicks;if(2<=h){l=b/h;a.push();a.strokeWeight(1);for(q=0;q<=h;q++)a.line(n,0,n+g,0),a.rotate(l);a.pop()}a.noStroke();a.fill(k);a.arc(0,0,t+g,t+g,0,b);a.fill(p);a.arc(0,0,t+g,t+g,
0,this._t01*b)}a.stroke(d);a.strokeWeight(1.5);a.fill(c);a.ellipse(0,0,t,t);a.push();a.rotate(this._t01*b);c=.2*n;a.fill(e);a.noStroke();a.beginShape();a.vertex(-c,0);a.vertex(0,-c);a.vertex(n,0);a.vertex(0,c);a.endShape(this._p.CLOSE);a.pop();this.isOver&&(a.noFill(),a.stroke(f),a.strokeWeight(3),a.arc(0,0,2*this._kRad,2*this._kRad,0,b));this._updateKnobPickBuffer(m);a.pop();this._bufferInvalid=!1}_updateKnobPickBuffer(a){let b=this._gui.pickColor(this),c=this._pkBfr;c.push();c.clear();c.translate(c.width/
...
class CvsPanel extends CvsBufferedControl{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||100,f||100);this._opaque=this._canDragY=this._canDragX=!0}get _canDrag(){return this._canDragX||this._canDragY}_doEvent(a,b=0,c=0,d,e){e=this.getAbsXY();this._orientation.xy(b-e.x,c-e.y,this._w,this._h);switch(a.type){case "mousedown":case "touchstart":0==d.part&&(this.isOver=this.isActive=!0);break;case "mouseout":case "mouseup":case "touchend":this.isOver=this.isActive=!1;break;case "mousemove":case "touchmove":this.isActive&&
CLOG("stuff to do"),this.isOver=this==d.control,this.invalidateBuffer()}return this.isActive?this:null}_updateControlVisual(){var a=this._scheme||this._gui.scheme();const b=a.C_1;a=a.C_6;let c=this._uiBfr;c.push();c.clear();this._opaque&&(c.noStroke(),c.fill(b),c.rect(0,0,this._w,this._h,...this._c));c.noStroke();this._isOver&&(c.strokeWeight(2),c.stroke(a));this._updateRectControlPB();this._bufferInvalid=!1}_updateSliderPickBuffer(a,b,c,d,e){d=Math.round(d);b=this._gui.pickColor(this);c=this._pkBfr;
c.push();c.clear();c.noStroke();c.translate(10,a);c.fill(b.r,b.g,b.b);c.rect(d-e/2,-e/2,e,e);c.pop()}_minControlSize(){return{w:this._w,h:20}}}
class CvsPane extends CvsBaseControl{constructor(a,b,c,d,e,f){super(a,b,c,d,e,f);this._background="rgba(0,0,0,0.6)";this._x=c;this._y=d;this._w=e;this._h=f;this._cornerRadius=5;this._status="closed";this._timer=0;this._z=PANE_Z}orient(a){return this}parent(a,b,c){return this}transparent(){return this}opaque(){return this}leaveParent(){console.warn("Panes cannot have a parent")}depth(){return this._depth}background(a){switch(a){case "dark":this._background="rgba(0,0,0,0.6)";break;case "light":this._background=
"rgba(255,255,255,0.6)";break;default:this._background=a}return this}close(){switch(this._status){case "opening":clearInterval(this._timer);case "open":this._timer=setInterval(()=>{this._closing()},CvsPane._dI),this._status="closing",this.action({source:this,p5Event:void 0,state:"closed"})}return this}isClosed(){return"closed"==this._status}isClosing(){return"closing"==this._status}open(){switch(this._status){case "closing":clearInterval(this._timer);case "closed":this._gui._closePanes(),this._timer=
setInterval(()=>{this._opening()},CvsPane._dI),this._status="opening",this.action({source:this,p5Event:void 0,state:"open"})}}isOpen(){return"open"==this._status}isOpening(){return"opening"==this._status}_tabAction(a){a=a.source._parent;switch(a._status){case "open":a.close();break;case "closed":a.open()}}_draw(a,b){a.push();a.translate(this._x,this._y);b.push();b.drawingContext.setTransform(a.drawingContext.getTransform());if(this._visible&&"closed"!=this._tabstate){a.noStroke();a.fill(this._background);
a.rect(0,0,this._w,this._h);b.noStroke();b.fill("white");b.rect(0,0,this._w,this._h);for(let c of this._children)c._visible&&c._draw(a,b)}b.pop();a.pop()}text(a,b){this.tab().text(a,b);return this}noText(){this.tab().noText();return this}icon(a,b){this.tab().icon(a,b);return this}noIcon(){this.tab().noIcon();return this}textSize(a){this.tab().textSize(a);return this}shrink(a){return this.tab().shrink()}tab(){return this._children[0]}enable(){this.tab().enable();return this}disable(){this.close();
this.tab().disable();return this}hide(){this.close();this.tab().hide();return this}show(){this.tab().show();return this}_minControlSize(){return{w:this._w,h:this._h}}}CvsPane._dI=50;CvsPane._dC=60;CvsPane._dO=40;CvsPane._wExtra=20;CvsPane._tabID=1;
...
this._x=a}_closing(){let a=this._x-CvsPane._dC;a<-this._depth&&(a=-this._depth,clearInterval(this._timer),this._status="closed");this._x=a}validateTabs(){this._gui.validateTabsWest();return this}}Object.assign(CvsPane.prototype,NoOrient);Object.assign(CvsPane.prototype,NoParent);Object.assign(CvsPane.prototype,FixedBackground);Object.assign(CvsPane.prototype,NoTooltip);
