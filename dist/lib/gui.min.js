/*
 ...
 @version 2.0.0
*/
const CANVAS_GUI_VERSION="2.0.0",[CLOG,CWARN,CERROR,CASSERT,CCLEAR]=[console.log,console.warn,console.error,console.assert,console.clear],GUIS=new Map,DELTA_Z=64,PANEL_Z=2048,PANE_Z=4096;
class GUI{constructor(a,b=p5.instance){this._keyListenersCreated=this._mouseListenersCreated=this._touchListenersCreated=!1;this._enabled=this._visible=!0;this._renderer=a;this._canvas=a.canvas;this._target=document.getElementById(a.canvas.id);this._p=b;this._controls=new Map;this._ctrls=[];this._corners=[4,4,4,4];this._optionGroups=new Map;this._textSize=12;this._tipTextSize=10;this._COLOR_STEP=8;this._PART_MASK=this._COLOR_STEP-1;this._COLOR_MASK=16777215^this._PART_MASK;this._NEXT_COLOR=this._COLOR_STEP;
this._colorKey=new Map;this._ctrlKey=new Map;this._panesEast=[];this._panesSouth=[];this._panesWest=[];this._panesNorth=[];this._initColorSchemes();this._addFocusHandlers();this._addMouseEventHandlers();this._addTouchEventHandlers();this._activeCtrl=this._overCtrl=null;this._activePart=0;this._drawHud=a.GL?this._drawHudWEBGL:this._drawHudP2D;this._validateGuiBuffers();this._getCamera=1==Number(b.VERSION.split(".")[0])?function(){return this._renderer._curCamera}:function(){return this._renderer.states.curCamera}}get overCtrl(){return this._overCtrl}set overCtrl(a){this._overCtrl=
a}get activeCtrl(){return this._activeCtrl}set activeCtrl(a){this._activeCtrl=a}get activePart(){return this._activePart}set activePart(a){this._activePart=a}_validateGuiBuffers(){let a=this._p;this._hud&&this._hud.width==a.width&&this._hud.height==a.height||(this._hud=a.createGraphics(a.width,a.height),this._hud.pixelDensity(window.devicePixelRatio),this._hud.clear(),this._pickbuffer=a.createGraphics(a.width,a.height),this._pickbuffer.pixelDensity(window.devicePixelRatio),this._pickbuffer.clear())}slider(a,
...
a,b,c,d,e),!1)}viewer(a,b,c,d,e){return this.addControl(new CvsViewer(this,a,b,c,d,e),!0)}joystick(a,b,c,d,e){return this.addControl(new CvsJoystick(this,a,b,c,d,e),!0)}knob(a,b,c,d,e){return this.addControl(new CvsKnob(this,a,b,c,d,e),!0)}__scroller(a,b,c,d,e){return this.addControl(new CvsScroller(this,a,b,c,d,e),!0)}__tooltip(a){return this.addControl(new CvsTooltip(this,a),!1)}pane(a,b,c){c=Math.round(c);switch(b){case "north":a=new CvsPaneNorth(this,a,c);break;case "south":a=new CvsPaneSouth(this,
a,c);break;case "west":a=new CvsPaneWest(this,a,c);break;default:a=new CvsPaneEast(this,a,c)}return this.addControl(a,!1)}grid(a,b,c,d){return new GridLayout(a,b,c,d)}name(){return this._uid}show(){this._visible=!0;return this}hide(){this._visible=!1;return this}isVisible(){return this._visible}enable(){this._enabled=!0;return this}disable(){this._enabled=!1;return this}isEnabled(){return this._enabled}_addFocusHandlers(){this._canvas.addEventListener("focusout",a=>{this._processFocusEvent(a)})}_addMouseEventHandlers(){if(!this._mouseListenersCreated){let a=
this._canvas;a.addEventListener("mousedown",b=>{this._processMouseEvent(b)});a.addEventListener("mouseup",b=>{this._processMouseEvent(b)});a.addEventListener("mousemove",b=>{this._processMouseEvent(b)});a.addEventListener("wheel",b=>{this._processMouseEvent(b)});a.addEventListener("mouseout",b=>{this._processMouseEvent(b)});a.addEventListener("mouseenter",b=>{this._processMouseEvent(b)});this._mouseListenersCreated=!0}}_addKeyEventHandlers(){this._keyListenersCreated||(this._target.setAttribute("tabindex",
"0"),this._target.focus(),this._target.addEventListener("keydown",a=>{this._processKeyEvent(a);return!1}),this._target.addEventListener("keyup",a=>{this._processKeyEvent(a);return!1}),this._keyListenersCreated=!0)}_addTouchEventHandlers(){if(!this._touchListenersCreated){let a=this._canvas;a.addEventListener("touchstart",b=>{this._processTouchEvent(b)});a.addEventListener("touchend",b=>{this._processTouchEvent(b)});a.addEventListener("touchmove",b=>{this._processTouchEvent(b)});a.addEventListener("touchcancel",
b=>{this._processTouchEvent(b)});this._touchListenersCreated=!0}}_processMouseEvent(a){if(this._visible&&this._enabled){const b=this._canvas.getBoundingClientRect();this._processEvent(a,a.clientX-b.left,a.clientY-b.top)}}_processTouchEvent(a){if(this._visible&&this._enabled){const b=this._canvas.getBoundingClientRect(),c=a.changedTouches[0];this._processEvent(a,c.clientX-b.left,c.clientY-b.top)}}_processEvent(a,b,c){if(!(this.activeCtrl instanceof CvsTextField)){var d=this.getPicked(b,c);this.activeCtrl?
this.activeCtrl=this.activeCtrl._doEvent(a,b,c,d):(d=this.getPicked(b,c),"mousemove"==a.type||"touchmove"==a.type?(this.overCtrl?._doEvent(a,b,c,d),d.control&&(d.control?._doEvent(a,b,c,d),this.overCtrl=d.control)):this.activeCtrl=d.control?._doEvent(a,b,c,d))}}_processKeyEvent(a){this._visible&&this._enabled&&this._activeCtrl instanceof CvsTextField&&(this.activeCtrl=this.activeCtrl._doKeyEvent(a))}_processFocusEvent(a){switch(a.type){case "focusout":this.activeCtrl instanceof CvsTextField&&(this.activeCtrl.validate(),
this.activeCtrl._deactivate(),this.activeCtrl=null)}}$(a){return"string"===typeof a?this._controls.get(a):a}addControl(a,b=!1){CASSERT(!this._controls.has(a.id),`Control '${a.id}' already exists and will be replaced.`);this._controls.set(a.id,a);this._ctrls=[...this._controls.values()];this.setRenderOrder();b&&this.register(a);return a}setRenderOrder(){this._ctrls.sort((a,b)=>a.z-b.z)}register(a){a&&!this._ctrlKey.has(a)&&(this._ctrlKey.set(a,this._NEXT_COLOR),this._colorKey.set(this._NEXT_COLOR,
...
c.setAttribute("padding","3px");c.style.border="2px solid #000000";if(c instanceof HTMLCanvasElement){a=window.devicePixelRatio;let [d,e,f]=[b.canvas,b.width*a,b.height*a];b=c.getContext("2d");c=b.canvas;b.drawImage(d,0,0,e,f,0,0,c.width,c.height)}}listControls(){CLOG("--------------------   List of controls   --------------------");this._ctrls.forEach(a=>{let b=`${a.id}                               `.substring(0,15),c=`${a.constructor.name}                   `.substring(0,15),d=`Z: ${a.z}      `.substring(0,
10);a=`Color key: ${this._ctrlKey.get(a)}`;CLOG(b+c+d+a)});CLOG("--------------------------------------------------------------")}getOptionGroup(a){this._optionGroups.has(a)||this._optionGroups.set(a,new CvsOptionGroup(a));return this._optionGroups.get(a)}textSize(a){if(!Number.isFinite(a))return this._textSize;this._textSize=a;this._controls.forEach(b=>{b.invalidateBuffer()});return this}tipTextSize(a){return a?(this._tipTextSize=a,this):this._tipTextSize}canvasWidth(){return this._renderer.width}canvasHeight(){return this._renderer.height}corners(a){Array.isArray(a)&&
4==a.length&&(this._corners=[...a]);return[...this._corners]}context(){return this._renderer}_closePanes(){for(let a of this._panesEast)a.close();for(let a of this._panesWest)a.close();for(let a of this._panesSouth)a.close();for(let a of this._panesNorth)a.close()}hidePanes(){this._closePanes();for(let a of this._panesEast)a.hide();for(let a of this._panesWest)a.hide();for(let a of this._panesSouth)a.hide();for(let a of this._panesNorth)a.hide()}showPanes(){for(let a of this._panesEast)a.show();for(let a of this._panesWest)a.show();
for(let a of this._panesSouth)a.show();for(let a of this._panesNorth)a.show()}validateTabsEast(){let a=this._panesEast,b=a.length,c=2*(b-1);a.forEach(e=>c+=e.tab()._w);let d=(this.canvasHeight()-c)/2;for(let e=0;e<b;e++){let f=a[e].tab(),h=-f._h,g=d;d+=f._w+2;f._x=h;f._y=g}}validateTabsWest(){let a=this._panesWest,b=a.length,c=2*(b-1);a.forEach(f=>c+=f.tab()._w);let d=(this.canvasHeight()-c)/2;for(let f=0;f<b;f++){var e=a[f];let h=e.tab();e=e.depth();let g=d;d+=h._w+2;h._x=e;h._y=g}}validateTabsSouth(){let a=
this._panesSouth,b=a.length,c=2*(b-1);a.forEach(e=>c+=e.tab()._w);let d=(this.canvasWidth()-c)/2;for(let e=0;e<b;e++){let f=a[e].tab(),h=d,g=-f._h;d+=f._w+2;f._x=h;f._y=g}}validateTabsNorth(){let a=this._panesNorth,b=a.length,c=2*(b-1);a.forEach(f=>c+=f.tab()._w);let d=(this.canvasWidth()-c)/2;for(let f=0;f<b;f++){var e=a[f];let h=e.tab(),g=d;e=e.depth();d+=h._w+2;h._x=g;h._y=e}}_initColorSchemes(){this._schemes=[];this._schemes.blue=new BlueScheme;this._schemes.green=new GreenScheme;this._schemes.red=
new RedScheme;this._schemes.cyan=new CyanScheme;this._schemes.yellow=new YellowScheme;this._schemes.purple=new PurpleScheme;this._schemes.orange=new OrangeScheme;this._schemes.light=new LightScheme;this._schemes.dark=new DarkScheme;this._scheme=this._schemes.blue}scheme(a){if(!a)return this._scheme;this._schemes[a]?(this._scheme=this._schemes[a],this._controls.forEach(b=>{b.scheme()||b.invalidateBuffer()})):CERROR(`'${a}' is not a valid color scheme`);return this}_getScheme(a){if(a&&this._schemes[a])return Object.assign({},
this._schemes[a]);CWARN(`Unable to retrieve color scheme '${a}'`)}addScheme(a,b){"string"!==typeof a||b||(this._schemes[a]?CERROR(`Cannot add scheme '${a}' because it already exists.'`):this._schemes[a]=b);return this}draw(){this._hud.clear();this._pickbuffer.clear();if(this._visible){this._p.push();for(let a of this._ctrls)a.getParent()||a._draw(this._hud,this._pickbuffer);this._p.pop();this._drawHud()}}_drawHudP2D(){this._p.push();this._p.image(this._hud,0,0);this._p.pop()}_drawHudWEBGL(){this._p.push();
let a=this._renderer,b=a.drawingContext,c=a.width,d=a.height,e=Number.MAX_VALUE;b.flush();let f=a.uMVMatrix.copy(),h=a.uPMatrix.copy();b.disable(b.DEPTH_TEST);a.resetMatrix();this._getCamera().ortho(0,c,-d,0,-e,e);this._p.image(this._hud,0,0);b.flush();a.uMVMatrix.set(f);a.uPMatrix.set(h);b.enable(b.DEPTH_TEST);this._p.pop()}getPicked(a,b){let c=this._pickbuffer,d={control:null,part:-1};0<=a&&a<c.width&&0<=b&&b<c.height&&(a=c.get().get(a,b),a=(a[0]<<16)+(a[1]<<8)+a[2],d.control=this._colorKey.get(a&
this._COLOR_MASK),d.part=a&this._PART_MASK);return d}}
...
default:this._w=b.w,this._h=b.h}this._validateControlBuffers();this.invalidateBuffer();return this}corners(a){return Array.isArray(a)&&4==a.length?(this._c=[...a],this):[...this._c]}tooltip(a,b=1600){a=this._gui.__tooltip(this._id+".tooltip").text(a).showTime(b).shrink();this.addChild(a);a instanceof CvsTooltip&&(a._validatePosition(),this._tooltip=a);return this}tipTextSize(a){this._tooltip&&a&&0<a&&this._tooltip.textSize(a);return this}}
...
(a-this._limit0)*(a-this._limit1)?(this.invalidateBuffer(),this._t01=this._norm01(a),this):this._t2v(this._t01)}_t2v(a){return this._limit0+a*(this._limit1-this._limit0)}_v2t(a){return(a-this._limit0)/(this._limit1-this._limit0)}_norm01(a,b=this._limit0,c=this._limit1){return this._p.map(a,b,c,0,1,!0)}_whereOver(a,b,c=8){let d=this._uiBfr.height/2;return Math.abs(this._t01*(this._uiBfr.width-20)-(a-10))<=c&&Math.abs(d-b)<=c?1:0}_doEvent(a,b,c,d){let e=this.getAbsXY();[b]=this._orientation.xy(b-e.x,
c-e.y,this._w,this._h);switch(a.type){case "mousedown":case "touchstart":0==d.part&&(this.isActive=!0,this._part=d.part,this.isOver=!0);break;case "mouseout":case "mouseup":case "touchend":this.action({source:this,p5Event:a,value:this.value(),final:!0});this.isOver=this.isActive=!1;break;case "mousemove":case "touchmove":this.isActive&&(b=this._norm01(b-10,0,this._uiBfr.width-20),this._s2ticks&&(b=this._nearestTickT(b)),this._t01!=b&&(this._t01=b,this.action({source:this,p5Event:a,value:this.value(),
final:!1}))),this.isOver=this==d.control,this.invalidateBuffer()}return this.isActive?this:null}_nearestTickT(a){let b=0<this._minorTicks?this._minorTicks*this._majorTicks:this._majorTicks;return 0<b?Math.round(a*b)/b:a}_updateControlVisual(){let a=this._scheme||this._gui.scheme();var b=a.C_3,c=a.G_7,d=a.G_3;const e=a.G_1,f=a.C_9,h=a.C_6;let g=this._uiBfr,k=g.width-20,p=Math.round(g.height/2);g.push();g.clear();this._opaque&&(g.noStroke(),g.fill(b),g.rect(0,0,this._w,this._h,...this._c));g.translate(10,
p);g.stroke(c);g.strokeWeight(1);c=this._majorTicks*this._minorTicks;if(2<=c){b=k/c;for(var l=0;l<=c;l++){var q=l*b;g.line(q,-7,q,7)}}c=this._majorTicks;if(2<=c)for(b=k/c,l=0;l<=c;l++)q=l*b,g.line(q,-10,q,10);g.fill(d);g.rect(0,-4,k,8);d=k*this._t01;g.fill(e);g.rect(0,-4,d,8,...this._c);g.fill(h);g.noStroke();this._isOver&&(g.strokeWeight(2),g.stroke(f));g.rect(d-6,-6,12,12,...this._c);this._enabled||this._disable_hightlight(g,a,-10,-this._h/2,this._w,this._h);this._updateSliderPickBuffer(p,k,8,d,
12);g.pop();this._bufferInvalid=!1}_updateSliderPickBuffer(a,b,c,d,e){d=Math.round(d);b=this._gui.pickColor(this);c=this._pkBfr;c.push();c.clear();c.noStroke();c.translate(10,a);c.fill(b.r,b.g,b.b);c.rect(d-e/2,-e/2,e,e);c.pop()}_minControlSize(){return{w:this._w,h:20}}}
class CvsRanger extends CvsSlider{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||100,f||20);this._t=[.25,.75];this._tIdx=-1;this._limit0=0;this._limit1=1;this._opaque=!1}range(a,b){if(Number.isFinite(a)&&Number.isFinite(b)){let c=this._norm01(Math.min(a,b));a=this._norm01(Math.max(a,b));if(0<=c&&1>=c&&0<=a&&1>=a)return this._bufferInvalid=this._t[0]!=c||this._t[1]!=a,this._t[0]=c,this._t[1]=a,this}return{low:this._t2v(this._t[0]),high:this._t2v(this._t[1])}}low(){return this._t2v(this._t[0])}high(){return this._t2v(this._t[1])}value(a){console.warn("Ranger controls require 2 values - use range(v0, v1) instead")}_doEvent(a,
b,c,d){let e=this.getAbsXY();[b]=this._orientation.xy(b-e.x,c-e.y,this._w,this._h);switch(a.type){case "mousedown":case "touchstart":if(0==d.part||1==d.part)this.isActive=!0,this._tIdx=d.part,this.isOver=!0;break;case "mouseout":case "mouseup":case "touchend":this.isActive&&(d=Math.min(this._t[0],this._t[1]),b=Math.max(this._t[0],this._t[1]),this._t[0]=d,this._t[1]=b,this._tIdx=-1,this.action({source:this,p5Event:a,low:this._t2v(d),high:this._t2v(b),final:!0}),this.isActive=!1,this.invalidateBuffer());
break;case "mousemove":case "touchmove":this.isActive&&(d=this._norm01(b-10,0,this._uiBfr.width-20),this._s2ticks&&(d=this._nearestTickT(d)),this._t[this._tIdx]!=d&&(this._t[this._tIdx]=d,d=Math.max(this._t[0],this._t[1]),this.action({source:this,p5Event:a,low:this._t2v(Math.min(this._t[0],this._t[1])),high:this._t2v(d),final:!1})),this.invalidateBuffer())}return this.isActive?this:null}_updateControlVisual(){let a=this._scheme||this._gui.scheme();var b=a.C_3,c=a.G_7,d=a.G_3,e=a.G_1;const f=a.C_9,
h=a.C_6;let g=this._uiBfr,k=g.width-20,p=Math.round(g.height/2);g.push();g.clear();this._opaque&&(g.noStroke(),g.fill(b),g.rect(0,0,this._w,this._h,...this._c));g.translate(10,p);g.stroke(c);g.strokeWeight(1);c=this._majorTicks*this._minorTicks;if(2<=c){b=k/c;for(var l=0;l<=c;l++){var q=l*b;g.line(q,-7,q,7)}}c=this._majorTicks;if(2<=c)for(b=k/this._majorTicks,l=0;l<=c;l++)q=l*b,g.line(q,-10,q,10);g.fill(d);g.rect(0,-4,k,8);d=k*Math.min(this._t[0],this._t[1]);b=k*Math.max(this._t[0],this._t[1]);g.fill(e);
g.rect(d,-4,b-d,8,...this._c);for(e=0;2>e;e++)g.fill(h),g.noStroke(),(this.isActive||this.isOver)&&e==this._tIdx&&(g.strokeWeight(2),g.stroke(f)),g.rect(this._t[e]*k-6,-6,12,12,...this._c);this._enabled||this._disable_hightlight(g,a,-10,-this._h/2,this._w,this._h);this._updateRangerPickBuffer(p,k,8,d,b,12);g.pop();this._bufferInvalid=!1}_updateRangerPickBuffer(a,b,c,d,e,f){d=Math.round(d);e=Math.round(e);b=this._gui.pickColor(this);c=this._pkBfr;c.push();c.clear();c.noStroke();c.translate(10,a);c.fill(b.r,
b.g,b.b);c.rect(d-f/2,-f/2,f,f);c.fill(b.r,b.g,b.b+1);c.rect(e-f/2,-f/2,f,f);c.pop()}}
...
Math.max(this._w,a.w),this._h=Math.max(this._h,a.h),this._validateControlBuffers(),this.invalidateBuffer());return this}noIcon(){this._icon&&(this._icon=void 0,this.invalidateBuffer());return this}_minControlSize(){let a=this._uiBfr,b=this._lines,c=this._icon,d=this._textSize||this._gui.textSize(),e=this._tbox,f=0,h=0,g=this._gap;c&&(f=c.width,h=c.height,g+=this._gap);0<b.length&&(a||this._validateBuffer(),a.textSize(d),e.w=d+b.map(k=>a.textWidth(k)).reduce((k,p)=>k>p?k:p),e.h=(b.length-1)*a.textLeading()+
a.textAscent()+a.textDescent(),g+=this._gap);f+=e.w+g;h=Math.max(this._tbox.h,h)+g;return{w:Math.ceil(f),h:Math.ceil(h)}}}
class CvsLabel extends CvsTextIcon{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||60,f||16)}_updateControlVisual(){var a=this._textSize||this._gui.textSize(),b=this._scheme||this._gui.scheme();let c=this._p;var d=this._icon,e=this._iconAlign;let f=this._textAlign,h=this._lines,g=this._gap;var k=b.C_3;b=b.C_8;let p=this._uiBfr;p.push();p.clear();this._opaque&&(p.noStroke(),p.fill(k),p.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));if(d){k=0;switch(e){case c.LEFT:k=g;break;
case c.RIGHT:k=this._w-d.width-g}0==h.length&&(k=(this._w-d.width)/2);p.image(this._icon,k,(this._h-d.height+g)/2)}if(0<h.length){p.textSize(a);a=g;k=this._w-g;let l=0;d&&e==c.LEFT&&(a+=d.width);d&&e==c.RIGHT&&(k-=d.width);d=k-a;e=this._tbox.h;e=p.textAscent()+(this._h-e)/2;p.fill(b);for(let q of h){switch(f){case c.LEFT:l=a;break;case c.CENTER:l=a+(d-p.textWidth(q))/2;break;case c.RIGHT:l=k-p.textWidth(q)-g}p.text(q,l,e);e+=p.textLeading()}}p.pop();this._bufferInvalid=!1}}
class CvsButton extends CvsTextIcon{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||80,f||16)}_updateControlVisual(){var a=this._textSize||this._gui.textSize();let b=this._scheme||this._gui.scheme();var c=this._iconAlign;let d=this._textAlign;var e=this._icon;let f=this._lines,h=this._gap;var g=b.C_3;const k=b.C_8,p=b.C_9;let l=this._uiBfr;l.push();l.clear();this._opaque&&(l.noStroke(),l.fill(g),l.rect(1,1,this._w-1,this._h-1,...this._c));if(e){g=0;switch(c){case this._p.LEFT:g=h;break;case this._p.RIGHT:g=
this._w-e.width-h}0==f.length&&(g=(this._w-e.width)/2);l.image(this._icon,g,(this._h-e.height)/2)}if(0<f.length){l.textSize(a);a=h;g=this._w-h;let q=0;e&&c==this._p.LEFT&&(a+=e.width);e&&c==this._p.RIGHT&&(g-=e.width);c=g-a;e=this._tbox.h;e=l.textAscent()+(this._h-e)/2;l.fill(k);for(let n of f){switch(d){case this._p.LEFT:q=a;break;case this._p.CENTER:q=a+(c-l.textWidth(n))/2;break;case this._p.RIGHT:q=g-l.textWidth(n)-h}l.text(n,q,e);e+=l.textLeading()}}this._isOver&&(l.stroke(p),l.strokeWeight(2),
l.noFill(),l.rect(1,1,this._w-2,this._h-2,...this._c));this._enabled||this._disable_hightlight(l,b,0,0,this._w,this._h);this._updateRectControlPB();l.pop();this._bufferInvalid=!1;this._parent instanceof CvsPane&&this._parent.validateTabs()}_doEvent(a,b,c,d){switch(a.type){case "mousedown":case "touchstart":this._clickAllowed=this.isActive=!0;this._part=d.part;this.isOver=!0;break;case "mouseout":case "mouseup":case "touchend":this.isActive&&(this._clickAllowed&&this.action({source:this,p5Event:a}),
this.isOver=this._clickAllowed=this.isActive=!1);break;case "mousemove":case "touchmove":this._clickAllowed=!1,this.isOver=this==d.control}return this.isActive?this:null}}
...
if(Number.isFinite(a)&&a!==this._value){b=a=this._p.constrain(a,0,1);let c=this._used/2;a<c?b=c:a>1-c&&(b=1-c);if(this._value!=a||this._dvalue!=b)this._value=a,this._dvalue=b,this.invalidateBuffer()}}getValue(){return this._value}getUsed(){return this._used}_doEvent(a,b,c,d){[b]=this._orientation.xy(b-this._x,c-this._y,this.w,this.h);let [e,f]=[this._trackWidth,this._used/2];switch(a.type){case "mousedown":case "touchstart":0==d.part&&(this.isActive=!0,this._part=d.part,this._s_value=this._value,
this._s_mx=b,this.isOver=!0);break;case "mouseout":case "mouseup":case "touchend":this.action({source:this,p5Event:a,value:this._value,used:this._used,final:!0});this.isOver=this.isActive=!1;break;case "mousemove":case "touchmove":this.isActive&&(b=this._s_value+(b-this._s_mx)/e,0<=b-f&&1>=b+f&&(this.update(b),this.action({source:this,p5Event:a,value:this._value,used:this._used,final:!1})),this.isOver=this==d.control,this.invalidateBuffer())}return this.isActive?this:null}_updateControlVisual(){let a=
this._scheme||this._gui.scheme();const b=a.C_3,c=a.G_8,d=a.G_3,e=a.C_9,f=a.C_5;let [h,g,k,p]=[this._w,this._h,this._inset,this._used],[l,q]=[this._trackWidth,this._trackHeight],n=Math.max(p*l,this._minThumbWidth),m=this._thumbHeight,t=this._dvalue*this._trackWidth,r=this._uiBfr;r.push();r.clear();this._opaque&&(r.noStroke(),r.fill(b),r.rect(0,0,h,g,...this._c));r.translate(k,this._uiBfr.height/2);r.fill(d);r.stroke(c);r.strokeWeight(1);r.rect(0,-q/2,l,q);r.fill(f);r.noStroke();if(this.isActive||this.isOver)r.strokeWeight(2),
r.stroke(e);r.rect(t-n/2,-m/2,n,m,...this._c);this._enabled||this._disable_hightlight(r,a,0,-g/2,h-20,g);this._updateScrollerPickBuffer(t-n/2,-m/2,n,m);r.pop();this._bufferInvalid=!1}_updateScrollerPickBuffer(a,b,c,d){let e=this._gui.pickColor(this),f=this._pkBfr;f.push();f.clear();f.noStroke();f.fill(e.r,e.g,e.b);f.translate(this._inset,this._pkBfr.height/2);f.rect(Math.round(a),Math.round(b),c,d);f.pop()}_minControlSize(){return{w:this._w,h:20}}}
...
this._gui.getOptionGroup(a);this._optGroup.add(this);return this}_doEvent(a,b,c,d){switch(a.type){case "mousedown":case "touchstart":this._clickAllowed=this.isActive=!0;this._part=d.part;this.isOver=!0;break;case "mouseout":case "mouseup":case "touchend":this.isActive&&(this._clickAllowed&&!this._selected&&this._optGroup&&(this.select(),this.action({source:this,p5Event:a,selected:!0})),this.isOver=this._clickAllowed=this.isActive=!1);break;case "mousemove":case "touchmove":this._clickAllowed=!1,this.isOver=
this==d.control}return this.isActive?this:null}_updateControlVisual(){var a=this._textSize||this._gui.textSize();let b=this._scheme||this._gui.scheme(),c=this._p;var d=c.constrain(.7*Number(a),12,16),e=this._iconAlign;let f=this._textAlign,h=this._lines,g=this._gap;var k=b.C_3;const p=b.C_8;var l=b.G_0;const q=b.G_9,n=b.C_9;let m=this._uiBfr;m.push();m.clear();this._opaque&&(m.noStroke(),m.fill(k),m.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));m.push();m.translate(e==c.RIGHT?
this._w-g-d/2:g+d/2,m.height/2);m.stroke(q);m.fill(l);m.strokeWeight(1.5);m.ellipse(0,0,d,d);this._selected&&(m.fill(q),m.noStroke(),m.ellipse(0,0,d/2,d/2));m.pop();if(0<h.length){m.textSize(a);a=g;k=this._w-g;l=0;e==c.LEFT&&(a+=d+g);e==c.RIGHT&&(k-=d+g);d=k-a;e=this._tbox.h;e=m.textAscent()+(this._h-e)/2;m.fill(p);for(let t of h){switch(f){case c.LEFT:l=a;break;case c.CENTER:l=a+(d-m.textWidth(t))/2;break;case c.RIGHT:l=k-m.textWidth(t)-g}m.text(t,l,e);e+=m.textLeading()}}this.isOver&&(m.stroke(n),
...
h+b.map(g=>a.textWidth(g)).reduce((g,k)=>g>k?g:k);c.h=(b.length-1)*a.textLeading()+a.textAscent()+a.textDescent()}d+=c.w+e+f;e=Math.max(this._tbox.h,f+e)+2*e;return{w:d,h:e}}}
...
d){switch(a.type){case "mousedown":case "touchstart":this._clickAllowed=this.isActive=!0;this._part=d.part;this.isOver=!0;break;case "mouseout":case "mouseup":case "touchend":this.isActive&&(this._clickAllowed&&(this._selected=!this._selected,this.action({source:this,p5Event:a,selected:this._selected})),this.isOver=this._clickAllowed=this.isActive=!1);break;case "mousemove":case "touchmove":this._clickAllowed=!1,this.isOver=this==d.control}return this.isActive?this:null}_updateControlVisual(){var a=
this._textSize||this._gui.textSize();let b=this._scheme||this._gui.scheme(),c=this._p;var d=c.constrain(.7*Number(a),12,16),e=this._iconAlign;let f=this._textAlign,h=this._lines,g=this._gap;var k=b.C_3;const p=b.C_8;var l=b.G_0;const q=b.G_9,n=b.C_9;let m=this._uiBfr;m.push();m.clear();this._opaque&&(m.noStroke(),m.fill(k),m.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));m.push();m.translate(e==c.RIGHT?this._w-g-d/2:g+d/2,m.height/2);m.stroke(q);m.fill(l);m.strokeWeight(1.5);
m.rect(-d/2,-d/2,d,d,3);this._selected&&(m.strokeWeight(2.5),m.line(-.281*d,0,-.188*d,.313*d),m.line(.27*d,-.27*d,-.188*d,.313*d));m.pop();if(0<h.length){m.textSize(a);a=g;k=this._w-g;l=0;e==c.LEFT&&(a+=d+g);e==c.RIGHT&&(k-=d+g);d=k-a;e=this._tbox.h;e=m.textAscent()+(this._h-e)/2;m.fill(p);for(let t of h){switch(f){case c.LEFT:l=a;break;case c.CENTER:l=a+(d-m.textWidth(t))/2;break;case c.RIGHT:l=k-m.textWidth(t)-g}m.text(t,l,e);e+=m.textLeading()}}this._isOver&&(m.stroke(n),m.strokeWeight(2),m.noFill(),
...
k)=>g>k?g:k);c.h=(b.length-1)*a.textLeading()+a.textAscent()+a.textDescent()}d+=c.w+e+f;e=Math.max(this._tbox.h,f+e)+2*e;return{w:d,h:e}}}
class CvsViewer extends CvsBufferedControl{constructor(a,b,c,d,e,f){super(a,b,c,d,e,f);this._layers=[];this._hidden=new Set;this._wcy=this._wcx=this._lh=this._lw=0;this._wscale=1;this._usedY=this._usedX=0;this._scalerZone={x0:0,y0:0,x1:0,y1:0};this._frameWeight=0;this._scrH=a.__scroller(this._id+"-scrH",4,f-24,e-28,20).hide().setAction(h=>{this.view(h.value*this._lw,this._wcy);this.invalidateBuffer()});this._scrV=a.__scroller(this._id+"-scrV",e-24,4,f-28,20).orient("south").hide().setAction(h=>{this.view(this._wcx,
h.value*this._lh);this.invalidateBuffer()});this.addChild(this._scrH);this.addChild(this._scrV)}scaler(a,b,c){if(Number.isFinite(a)&&Number.isFinite(b)&&Number.isFinite(c)){let d=Math.min(b,c);b=Math.max(b,c);a=this._p.constrain(a,d,b);if(!this._scaler){let [e,f]=[this._w,this._h];this._scaler=this._gui.slider(this._id+"-scaler",.25*e,.5*f-10,.5*e,20).hide().setAction(h=>{this._wscale=h.value;this.invalidateBuffer()});this.addChild(this._scaler);this._scalerZone={x0:.15*e,y0:.4*f-10,x1:.85*e,y1:.6*
...
this._scrV.getValue()*this._lh;this.invalidateBuffer();return this}frame(a=0){this._frameWeight=0>a?0:a;return this}shrink(a){console.warn("Cannot 'shrink' a viewer");return this}orient(a){console.warn("Changing orientation of a viewer is not allowed !!!");return this}_doEvent(a,b,c,d){d=this.getAbsXY();let [e,f,h,g]=this._orientation.xy(b-d.x,c-d.y,this._w,this._h);this.isOver=0<=e&&e<=h&&0<=f&&f<=g;switch(a.type){case "mousedown":case "touchstart":this._dragging=this.isOver=this.isActive=!0;this._mx0=
this._pmx=e;this._my0=this._pmy=f;this._dcx=this._wcx;this._dcy=this._wcy;this._scrH.show();this._scrV.show();this.invalidateBuffer();break;case "mouseout":this._scrH.hide(),this._scrV.hide();case "mouseup":case "touchend":this.action({source:this,p5Event:void 0,cX:this._wcx,cY:this._wcy,scale:this._wscale});this.isOver=this._dragging=this.isActive=!1;break;case "mousemove":case "touchmove":this.isOver?(this._dragging?(this._scaler?.hide(),this._validateMouseDrag(this._dcx+(this._mx0-e)/this._wscale,
this._dcy+(this._my0-f)/this._wscale),this.invalidateBuffer()):this._scaler&&(a=this._scalerZone,e>=a.x0&&e<=a.x1&&f>=a.y0&&f<=a.y1?this._scaler.show():this._scaler.hide()),this._scrH.show(),this._scrV.show()):(this._scrH.hide(),this._scrV.hide())}return this.isOver?this:null}_validateMouseDrag(a,b){let c=Math.round(.5*this._w/this._wscale);var d=Math.round(.5*this._h/this._wscale);let e=this._wcx+c;var f=this._wcy+d;f=0>this._wcy-d&&f>this._lh;let h=a-c,g=a+c,k=b-d;d=b+d;0>this._wcx-c&&e>this._lw||
0>h&&g>this._lw?a=this._lw/2:this._xor(0>h,g>this._lw)&&(a=0>h?a-h:a+(this._lw-g));f||0>k&&d>this._lh?b=this._lh/2:this._xor(0>k,d>this._lh)&&(b=0>k?b-k:b+(this._lh-d));this.view(a,b);this.invalidateBuffer()}_updateControlVisual(){var a=this._scheme||this._gui.scheme();let [b,c,d]=[this._wscale,this._wcx,this._wcy],[e,f,h,g]=[this._w,this._h,this._lw,this._lh];var k=a.C_2;a=a.C_7;let p=this._uiBfr;p.push();this._opaque?p.background(k):p.clear();k=Math.round(.5*e/b);var l=Math.round(.5*f/b);k=this._overlap(0,
0,h,g,c-k,d-l,c+k,d+l);let [q,n]=[Math.round(k.offsetX*b),Math.round(k.offsetY*b)],[m,t]=[Math.round(k.width*b),Math.round(k.height*b)];if(k.valid)for(let r=0,u=this._layers.length;r<u;r++)!this._hidden.has(r)&&this._layers[r]&&(l=this._layers[r].get(k.left,k.top,k.width,k.height),.01<Math.abs(b-1)&&l.resize(m,t),p.image(l,k.offsetX*b,k.offsetY*b,l.width,l.height));0<this._frameWeight&&(p.noFill(),p.stroke(a),p.strokeWeight(this._frameWeight),p.rect(0,0,p.width,p.height));this._updateViewerPickBuffer(q,
n,m,t);p.pop()}_updateViewerPickBuffer(a,b,c,d){let e=this._gui.pickColor(this),f=this._pkBfr;f.push();f.clear();f.noStroke();f.fill(e.r,e.g,e.b);f.rect(a,b,c,d);f.pop()}_overlap(a,b,c,d,e,f,h,g){var k=Math.min(b,d);b=Math.max(b,d);d=Math.min(a,c);c=Math.max(a,c);a=Math.min(f,g);g=Math.max(f,g);f=Math.min(e,h);h=Math.max(e,h);if(b<=a||g<=k||c<=f||h<=d)return{valid:!1};e=d<f?f:d;h=c>h?h:c;b=b>g?g:b;k=k<a?a:k;d=h-e;g=b-k;f=e-f;a=k-a;this._scrH.update(void 0,d/this._lw);this._scrV.update(void 0,g/this._lh);
return{valid:!0,left:e,right:h,top:k,bottom:b,width:d,height:g,offsetX:f,offsetY:a}}_xor(a,b){return(a||b)&&!(a&&b)}_minControlSize(){return{w:this._w,h:this._h}}}
class CvsTextField extends CvsText{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||80,f||16);this._nextActive=null;this._currCsrIdx=this._prevCsrIdx=this._linkOffset=0;this._cursorOn=this._textInvalid=!1;this.textAlign(this._p.LEFT);this._c=[0,0,0,0]}index(a,b){Number.isFinite(a)&&(Number.isFinite(b)&&(this._linkOffset=b),this._linkIndex=a,this._gui._links||(this._gui._links=new Map),this._gui._links.set(a,this));return this}text(a){if(null==a||void 0==a)return this._getLine();this._textInvalid=!1;
for(a=a.toString().replaceAll("\n"," ");0<a.length&&this._uiBfr.textWidth(a)>=this._maxTextWidthPixels();)a=a.substring(0,a.length-1);this._lines=[a];this.validate();this.invalidateBuffer();return this}textSize(a){let b=this._textSize||this._gui.textSize();if(!Number.isFinite(a))return b;a=Number(a);a!=b&&(this._textSize=a,this.invalidateBuffer());return this}noIndex(){Number.isFinite(this._linkIndex)&&!this._gui._links&&this._gui._links.delete(this._linkIndex);this._linkIndex=void 0;return this}isValid(){return!this._textInvalid}hasValidText(){return!this._textInvalid&&
0<this._lines.length&&0<this._lines[0].length}clearValid(){this._textInvalid&&(this._textInvalid=!1,this.invalidateBuffer());return this}validation(a){this._validation=a;return this}validate(){this._validate();return this}_validate(){if(this._validation){var a=this._getLine();a=this._validation(a);Array.isArray(a)&&0<a.length&&(this._textInvalid=!a[0],a[1]&&(this._uiBfr.textWidth(a[1])<this._maxTextWidthPixels()?this._lines[0]=a[1]:this._textInvalid=!0))}}_deactivate(){this._cursorOn=this.isActive=
!1;clearInterval(this._clock);this.invalidateBuffer();this._nextActive=null}_activate(a=!1){this.isActive=!0;let b=this._getLine();this._currCsrIdx=b.length;this._prevCsrIdx=a||this._textInvalid?0:b.length;this._cursorOn=!0;clearInterval(this._clock);this._clock=setInterval(()=>{this._cursorOn=!this._cursorOn;this.invalidateBuffer()},550);this.invalidateBuffer();this._nextActive=this}_activateNext(a){this._deactivate();this._validate();let b=this._gui._links,c=null;if(b){let d=this._linkIndex;do d+=
a,c=b.get(d);while(c&&(!c.isEnabled()||!c.isVisible()));c?._activate();this.invalidateBuffer()}this._nextActive=c}_getLine(){return 0<this._lines.length?this._lines[0]:""}_cursorX(a,b,c){return 0==c?0:a.textWidth(b.substring(0,c))}_doKeyEvent(a){this._nextActive=this;let b=this._maxTextWidthPixels(),c=this._getLine(),d=this._prevCsrIdx!=this._currCsrIdx,e=!(!this._linkIndex||d||0!=this._currCsrIdx),f=!!(this._linkIndex&&!d&&this._currCsrIdx>=c.length);if("keydown"==a.type){1==a.key.length&&(this._prevCsrIdx!=
this._currCsrIdx&&(c=this._removeSelectedText(c)),c=c.substring(0,this._currCsrIdx)+a.key+c.substring(this._currCsrIdx),this._uiBfr.textWidth(c)<b&&(this._currCsrIdx++,this._prevCsrIdx++,this._lines[0]=c),this.invalidateBuffer());switch(a.key){case "ArrowLeft":e?(this._activateNext(-1),this._validate(),this.action({source:this,p5Event:a,value:this._getLine()})):0<this._currCsrIdx&&(!a.shiftKey&&d?this._currCsrIdx=Math.min(this._currCsrIdx,this._prevCsrIdx):this._currCsrIdx--,a.shiftKey||(this._prevCsrIdx=
this._currCsrIdx));break;case "ArrowRight":f?(this._activateNext(1),this._validate(),this.action({source:this,p5Event:a,value:this._getLine()})):this._currCsrIdx<=c.length&&(!a.shiftKey&&d?this._currCsrIdx=Math.max(this._currCsrIdx,this._prevCsrIdx):this._currCsrIdx++,a.shiftKey||(this._prevCsrIdx=this._currCsrIdx));break;case "ArrowUp":d||(0!==this._linkOffset&&this._activateNext(-this._linkOffset),this._validate(),this.action({source:this,p5Event:a,value:this._getLine()}));break;case "ArrowDown":d||
(0!==this._linkOffset&&this._activateNext(this._linkOffset),this._validate(),this.action({source:this,p5Event:a,value:this._getLine()}));break;case "Enter":this._deactivate();this._validate();this.action({source:this,p5Event:a,value:this._getLine()});break;case "Backspace":this._prevCsrIdx!=this._currCsrIdx?c=this._removeSelectedText(c):0<this._currCsrIdx&&(c=c.substring(0,this._currCsrIdx-1)+c.substring(this._currCsrIdx),this._currCsrIdx--,this._prevCsrIdx=this._currCsrIdx);this._lines[0]=c;break;
case "Delete":this._prevCsrIdx!=this._currCsrIdx?c=this._removeSelectedText(c):this._currCsrIdx<c.length&&(c=c.substring(0,this._currCsrIdx)+c.substring(this._currCsrIdx+1)),this._lines[0]=c}this.invalidateBuffer()}return this._nextActive}_doEvent(a,b,c,d){switch(a.type){case "mousedown":case "touchstart":this._activate();break;case "mousemove":case "touchmove":this.isOver=this==d.control}return this._nextActive}_maxTextWidthPixels(){let a=Number(this._textSize||this._gui.textSize());return this._w-
2*this._gap-a/2}_removeSelectedText(a){let b=Math.min(this._prevCsrIdx,this._currCsrIdx),c=Math.max(this._prevCsrIdx,this._currCsrIdx);this._prevCsrIdx=this._currCsrIdx=b;return a.substring(0,b)+a.substring(c)}_updateControlVisual(){var a=Number(this._textSize||this._gui.textSize());let b=this._scheme||this._gui.scheme(),c=0<this._lines.length?this._lines[0]:"";var d=this._textInvalid;let e=2*this._gap;const f=b.G_9,h=b.C_9,g=b.C_3;let k=b.C_1,p=b.C_9,l=this._uiBfr;l.push();l.textSize(a);l.background(b.G_0);
l.noStroke();if(!this.isActive)k=d?b.C_9:b.C_1,p=d?b.C_3:b.C_9,l.stroke(p),l.strokeWeight(1.5),l.fill(k),l.rect(0,0,this._w,this._h);else if(this._currCsrIdx!=this._prevCsrIdx){d=this._cursorX(l,c,this._prevCsrIdx);let q=this._cursorX(l,c,this._currCsrIdx);l.noStroke();l.fill(g);l.rect(e+Math.min(d,q),1,Math.abs(d-q),this._h-2)}l.fill(k);l.textSize(a);l.textAlign(this._p.LEFT,this._p.TOP);l.noStroke();l.fill(p);l.text(c,e,(this._h-a)/2);this._activate&&this._cursorOn&&(a=this._cursorX(l,c,this._currCsrIdx),
l.stroke(f),l.strokeWeight(1.5),l.line(e+a,4,e+a,this._h-5));this.isOver&&(l.stroke(h),l.strokeWeight(2),l.noFill(),l.rect(1,1,this._w-2,this._h-2,this._c[0],this._c[1],this._c[2],this._c[3]));this._enabled||this._disable_hightlight(l,b,0,0,this._w,this._h);this._updateRectControlPB();l.pop();this._bufferInvalid=!1}}
...
Math.cos(this._ang),this._mag*Math.sin(this._ang)]}_validateThumbPosition(a,b){let c=this._p.constrain(Math.sqrt(a*a+b*b),0,this._pr1);a=Math.atan2(b,a);a+=0>a?2*Math.PI:0;b=c<=this._pr0;let d=-1,e;switch(this._mode){case "X4":e=Math.PI/2;d=Math.floor((a+e/2)/e)%4;a=e*d;d*=2;break;case "X8":e=Math.PI/4,d=Math.floor((a+e/2)/e)%8,a=e*d}[this._mag,this._ang,this._dir,this._dead]=[c,a,d,b]}_doEvent(a,b,c,d){function e(p,l,q){return{source:p,p5Event:l,final:q,mag:(p._mag-p._pr0)/(p._pr1-p._pr0),angle:p._ang,
dir:p._dir,dead:p._dead}}let [f,h,g,k]=this._orientation.xy(b-this._x,c-this._y,this.w,this.h);f-=g/2;h-=k/2;switch(a.type){case "mousedown":case "touchstart":this.isActive=!0;this._part=d.part;this.isOver=!0;break;case "mouseout":case "mouseup":case "touchend":this._validateThumbPosition(f,h);this.action(e(this,a,!0));this.isActive=!1;this.invalidateBuffer();this._tmrID||(this._tmrID=setInterval(()=>{this._mag-=.07*this._size;0>=this._mag&&(clearInterval(this._tmrID),this._tmrID=void 0,this._mag=
0);this.invalidateBuffer()},25));break;case "mousemove":case "touchmove":this.isActive&&(this._validateThumbPosition(f,h),this.action(e(this,a,!1))),this.isOver=this==d.control,this.invalidateBuffer()}return this.isActive?this:null}_updateControlVisual(){var a=this._scheme||this._gui.scheme();let [b,c]=[this._mag*Math.cos(this._ang),this._mag*Math.sin(this._ang)];var d=a.C_3,e=a.C_1,f=a.T_0;const h=a.C_9,g=a.C_9,k=a.C_4,p=a.C_6,l=a.C_7;var q=a.C_8;a=a.T_5;let n=this._uiBfr;n.push();n.clear();this._opaque&&
(n.noStroke(),n.fill(d),n.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));n.translate(n.width/2,n.height/2);n.noStroke();n.fill(e);n.ellipse(0,0,2*this._pr1,2*this._pr1);d=.26*this._size;n.fill(f);n.noStroke();n.ellipse(0,0,2*d,2*d);n.ellipse(0,0,1.25*d,1.25*d);n.stroke(q);switch(this._mode){case "X0":f=this._pr1;q=Math.PI/8;n.push();n.strokeWeight(.75);d=.3*this._size;for(e=0;16>e;e++)n.line(f,0,d,0),n.rotate(q);n.pop();break;case "X8":f=this._pr0;d=.33*this._size;q=Math.PI/
4;n.push();n.strokeWeight(1);for(e=0;8>e;e++)n.line(f,0,d,0),n.rotate(q);n.pop();case "X4":f=this._pr0;d=this._pr1;q=Math.PI/2;n.push();n.strokeWeight(1.5);for(e=0;4>e;e++)n.line(f,0,d,0),n.rotate(q);n.pop()}n.stroke(h);n.strokeWeight(Math.max(3,.025*this._size));n.noFill();n.ellipse(0,0,2*this._pr1,2*this._pr1);n.fill(a);n.noStroke();n.ellipse(0,0,2*this._pr0,2*this._pr0);n.stroke(l);n.strokeWeight(.05*this._size);n.line(0,0,b,c);n.strokeWeight(2);n.stroke(g);this.isActive||0<this._over?n.fill(p):
n.fill(k);n.ellipse(b,c,2*this._tSize,2*this._tSize);this._updateJoystickPickBuffer(b,c,this._tSize);n.pop();this._bufferInvalid=!1}_updateJoystickPickBuffer(a,b,c){let d=this._gui.pickColor(this),e=this._pkBfr;e.push();e.clear();e.translate(e.width/2,e.height/2);e.noStroke();e.fill(d.r,d.g,d.b);e.ellipse(a,b,2*c,2*c);e.pop()}}
...
e=0>d;f=1<d;d=this._p.constrain(d,0,1);break;case CvsKnob.Y_MODE:d=this._t01-(b-this._prevY)*this._sensitivity;e=0>d;f=1<d;d=this._p.constrain(d,0,1);break;case CvsKnob.A_MODE:d=Math.PI-this._turnArc/2;let h=2*Math.PI-d;a=c(Math.atan2(b,a));a=c(a-this._gapPos);e=a<d;f=a>h;d=this._p.map(a,d,h,0,1,!0)}return{t:d,under:e,over:f}}_doEvent(a,b,c,d){let [e,f,h,g]=this._orientation.xy(b-this._x,c-this._y,this.w,this.h);e-=h/2;f-=g/2;switch(a.type){case "mousedown":case "touchstart":this._prevX=e;this._prevY=
f;this.isOver=this.isActive=!0;this.invalidateBuffer();break;case "mouseout":case "mouseup":case "touchend":b=this._tFromXY(e,f);this._t01=this._s2ticks?this._nearestTickT(b.t):b.t;this.action({source:this,p5Event:a,value:this.value(),final:!0});this.isActive=!1;this.invalidateBuffer();break;case "mousemove":case "touchmove":this.isActive&&(b=this._tFromXY(e,f),b=this._s2ticks?this._nearestTickT(b.t):b.t,this._t01!=b&&(this._prevX=e,this._prevY=f,this._t01=b,this.action({source:this,p5Event:a,value:this.value(),
final:!1}))),this.isOver=this==d.control,this.invalidateBuffer()}return this.isActive?this:null}_updateControlVisual(){var a=this._scheme||this._gui.scheme(),b=a.C_3,c=a.C_7;const d=a.C_8,e=a.C_3,f=a.C_9;var h=a.C_3,g=a.C_1,k=a.G_8;const p=a.G_2,l=a.T_1;a=this._uiBfr;a.clear();this._opaque&&(a.noStroke(),a.fill(b),a.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));b=this._turnArc;var q=(2*Math.PI-b)/2;let n=this._gRad,m=2*this._kRad,t=2*n;a.push();a.translate(a.width/2,a.height/
2);a.rotate(this._gapPos+q);a.noStroke();a.fill(h);a.ellipse(0,0,m,m);a.fill(g);a.arc(0,0,m,m,0,this._turnArc);h=this._majorTicks*this._minorTicks;if(2<=h){g=this._tw;q=.65*g;a.stroke(k);k=b/h;a.push();a.strokeWeight(.9);for(let r=0;r<=h;r++)a.line(n,0,n+q,0),a.rotate(k);a.pop();h=this._majorTicks;if(2<=h){k=b/h;a.push();a.strokeWeight(1);for(q=0;q<=h;q++)a.line(n,0,n+g,0),a.rotate(k);a.pop()}a.noStroke();a.fill(l);a.arc(0,0,t+g,t+g,0,b);a.fill(p);a.arc(0,0,t+g,t+g,0,this._t01*b)}a.stroke(d);a.strokeWeight(1.5);
a.fill(c);a.ellipse(0,0,t,t);a.push();a.rotate(this._t01*b);c=.2*n;a.fill(e);a.noStroke();a.beginShape();a.vertex(-c,0);a.vertex(0,-c);a.vertex(n,0);a.vertex(0,c);a.endShape(this._p.CLOSE);a.pop();this.isOver&&(a.noFill(),a.stroke(f),a.strokeWeight(3),a.arc(0,0,2*this._kRad,2*this._kRad,0,b));this._updateKnobPickBuffer(m);a.pop();this._bufferInvalid=!1}_updateKnobPickBuffer(a){let b=this._gui.pickColor(this),c=this._pkBfr;c.push();c.clear();c.translate(c.width/2,c.height/2);c.noStroke();c.fill(b.r,
b.g,b.b);c.ellipse(0,0,a,a);c.pop()}_minControlSize(){return{w:this._size,h:this._size}}}CvsKnob.X_MODE=1;CvsKnob.Y_MODE=2;CvsKnob.A_MODE=3;
class CvsPane extends CvsBaseControl{constructor(a,b,c,d,e,f){super(a,b,c,d,e,f);this._background="rgba(0,0,0,0.6)";this._x=c;this._y=d;this._w=e;this._h=f;this._cornerRadius=5;this._status="closed";this._timer=0;this._z=PANE_Z}parent(a,b,c){console.warn("Panes cannot have a parent")}leaveParent(){console.warn("Panes cannot have a parent")}depth(){return this._depth}background(a){switch(a){case "dark":this._background="rgba(0,0,0,0.6)";break;case "light":this._background="rgba(255,255,255,0.6)";break;
...
b.noStroke();b.fill("white");b.rect(0,0,this._w,this._h);for(let c of this._children)c._visible&&c._draw(a,b)}b.pop();a.pop()}text(a,b){this.tab().text(a,b);return this}noText(){this.tab().noText();return this}icon(a,b){this.tab().icon(a,b);return this}noIcon(){this.tab().noIcon();return this}textSize(a){this.tab().textSize(a);return this}shrink(a){return this.tab().shrink()}opaque(a){console.warn("This method is not applicable to a pane");return this}transparent(a){console.warn("This methis is not applicable to a pane");
return this}orient(a){console.warn("Changing orientation of a pane is not allowed !!!");return this}tab(){return this._children[0]}enable(){this.tab().enable();return this}disable(){this.close();this.tab().disable();return this}hide(){this.close();this.tab().hide();return this}show(){this.tab().show();return this}_minControlSize(){return{w:this._w,h:this._h}}}CvsPane._dI=50;CvsPane._dC=60;CvsPane._dO=40;CvsPane._wExtra=20;CvsPane._tabID=1;
