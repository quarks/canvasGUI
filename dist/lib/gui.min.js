/*
 ...
 @version 2.0.0
*/
const CANVAS_GUI_VERSION="2.0.0",[CLOG,CWARN,CERROR,CASSERT,CCLEAR]=[console.log,console.warn,console.error,console.assert,console.clear],DELTA_Z=64,PANEL_Z=2048,PANE_Z=4096,TT_SHOW_TIME=1600,TT_REPEAT_TIME=1E4,CTL_CNRS=[4,4,4,4],FONTS=new Set("arial;verdana;tahoma;trebuchet ms;times new roman;georgia;courier new;brush script mt;impact;serif;sans-serif;monospace".split(";")),IS_VALID_FONT=function(a){return FONTS.has(a)},MEASURE_TEXT=function(a,b,c,d,e){b.push();b.textAlign("left");b.textFont(c);
b.textStyle(d);b.textSize(e);a=b.drawingContext.measureText(a);b.pop();return{left:a.actualBoundingBoxLeft,right:a.actualBoundingBoxRight,tw:a.actualBoundingBoxLeft+a.actualBoundingBoxRight,fw:a.width,ascent:a.actualBoundingBoxAscent,descent:a.actualBoundingBoxDescent}};
class GUI{constructor(a,b,c=p5.instance){this._keyListenersCreated=this._mouseListenersCreated=this._touchListenersCreated=!1;this._enabled=this._visible=!0;this._show_time=TT_SHOW_TIME;this._repeat_time=TT_REPEAT_TIME;this._uid=a;this._renderer=b;this._canvas=b.canvas;this._target=document.getElementById(b.canvas.id);this._p=c;this._controls=new Map;this._ctrls=[];this._corners=CTL_CNRS;this._optionGroups=new Map;this._textSize=12;this._textFont="sans-serif";this._textStyle="normal";this._tipTextSize=
10;this._COLOR_STEP=8;this._PART_MASK=this._COLOR_STEP-1;this._COLOR_MASK=16777215^this._PART_MASK;this._NEXT_COLOR=this._COLOR_STEP;this._colorKey=new Map;this._ctrlKey=new Map;this._panesEast=[];this._panesSouth=[];this._panesWest=[];this._panesNorth=[];this._initColorSchemes();this._addFocusHandlers();this._addMouseEventHandlers();this._addTouchEventHandlers();this._activeCtrl=this._currOver=null;this._activePart=0;this._drawHud=b.GL?this._drawHudWEBGL:this._drawHudP2D;this._validateGuiBuffers();
...
this._schemes.dark=new DarkScheme;this._scheme=this._schemes.blue}scheme(a){if(!a)return this._scheme;this._schemes[a]?(this._scheme=this._schemes[a],this._controls.forEach(b=>{b.scheme()||b.invalidateBuffer()})):CWARN(`'${a}' is not a valid color scheme`);return this}_getScheme(a){if(a&&this._schemes[a])return this._schemes[a];CWARN(`Unable to retrieve color scheme '${a}'`)}addScheme(a,b){"string"!==typeof a||b||(this._schemes[a]?CERROR(`Cannot add scheme '${a}' because it already exists.'`):this._schemes[a]=
b);return this}draw(){this._hud.clear();this._pickbuffer.clear();if(this._visible){this._p.push();for(let a of this._ctrls)a.getParent()||a._draw(this._hud,this._pickbuffer);this._p.pop();this._drawHud()}}_drawHudP2D(){this._p.push();this._p.image(this._hud,0,0);this._p.pop()}_drawHudWEBGL(){this._p.push();let a=this._renderer,b=a.drawingContext,c=a.width,d=a.height,e=Number.MAX_VALUE;b.flush();let f=a.uMVMatrix.copy(),h=a.uPMatrix.copy();b.disable(b.DEPTH_TEST);a.resetMatrix();this._getCamera().ortho(0,
...
CLOG("================================================"))}static $$(a){return GUI._guis.get(a)}static get(a,b=p5.instance){let c=`#${b.floor(b.random(111111,999999))}`;return GUI.create(c,a,b)}static create(a,b,c=p5.instance){GUI.ANNOUNCE_CANVAS_GUI();a instanceof String&&0!==a.length||(a=`#${c.floor(c.random(111111,999999))}`,CWARN(`Invalid name provided so this GUI will be called '${a}' intead.`));if(GUI._guis.has(a))return CWARN(`You already have a  GUI called '${a} it will not be replaced.`),
GUI._guis.get(a);b=new GUI(a,b,c);GUI._guis.set(a,b);return b}}GUI.VERSION="2.0.0";GUI._guis=new Map;const createGUI=function(a,b,c=p5.instance){return GUI.create(a,b,c)},getGUI=function(a){return GUI.$$(a)};
class BaseScheme{constructor(a="color scheme name"){this._colors=[];this._name=a;this._tints=[[0,0,0,13],[0,0,0,19],[0,0,0,26],[0,0,0,64],[0,0,0,77],[0,0,0,102],[0,0,0,128],[0,0,0,153],[0,0,0,179]];this._greys=[[255,255,255],[204,204,204],[179,179,179],[153,153,153],[128,128,128],[102,102,102],[77,77,77],[51,51,51],[26,26,26],[0,0,0]]}get name(){return this._name}copy(){return Object.assign(new BaseScheme,this)}C(a,b=255){b=Math.floor(0>b?0:255<b?255:b);return[...this._colors[a],b]}G(a,b=255){b=Math.floor(0>
b?0:255<b?255:b);return[...this._greys[a],b]}T(a){return this._tints[a]}}class BlueScheme extends BaseScheme{constructor(){super("blue");this._colors=[[230,236,255],[204,218,255],[179,199,255],[153,180,255],[102,143,255],[69,112,230],[41,84,204],[19,65,191],[15,52,153],[10,35,102]]}}class GreenScheme extends BaseScheme{constructor(){super("green");this._colors=[[230,255,230],[204,255,204],[179,255,179],[153,255,153],[102,255,102],[69,230,69],[41,204,41],[19,191,19],[15,153,15],[10,102,10]]}}
class RedScheme extends BaseScheme{constructor(){super("red");this._colors=[[255,230,230],[255,204,204],[255,179,179],[255,153,153],[255,102,102],[230,69,69],[204,41,41],[191,19,19],[153,15,15],[102,10,10]]}}class CyanScheme extends BaseScheme{constructor(){super("cyan");this._colors=[[230,255,255],[204,255,255],[179,255,255],[153,255,255],[102,255,255],[69,230,230],[41,204,204],[19,191,191],[15,153,153],[10,102,102]]}}
class YellowScheme extends BaseScheme{constructor(){super("yellow");this._colors=[[255,255,230],[255,255,204],[255,255,179],[255,255,153],[255,255,102],[230,230,69],[204,204,41],[191,191,19],[153,153,15],[102,102,10]]}}class PurpleScheme extends BaseScheme{constructor(){super("purple");this._colors=[[255,230,255],[255,204,255],[255,179,255],[255,153,255],[255,102,255],[230,69,230],[204,41,204],[191,19,191],[153,15,153],[102,10,102]]}}
class OrangeScheme extends BaseScheme{constructor(){super("orange");this._colors=[[255,242,230],[255,230,204],[255,217,179],[255,204,153],[255,179,102],[230,149,69],[204,122,41],[191,105,19],[153,84,15],[102,56,10]]}}class LightScheme extends BaseScheme{constructor(){super("light");this._colors=[[254,254,254],[228,228,228],[203,203,203],[177,177,177],[152,152,152],[127,127,127],[101,101,101],[76,76,76],[50,50,50],[25,25,25]]}}
class DarkScheme extends BaseScheme{constructor(){super("dark");this._colors=[[0,0,0],[25,25,25],[50,50,50],[76,76,76],[101,101,101],[127,127,127],[152,152,152],[177,177,177],[203,203,203],[228,228,228]];this._tints=[[102,102,102,160],[131,131,131,172],[145,145,145,179],[158,158,158,185],[170,170,170,192],[191,191,191,204],[210,210,210,217],[226,226,226,230],[241,241,241,243]];this._greys=this._greys.reverse()}}
...
!1}get x(){return this._x}set x(a){this._x=Math.round(a)}get y(){return this._y}set y(a){this._y=Math.round(a)}get z(){return this._z}set z(a){this._z=a}get w(){return this._w}set w(a){this._w=Math.round(a)}get h(){return this._h}set h(a){this._h=Math.round(a)}get id(){return this._id}get type(){return this.constructor.name.substring(3)}get isEnabled(){return this._enabled}get isVisible(){return this._visible}get isActive(){return this._active}moveTo(a,b){this.x=a;this.y=b;return this}moveBy(a,b){this.x+=
a;this.y+=b;return this}getAbsXY(){if(this._parent){let a=this._parent.getAbsXY();a.x+=this._x;a.y+=this._y;return a}return{x:this._x,y:this._y}}scheme(a,b){if(a){let c=this._gui._getScheme(a);if(c&&this._scheme!=c&&(this._scheme=c,this.invalidateBuffer(),b))for(let d of this._children)d.scheme(a,b);return this}return this._scheme}invalidateBuffer(){this._bufferInvalid=!0;return this}parent(a,b,c){a=this._gui.$(a);a.addChild(this,b,c);this.z=a.z+DELTA_Z;this._gui.setRenderOrder();return this}addChild(a,
...
this._scheme||this._gui.scheme();var b=a.C(3),c=a.G(7),d=a.G(3),e=a.G(1);const f=a.C(9),h=a.C(6);let g=this._uiBfr,l=g.width-20,q=Math.round(g.height/2);g.push();g.clear();this._opaque&&(g.noStroke(),g.fill(...b),g.rect(0,0,this._w,this._h,...this._c));g.translate(10,q);g.stroke(...c);g.strokeWeight(1);c=this._majorTicks*this._minorTicks;if(2<=c){b=l/c;for(var n=0;n<=c;n++){var p=n*b;g.line(p,-7,p,7)}}c=this._majorTicks;if(2<=c)for(b=l/this._majorTicks,n=0;n<=c;n++)p=n*b,g.line(p,-10,p,10);g.fill(...d);
g.rect(0,-4,l,8);d=l*Math.min(this._t[0],this._t[1]);b=l*Math.max(this._t[0],this._t[1]);g.fill(...e);g.rect(d,-4,b-d,8,...this._c);for(e=0;2>e;e++)g.fill(...h),g.noStroke(),(this.isActive||this.isOver)&&e==this._tIdx&&(g.strokeWeight(2),g.stroke(...f)),g.rect(this._t[e]*l-6,-6,12,12,...this._c);this._enabled||this._disable_hightlight(g,a,-10,-this._h/2,this._w,this._h);this._updateRangerPickBuffer(q,l,8,d,b,12);g.pop();this._bufferInvalid=!1}_updateRangerPickBuffer(a,b,c,d,e,f){d=Math.round(d);e=
Math.round(e);let h=this._gui.pickColor(this),g=this._pkBfr;g.push();g.clear();g.noStroke();g.translate(10,a);g.fill(h.r,h.g,h.b+5);g.rect(0,-c/2,b,c,...this._c);g.fill(h.r,h.g,h.b+6);g.rect(d,-c/2,e-d,c,...this._c);g.fill(h.r,h.g,h.b);g.rect(d-f/2,-f/2,f,f);g.fill(h.r,h.g,h.b+1);g.rect(e-f/2,-f/2,f,f);g.pop()}}
...
class CvsLabel extends CvsTextIcon{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||60,f||16)}setAction(a){return this}_updateControlVisual(){var a=this._textSize||this._gui.textSize(),b=this._textFont||this._gui.textFont(),c=this._textStyle||this._gui.textStyle(),d=this._scheme??this._gui.scheme();let e=this._p;var f=this._icon,h=this._iconAlign;let g=this._textAlign,l=this._lines,q=this._gap;const n=d.C(3);d=d.C(8);let p=this._uiBfr;p.push();p.clear();p.textFont(b);p.textStyle(c);this._opaque&&(p.noStroke(),
p.fill(...n),p.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));if(f){b=0;switch(h){case e.LEFT:b=q;break;case e.RIGHT:b=this._w-f.width-q}0==l.length&&(b=(this._w-f.width)/2);p.image(this._icon,b,(this._h-f.height+q)/2)}if(0<l.length){p.textSize(a);a=q;b=this._w-q;c=0;f&&h==e.LEFT&&(a+=f.width);f&&h==e.RIGHT&&(b-=f.width);f=b-a;h=this._tbox.h;h=p.textAscent()+(this._h-h)/2;p.fill(...d);for(let k of l){switch(g){case e.LEFT:c=a;break;case e.CENTER:c=a+(f-p.textWidth(k))/2;break;
case e.RIGHT:c=b-p.textWidth(k)-q}p.text(k,c,h);h+=p.textLeading()}}p.pop();this._bufferInvalid=!1}tooltip(a){return this}tipTextSize(a){return this}}Object.assign(CvsLabel.prototype,NoTooltip);
class CvsButton extends CvsTextIcon{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||80,f||16)}_updateControlVisual(){var a=this._textSize||this._gui.textSize();let b=this._scheme||this._gui.scheme();var c=this._iconAlign;let d=this._textAlign;var e=this._icon;let f=this._lines,h=this._gap;var g=b.C(3);const l=b.C(8),q=b.C(9);let n=this._uiBfr;n.push();n.clear();this._opaque&&(n.noStroke(),n.fill(...g),n.rect(1,1,this._w-1,this._h-1,...this._c));if(e){g=0;switch(c){case this._p.LEFT:g=h;break;case this._p.RIGHT:g=
...
0,this._w-1,this._h-1);b.fill(...f).noStroke();if(0<c.length){b.textSize(a);a=this._w-d-d;e=this._tbox.h;e=b.textAscent()+(this._h-e)/2;for(let h of c)c=d+(a-b.textWidth(h))/2,b.text(h,c,e),e+=b.textLeading()}b.pop();this._bufferInvalid=!1}_minControlSize(){let a=this._uiBfr,b=this._lines,c=this._textSize||this._gui.tipTextSize(),d=this._tbox,e=0,f=0,h=this._gap;0<b.length&&(a||this._validateBuffer(),a.textSize(c),d.w=c+b.map(g=>a.textWidth(g)).reduce((g,l)=>g>l?g:l),d.h=(b.length-1)*a.textLeading()+
a.textAscent()+a.textDescent(),h+=this._gap);e+=d.w+h;f=Math.max(d.h,f)+2*h;return{w:e,h:f}}}
class CvsScroller extends CvsBufferedControl{constructor(a,b,c=0,d=0,e=100,f=20){super(a,b,c,d,e,f);this._dvalue=this._value=.5;this._used=.1;this._s_mx=this._s_dvalue=this._s_value=.5;this._minV=this._used/2;this._maxV=1-this._used/2;this._inset=2;this._trackHeight=8;this._thumbHeight=12;this._minThumbWidth=10;this._trackWidth=e-2*this._inset;this._opaque=!1}update(a,b){Number.isFinite(b)&&b!==this._used&&(this._used=b,this._minV=this._used/2,this._maxV=1-this._used/2,this.invalidateBuffer());if(Number.isFinite(a)&&
a!==this._value){b=a=this._p.constrain(a,0,1);let c=this._used/2;a<c?b=c:a>1-c&&(b=1-c);if(this._value!=a||this._dvalue!=b)this._value=a,this._dvalue=b,this.invalidateBuffer()}}getValue(){return this._value}getUsed(){return this._used}_doEvent(a,b=0,c=0,d,e){[b]=this._orientation.xy(b-this._x,c-this._y,this.w,this.h);let [f,h]=[this._trackWidth,this._used/2];switch(a.type){case "mousedown":case "touchstart":0==d.part&&(this._active=!0,this._s_value=this._value,this._s_mx=b,this.isOver=!0);break;case "mouseout":case "mouseup":case "touchend":this.action({source:this,
p5Event:a,value:this._value,used:this._used,final:!0});this.isOver=this._active=!1;break;case "mousemove":case "touchmove":this.isActive&&(b=this._s_value+(b-this._s_mx)/f,0<=b-h&&1>=b+h&&(this.update(b),this.action({source:this,p5Event:a,value:this._value,used:this._used,final:!1}))),this.isOver=this==d.control,this.invalidateBuffer()}return this.isActive?this:null}_updateControlVisual(){let a=this._scheme||this._gui.scheme();const b=a.C(3),c=a.G(8),d=a.G(3),e=a.C(9),f=a.C(5);let [h,g,l,q]=[this._w,
this._h,this._inset,this._used],[n,p]=[this._trackWidth,this._trackHeight],k=Math.max(q*n,this._minThumbWidth),m=this._thumbHeight,t=this._dvalue*this._trackWidth,r=this._uiBfr;r.push();r.clear();this._opaque&&(r.noStroke(),r.fill(...b),r.rect(0,0,h,g,...this._c));r.translate(l,this._uiBfr.height/2);r.fill(...d);r.stroke(...c);r.strokeWeight(1);r.rect(0,-p/2,n,p);r.fill(...f);r.noStroke();if(this.isActive||this.isOver)r.strokeWeight(2),r.stroke(...e);r.rect(t-k/2,-m/2,k,m,...this._c);this._enabled||
this._disable_hightlight(r,a,0,-g/2,h-20,g);this._updateScrollerPickBuffer(t-k/2,-m/2,k,m);r.pop();this._bufferInvalid=!1}_updateScrollerPickBuffer(a,b,c,d){let e=this._gui.pickColor(this),f=this._pkBfr;f.push();f.clear();f.noStroke();f.fill(e.r,e.g,e.b);f.translate(this._inset,this._pkBfr.height/2);f.rect(Math.round(a),Math.round(b),c,d);f.pop()}_minControlSize(){return{w:this._w,h:20}}tooltip(a){return this}tipTextSize(a){return this}}Object.assign(CvsScroller.prototype,NoTooltip);
...
this._tooltip?._updateState(e)}return this.isActive?this:null}_updateControlVisual(){var a=this._textSize||this._gui.textSize();let b=this._scheme||this._gui.scheme(),c=this._p;var d=c.constrain(.7*Number(a),12,16),e=this._iconAlign;let f=this._textAlign,h=this._lines,g=this._gap;var l=b.C(3);const q=b.C(8);var n=b.G(0);const p=b.G(9),k=b.C(9);let m=this._uiBfr;m.push();m.clear();this._opaque&&(m.noStroke(),m.fill(...l),m.rect(0,0,this._w,this._h,...this._c));m.push();m.translate(e==c.RIGHT?this._w-
g-d/2:g+d/2,m.height/2);m.stroke(...p);m.fill(...n);m.strokeWeight(1.5);m.ellipse(0,0,d,d);this._selected&&(m.fill(...p),m.noStroke(),m.ellipse(0,0,d/2,d/2));m.pop();if(0<h.length){m.textSize(a);a=g;l=this._w-g;n=0;e==c.LEFT&&(a+=d+g);e==c.RIGHT&&(l-=d+g);d=l-a;e=this._tbox.h;e=m.textAscent()+(this._h-e)/2;m.fill(...q);for(let t of h){switch(f){case c.LEFT:n=a;break;case c.CENTER:n=a+(d-m.textWidth(t))/2;break;case c.RIGHT:n=l-m.textWidth(t)-g}m.text(t,n,e);e+=m.textLeading()}}this.isOver&&(m.stroke(...k),
...
this._prevCsrIdx=this._currCsrIdx=b;return a.substring(0,b)+a.substring(c)}_updateControlVisual(){function a(r){return r&&0!=r?MEASURE_TEXT(f.substring(0,r),k,c,d,b).fw:0}let b=Number(this._textSize||this._gui.textSize()),c=this._textFont||this._gui.textFont(),d=this._textStyle||this._gui.textStyle(),e=this._scheme||this._gui.scheme(),f=this._getLine();var h=this._textInvalid;let g=4+Math.max(this._c[0],this._c[3]);var l=this._w-(4+Math.max(this._c[1],this._c[2]));const q=e.G(9),n=e.C(9),p=e.C(3);
let k=this._uiBfr;k.clear();k.push();k.textFont(c);k.textStyle(d);k.textSize(b);var m=e.C(1);let t=e.C(9);this.isActive?k.fill(...e.G(0)):(m=h?e.C(9):e.C(1),t=h?e.C(3):e.C(9),k.fill(...m));k.stroke(...t);k.strokeWeight(2);k.rect(1,1,this._w-2,this._h-2,...this._c);k.push();k.beginClip();k.rect(g,1.5,l-g,this._h-3);k.endClip();k.fill(...m);h=a(this._currCsrIdx);this.isActive&&(l=h-(l-g),0<l&&k.translate(-l,0),this._currCsrIdx!=this._prevCsrIdx&&(m=a(this._prevCsrIdx),l=g+Math.min(m,h),m=Math.abs(m-
h),k.noStroke(),k.fill(...p),k.rect(l,1.5,m,this._h-3,...this._c)));k.textSize(b);k.textAlign(this._p.LEFT,this._p.TOP);k.noStroke();k.fill(...t);k.text(f,g,(this._h-b)/2);this._active&&this._cursorOn&&(k.stroke(...q),k.strokeWeight(1.75),k.line(g+h,4,g+h,this._h-5));k.pop();this.isOver&&(k.stroke(...n),k.strokeWeight(2.5),k.noFill(),k.rect(1,1,this._w-2,this._h-2,...this._c));this._enabled||this._disable_hightlight(k,e,0,0,this._w,this._h);this._updateRectControlPB();k.pop();this._bufferInvalid=
!1}}
class CvsJoystick extends CvsBufferedControl{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||40,f||40);this._size=Math.min(e,f);this._pr0=.05*this._size;this._pr1=.4*this._size;this._tSize=Math.max(.075*this._size,6);this._mode="X0";this._ang=this._mag=0;this._opaque=!1;this._tmrID=void 0}mode(a){if(!a)return this._mode;a=a.toUpperCase();switch(a){case "X0":case "X4":case "X8":this._mode!=a&&(this._mode=a,this.invalidateBuffer())}return this}thumbSize(a){this._tSize=a;return this}_getThumbXY(){return[this._mag*Math.cos(this._ang),
this._mag*Math.sin(this._ang)]}_validateThumbPosition(a,b){let c=this._p.constrain(Math.sqrt(a*a+b*b),0,this._pr1);a=Math.atan2(b,a);a+=0>a?2*Math.PI:0;b=c<=this._pr0;let d=-1,e;switch(this._mode){case "X4":e=Math.PI/2;d=Math.floor((a+e/2)/e)%4;a=e*d;d*=2;break;case "X8":e=Math.PI/4,d=Math.floor((a+e/2)/e)%8,a=e*d}[this._mag,this._ang,this._dir,this._dead]=[c,a,d,b]}_doEvent(a,b=0,c=0,d,e){function f(n,p,k){return{source:n,p5Event:p,final:k,mag:(n._mag-n._pr0)/(n._pr1-n._pr0),angle:n._ang,dir:n._dir,
dead:n._dead}}let [h,g,l,q]=this._orientation.xy(b-this._x,c-this._y,this.w,this.h);h-=l/2;g-=q/2;switch(a.type){case "mousedown":case "touchstart":this.isOver=this._active=!0;break;case "mouseout":case "mouseup":case "touchend":this._validateThumbPosition(h,g);this.action(f(this,a,!0));this._active=!1;this.invalidateBuffer();this._tmrID||(this._tmrID=setInterval(()=>{this._mag-=.07*this._size;0>=this._mag&&(clearInterval(this._tmrID),this._tmrID=void 0,this._mag=0);this.invalidateBuffer()},25));
break;case "mousemove":case "touchmove":this.isActive&&(this._validateThumbPosition(h,g),this.action(f(this,a,!1))),this.isOver=this==d.control,this._tooltip?._updateState(e),this.invalidateBuffer()}return this.isActive?this:null}_updateControlVisual(){var a=this._scheme||this._gui.scheme();let [b,c]=[this._mag*Math.cos(this._ang),this._mag*Math.sin(this._ang)];var d=a.C(3),e=a.C(1),f=a.T(0);const h=a.C(9),g=a.C(9),l=a.C(4),q=a.C(6),n=a.C(7);var p=a.C(8);a=a.T(5);let k=this._uiBfr;k.push();k.clear();
this._opaque&&(k.noStroke(),k.fill(...d),k.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));k.translate(k.width/2,k.height/2);k.noStroke();k.fill(...e);k.ellipse(0,0,2*this._pr1,2*this._pr1);d=.26*this._size;k.fill(...f);k.noStroke();k.ellipse(0,0,2*d,2*d);k.ellipse(0,0,1.25*d,1.25*d);k.stroke(...p);switch(this._mode){case "X0":f=this._pr1;p=Math.PI/8;k.push();k.strokeWeight(.75);d=.3*this._size;for(e=0;16>e;e++)k.line(f,0,d,0),k.rotate(p);k.pop();break;case "X8":f=this._pr0;
d=.33*this._size;p=Math.PI/4;k.push();k.strokeWeight(1);for(e=0;8>e;e++)k.line(f,0,d,0),k.rotate(p);k.pop();case "X4":f=this._pr0;d=this._pr1;p=Math.PI/2;k.push();k.strokeWeight(1.5);for(e=0;4>e;e++)k.line(f,0,d,0),k.rotate(p);k.pop()}k.stroke(...h);k.strokeWeight(Math.max(3,.025*this._size));k.noFill();k.ellipse(0,0,2*this._pr1,2*this._pr1);k.fill(...a);k.noStroke();k.ellipse(0,0,2*this._pr0,2*this._pr0);k.stroke(...n);k.strokeWeight(.05*this._size);k.line(0,0,b,c);k.strokeWeight(2);k.stroke(...g);
this.isActive||this.isOver?k.fill(...q):k.fill(...l);k.ellipse(b,c,2*this._tSize,2*this._tSize);this._updateJoystickPickBuffer(b,c,this._tSize);k.pop();this._bufferInvalid=!1}_updateJoystickPickBuffer(a,b,c){let d=this._gui.pickColor(this),e=this._pkBfr;e.push();e.clear();e.translate(e.width/2,e.height/2);e.noStroke();e.fill(d.r,d.g,d.b);e.ellipse(a,b,2*c,2*c);e.pop()}}
...
final:!1}))),this.isOver=this==d.control,this._tooltip?._updateState(e),this.invalidateBuffer()}return this.isActive?this:null}_updateControlVisual(){var a=this._scheme||this._gui.scheme(),b=a.C(3),c=a.C(7);const d=a.C(8),e=a.C(3),f=a.C(9);var h=a.C(3),g=a.C(1),l=a.G(8);const q=a.G(2),n=a.T(1);a=this._uiBfr;a.clear();this._opaque&&(a.noStroke(),a.fill(...b),a.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));b=this._turnArc;var p=(2*Math.PI-b)/2;let k=this._gRad,m=2*this._kRad,
t=2*k;a.push();a.translate(a.width/2,a.height/2);a.rotate(this._gapPos+p);a.noStroke();a.fill(...h);a.ellipse(0,0,m,m);a.fill(...g);a.arc(0,0,m,m,0,this._turnArc);h=this._majorTicks*this._minorTicks;if(2<=h){g=this._tw;p=.65*g;a.stroke(...l);l=b/h;a.push();a.strokeWeight(.9);for(let r=0;r<=h;r++)a.line(k,0,k+p,0),a.rotate(l);a.pop();h=this._majorTicks;if(2<=h){l=b/h;a.push();a.strokeWeight(1);for(p=0;p<=h;p++)a.line(k,0,k+g,0),a.rotate(l);a.pop()}a.noStroke();a.fill(...n);a.arc(0,0,t+g,t+g,0,b);a.fill(...q);
a.arc(0,0,t+g,t+g,0,this._t01*b)}a.stroke(...d);a.strokeWeight(1.5);a.fill(...c);a.ellipse(0,0,t,t);a.push();a.rotate(this._t01*b);c=.2*k;a.fill(...e);a.noStroke();a.beginShape();a.vertex(-c,0);a.vertex(0,-c);a.vertex(k,0);a.vertex(0,c);a.endShape(this._p.CLOSE);a.pop();this.isOver&&(a.noFill(),a.stroke(...f),a.strokeWeight(3),a.arc(0,0,2*this._kRad,2*this._kRad,0,b));this._updateKnobPickBuffer(m);a.pop();this._bufferInvalid=!1}_updateKnobPickBuffer(a){let b=this._gui.pickColor(this),c=this._pkBfr;
c.push();c.clear();c.translate(c.width/2,c.height/2);c.noStroke();c.fill(b.r,b.g,b.b);c.ellipse(0,0,a,a);c.pop()}_minControlSize(){return{w:this._size,h:this._size}}}CvsKnob.X_MODE=1;CvsKnob.Y_MODE=2;CvsKnob.A_MODE=3;
...
f-g:0);b=this._y+(this._canDragY?h-l:0);let [q,n]=[this._p.width,this._p.height],[p,k]=[this._w,this._h];this._constrainX&&p<=q&&(0>a?a=0:a>q-p&&(a=q-p));this._constrainY&&k<=n&&(0>b?b=0:b>n-k&&(b=n-k));this.moveTo(a,b)}this.isOver=this==d.control}return this.isActive?this:null}_updateControlVisual(){var a=this._scheme||this._gui.scheme();const b=a.C(0);a=a.C(3);CLOG(b);let c=this._uiBfr;c.push();c.clear();c.strokeWeight(3);c.noStroke();c.noFill();this._opaque&&c.fill(...b);this.isOver&&c.stroke(...a);
c.rect(0,0,this._w,this._h);this._updatePanelControlPB();this._bufferInvalid=!1}_updatePanelControlPB(){let a=this._pkBfr;a.clear();a.noStroke();a.noFill();let b=this._gui.pickColor(this);this._opaque&&a.fill(b.r,b.g,b.b);a.rect(1,1,this._w-1,this._h-1)}_minControlSize(){return{w:this._w,h:this._h}}parent(a,b,c){return this}leaveParent(){return this}tooltip(a){return this}tipTextSize(a){return this}transparent(){return this}opaque(){return this}orient(a){return this}}
Object.assign(CvsPanel.prototype,NoParent);Object.assign(CvsPanel.prototype,NoTooltip);Object.assign(CvsPanel.prototype,NoOrient);
