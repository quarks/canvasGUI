...
g||void 0===g?void 0:g.source._name}`)})}name(){return this._name}getAbsXY(){if(this._parent){let a=this._parent.getAbsXY();a.x+=this._x;a.y+=this._y;return a}return{x:this._x,y:this._y}}scheme(a,b){if(a){this._scheme=this._gui.getScheme(a);this.invalidateBuffer();if(b)for(let c of this._children)c.scheme(a,b);return this}return this._scheme}addChild(a,b,c){a=this._gui.getControl(a);b=Number.isFinite(b)?Number(b):a._x;c=Number.isFinite(c)?Number(c):a._y;a._parent||a.leaveParent();a._x=b;a._y=c;a._parent=
...
return this}orient(a){a=a.toString().toLowerCase();switch(a){case "north":this._orientation=CvsBaseControl.NORTH;break;case "south":this._orientation=CvsBaseControl.SOUTH;break;case "west":this._orientation=CvsBaseControl.WEST;break;default:this._orientation=CvsBaseControl.EAST}return this}isActive(){return this._active}isEnabled(){return this._enabled}enable(a){this._enabled=!0;if(a)for(let b of this._children)b.enable(a);return this}disable(a){this._enabled&&(this._enabled=!1,this.invalidateBuffer());
...
c=c.y;this._pover=this._over;this._over=this._whereOver(d,c);this._bufferInvalid=this._bufferInvalid||this._pover!=this._over;this._tooltip&&this._tooltip._updateState(this._pover,this._over);switch(a.type){case "mousedown":0<this._over&&(this._active=!0,this.invalidateBuffer());break;case "mouseout":case "mouseup":this._active&&(this.action({source:this,p5Event:a,value:this.value(),final:!0}),this._active=!1,this.invalidateBuffer(),b=!0);break;case "mousemove":this._active&&(d=this._norm01(d-10,
0,this._buffer.width-20),this._s2ticks&&(d=this._nearestTickT(d)),this._t01!=d&&(this._t01=d,this.action({source:this,p5Event:a,value:this.value(),final:!1})),this.invalidateBuffer())}return b}_nearestTickT(a){let b=0<this._minorTicks?this._minorTicks*this._majorTicks:this._majorTicks;return 0<b?Math.round(a*b)/b:a}_updateControlVisual(){let a=this._buffer,b=this._scheme||this._gui.scheme();var c=a.width-20,d=b.COLOR_3,e=b.GREY_8;const f=b.GREY_1,g=b.GREY_4,h=b.COLOR_14,k=b.COLOR_10;a.push();a.clear();
...
c=this._textSize||this._gui.textSize(),d=this._tbox,e=0,f=0,g=this._gap;0<b.length&&(a||this._validateBuffer(),a.textSize(c),d.w=c+b.map(h=>a.textWidth(h)).reduce((h,k)=>h>k?h:k),d.h=(b.length-1)*a.textLeading()+a.textAscent()+a.textDescent(),g+=this._gap);e+=d.w+g;f=Math.max(d.h,f)+2*g;return{w:e,h:f}}}
class CvsTextIcon extends CvsText{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||80,f||16);this._icon=void 0;this._iconAlign=this._p.LEFT}icon(a,b){if(!a)return{text:this._text,icon:this._icon};this._icon=a;!b||b!=this._p.LEFT&&b!=this._p.RIGHT||(this._iconAlign=b);a=this._minControlSize();this._w=Math.max(this._w,a.w);this._h=Math.max(this._h,a.h);this.invalidateBuffer();return this}noIcon(){this._icon=void 0;this._iconAlign=this._p.LEFT;this.invalidateBuffer();return this}_minControlSize(){let a=
...
class CvsOption extends CvsText{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||100,f||18);this._selected=!1;this._optGroup=null;this._textAlign=this._iconAlign=this._p.LEFT}iconAlign(a){if(!a)return this._iconAlign;if(a==this._p.LEFT||a==this._p.RIGHT)this._iconAlign=a,this.invalidateBuffer();return this}select(){var a;let b=null===(a=this._optGroup)||void 0===a?void 0:a._prev();b&&(b._selected=!1,b.invalidateBuffer());this._selected=!0;this.invalidateBuffer();return this}_deselect(){this._selected=
...
this._over&&(this._active=this._dragging=this._clickAllowed=!0,this.invalidateBuffer(),b=!0);break;case "mouseout":case "mouseup":this._active&&this._clickAllowed&&!this._selected&&this._optGroup&&(this.select(),this.action({source:this,p5Event:a,selected:!0}));this._over=0;this._active=this._dragging=this._clickAllowed=!1;this.invalidateBuffer();b=!0;break;case "mousemove":this._clickAllowed=!1}return b}_updateControlVisual(){var a=this._textSize||this._gui.textSize();let b=this._scheme||this._gui.scheme(),
