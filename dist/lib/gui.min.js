/*
 ...
 @version 2.0.0
*/
const CANVAS_GUI_VERSION="2.0.0",[CLOG,CWARN,CERROR,CASSERT,CCLEAR]=[console.log,console.warn,console.error,console.assert,console.clear],GUIS=new Map,DELTA_Z=64,PANE_Z=2048;
class GUI{constructor(a,b=p5.instance){this._keyEventsEnabled=this._mouseEventsEnabled=this._touchEventsEnabled=!1;this._enabled=this._visible=this._eventsAllowed=!0;this.py=this.px=this.ty=this.tx=this.my=this.mx=0;this._renderer=a;this._canvas=a.canvas;this._target=document.getElementById(a.canvas.id);this._p=b;this._is3D=void 0!=this._renderer.GL;this._controls=new Map;this._ctrls=[];this._corners=[4,4,4,4];this._optionGroups=new Map;this._textSize=12;this._tipTextSize=10;this._COLOR_STEP=8;this._PART_MASK=
this._COLOR_STEP-1;this._COLOR_MASK=16777215^this._PART_MASK;this._NEXT_COLOR=this._COLOR_STEP;this._colorKey=new Map;this._ctrlKey=new Map;this._panesEast=[];this._panesSouth=[];this._panesWest=[];this._panesNorth=[];this._initColorSchemes();this._addFocusHandlers();this._addMouseEventHandlers();this._addTouchEventHandlers();this._activeCtrl=this._overCtrl=null;this._activePart=0;this._drawHud=this._is3D?this._drawHudWEBGL:this._drawHudP2D;this._validateGuiBuffers();this._getCamera=1==Number(b.VERSION.split(".")[0])?
function(){return this._renderer._curCamera}:function(){return this._renderer.states.curCamera}}get overCtrl(){return this._overCtrl}set overCtrl(a){this._overCtrl=a}get activeCtrl(){return this._activeCtrl}set activeCtrl(a){this._activeCtrl=a}get activePart(){return this._activePart}set activePart(a){this._activePart=a}_validateGuiBuffers(){let a=this._p;this._hud&&this._hud.width==a.width&&this._hud.height==a.height||(this._hud=a.createGraphics(a.width,a.height),this._hud.pixelDensity(window.devicePixelRatio),
this._hud.clear(),this._pickbuffer=a.createGraphics(a.width,a.height),this._pickbuffer.pixelDensity(window.devicePixelRatio),this._pickbuffer.clear())}slider(a,b,c,d,e){return this.addControl(new CvsSlider(this,a,b,c,d,e),!0)}ranger(a,b,c,d,e){return this.addControl(new CvsRanger(this,a,b,c,d,e),!0)}button(a,b,c,d,e){return this.addControl(new CvsButton(this,a,b,c,d,e),!0)}textfield(a,b,c,d,e){this._addKeyEventHandlers();return this.addControl(new CvsTextField(this,a,b,c,d,e),!0)}checkbox(a,b,c,d,
...
a,b,c,d,e),!0)}__tooltip(a){return this.addControl(new CvsTooltip(this,a),!1)}pane(a,b,c){c=Math.round(c);switch(b){case "north":a=new CvsPaneNorth(this,a,c);break;case "south":a=new CvsPaneSouth(this,a,c);break;case "west":a=new CvsPaneWest(this,a,c);break;default:a=new CvsPaneEast(this,a,c)}return this.addControl(a,!1)}grid(a,b,c,d){return new GridLayout(a,b,c,d)}name(){return this._uid}show(){this._visible=!0;return this}hide(){this._visible=!1;return this}isVisible(){return this._visible}enable(){this._enabled=
!0;return this}disable(){this._enabled=!1;return this}isEnabled(){return this._enabled}stopEventHandling(){this._eventsAllowed=!1}startEventHandling(){this._eventsAllowed=!0}_addFocusHandlers(){let a=this._canvas;a.addEventListener("focusout",b=>{this._handleFocusEvents(b)});a.addEventListener("focusin",b=>{this._handleFocusEvents(b)})}_addMouseEventHandlers(){if(!this._mouseEventsEnabled){let a=this._canvas;a.addEventListener("mousedown",b=>{this._processMouseEvent(b)});a.addEventListener("mouseup",
b=>{this._processMouseEvent(b)});a.addEventListener("mousemove",b=>{this._processMouseEvent(b)});a.addEventListener("wheel",b=>{this._processMouseEvent(b)});a.addEventListener("mouseout",b=>{this._processMouseEvent(b)});a.addEventListener("mouseenter",b=>{this._processMouseEvent(b)});this._mouseEventsEnabled=!0}}_addKeyEventHandlers(){this._keyEventsEnabled||(this._target.setAttribute("tabindex","0"),this._target.focus(),this._target.addEventListener("keydown",a=>{this._handleKeyEvents(a);return!1}),
this._target.addEventListener("keyup",a=>{this._handleKeyEvents(a);return!1}),this._keyEventsEnabled=!0)}_addTouchEventHandlers(){if(!this._touchEventsEnabled){let a=this._canvas;a.addEventListener("touchstart",b=>{this._processTouchEvent(b)});a.addEventListener("touchend",b=>{this._processTouchEvent(b)});a.addEventListener("touchmove",b=>{this._processTouchEvent(b)});a.addEventListener("touchcancel",b=>{this._processTouchEvent(b)});this._touchEventsEnabled=!0}}_processMouseEvent(a){const b=this._canvas.getBoundingClientRect();
this.mx=a.clientX-b.left;this.my=a.clientY-b.top;this._processEvent(a,a.clientX-b.left,a.clientY-b.top)}_processTouchEvent(a){const b=this._canvas.getBoundingClientRect(),c=a.changedTouches[0];this.tx=c.clientX-b.left;this.ty=c.clientY-b.top;this._processEvent(a,c.clientX-b.left,c.clientY-b.top)}_processEvent(a,b,c){var d=this.getPicked(b,c);this.activeCtrl?this.activeCtrl=this.activeCtrl._doEvent(a,b,c,d):(d=this.getPicked(b,c),"mousemove"==a.type||"touchmove"==a.type?(this.overCtrl?._doEvent(a,
b,c,d),d.control&&(d.control?._doEvent(a,b,c,d),this.overCtrl=d.control)):this.activeCtrl=d.control?._doEvent(a,b,c,d))}_handleFocusEvents(a){}_handleKeyEvents(a){this._eventsAllowed&&this._enabled&&this.isVisible();return!1}$(a){return"string"===typeof a?this._controls.get(a):a}addControl(a,b=!1){CASSERT(!this._controls.has(a.id),`Control '${a.id}' already exists and will be replaced.`);this._controls.set(a.id,a);this._ctrls=[...this._controls.values()];this.setRenderOrder();b&&this.register(a);
...
this._pickbuffer.clear();if(this._visible){this._p.push();for(let a of this._ctrls)a.getParent()||a._draw(this._hud,this._pickbuffer);this._p.pop();this._drawHud()}}_drawHudP2D(){this._visible&&(this._p.push(),this._p.image(this._hud,0,0),this._p.pop())}_drawHudWEBGL(){if(this._visible){this._p.push();let a=this._renderer,b=a.drawingContext,c=a.width,d=a.height,e=Number.MAX_VALUE;b.flush();let f=a.uMVMatrix.copy(),h=a.uPMatrix.copy();b.disable(b.DEPTH_TEST);a.resetMatrix();this._getCamera().ortho(0,
c,-d,0,-e,e);this._p.image(this._hud,0,0);b.flush();a.uMVMatrix.set(f);a.uPMatrix.set(h);b.enable(b.DEPTH_TEST);this._p.pop()}}getPicked(a,b){let c=this._pickbuffer,d={control:null,part:-1};0<=a&&a<c.width&&0<=b&&b<c.height&&(a=c.get().get(a,b),a=(a[0]<<16)+(a[1]<<8)+a[2],d.control=this._colorKey.get(a&this._COLOR_MASK),d.part=a&this._PART_MASK);return d}}
...
class CvsBaseControl{constructor(a,b,c,d,e,f){this._children=[];this._enabled=this._visible=!0;this._pover=this._over=this._h=this._w=this._y=this._x=this._z=0;this._clickAllowed=!1;this._bufferInvalid=this._opaque=!0;this.action=function(){};this._gui=a;this._p=this._gui._p;this._id=b;this._x=Math.round(c);this._y=Math.round(d);this._w=Math.round(e);this._h=Math.round(f);this._parent=void 0;this._enabled=this._visible=!0;this._scheme=void 0;this._orientation=CvsBaseControl.EAST;this._dragging=!1;
this._c=a.corners(void 0)}get x(){return this._x}set x(a){this._x=Math.round(a)}get y(){return this._y}set y(a){this._y=Math.round(a)}get z(){return this._z}set z(a){this._z=a}get w(){return this._w}set w(a){this._w=Math.round(a)}get h(){return this._h}set h(a){this._h=Math.round(a)}get id(){return this._id}moveTo(a,b){this.x=a;this.y=b;return this}moveBy(a,b){this.x+=a;this.y+=b;return this}getAbsXY(){if(this._parent){let a=this._parent.getAbsXY();a.x+=this._x;a.y+=this._y;return a}return{x:this._x,
...
(c=a-(this._w-this._c[1]),d=b-this._c[1],0<c&&0>d&&c*c+d*d>this._c[1]*this._c[1])||5<this._c[2]&&(c=a-(this._w-this._c[2]),d=b-(this._h-this._c[2]),0<c&&0<d&&c*c+d*d>this._c[2]*this._c[2])||5<this._c[3]&&(a-=this._c[3],b-=this._h-this._c[3],0>a&&0<b&&a*a+b*b>this._c[3]*this._c[3])?0:1}return 0}_minControlSize(){return null}_updateControlVisual(){}_doEvent(a,b,c,d){return null}_handleKey(a){return!0}_handleTouch(a){}_processEvent(a,...b){}_draw(a,b){}_eq(a,b){return.001>Math.abs(a-b)}_neq(a,b){return.001<=
Math.abs(a-b)}over(){return this._over}pover(){return this._pover}orientation(){return this._orientation}}CvsBaseControl.NORTH=new OrientNorth;CvsBaseControl.SOUTH=new OrientSouth;CvsBaseControl.EAST=new OrientEast;CvsBaseControl.WEST=new OrientWest;
...
c-this._y,this.w,this.h);switch(a.type){case "mousedown":case "touchstart":0==d.part&&(this._clickAllowed=this._active=!0,this._part=d.part,this.isOver=!0);break;case "mouseout":case "mouseup":case "touchend":this.action({source:this,p5Event:a,value:this.value(),final:!0});this.isOver=this._active=!1;break;case "mousemove":case "touchmove":this._active&&(b=this._norm01(b-10,0,this._uiBfr.width-20),this._s2ticks&&(b=this._nearestTickT(b)),this._t01!=b&&(this._t01=b,this.action({source:this,p5Event:a,
value:this.value(),final:!1}))),this.isOver=this==d.control,this.invalidateBuffer()}return this._active?this:null}_nearestTickT(a){let b=0<this._minorTicks?this._minorTicks*this._majorTicks:this._majorTicks;return 0<b?Math.round(a*b)/b:a}_updateControlVisual(){let a=this._scheme||this._gui.scheme();var b=a.C_3,c=a.G_7,d=a.G_3;const e=a.G_1,f=a.C_9,h=a.C_6;let g=this._uiBfr,l=g.width-20,m=Math.round(g.height/2);g.push();g.clear();this._opaque&&(g.noStroke(),g.fill(b),g.rect(0,0,this._w,this._h,...this._c));
g.translate(10,m);g.stroke(c);g.strokeWeight(1);c=this._majorTicks*this._minorTicks;if(2<=c){b=l/c;for(var k=0;k<=c;k++){var q=k*b;g.line(q,-7,q,7)}}c=this._majorTicks;if(2<=c)for(b=l/c,k=0;k<=c;k++)q=k*b,g.line(q,-10,q,10);g.fill(d);g.rect(0,-4,l,8);d=l*this._t01;g.fill(e);g.rect(0,-4,d,8,...this._c);g.fill(h);g.noStroke();this._isOver&&(g.strokeWeight(2),g.stroke(f));g.rect(d-6,-6,12,12,...this._c);this._enabled||this._disable_hightlight(g,a,-10,-this._h/2,this._w,this._h);this._updateSliderPickBuffer(m,
l,8,d,12);g.pop();this._bufferInvalid=!1}_updateSliderPickBuffer(a,b,c,d,e){d=Math.round(d);b=this._gui.pickColor(this);c=this._pkBfr;c.push();c.clear();c.noStroke();c.translate(10,a);c.fill(b.r,b.g,b.b);c.rect(d-e/2,-e/2,e,e);c.pop()}_minControlSize(){return{w:this._w,h:20}}}
...
b,c=8){if(8>=Math.abs(b-this._uiBfr.height/2)){b=this._uiBfr.width-20;let d=this._t;a-=10;if(Math.abs(d[0]*b-a)<=c)return 1;if(Math.abs(d[1]*b-a)<=c)return 2}return 0}_doEvent(a,b,c,d){[b]=this._orientation.xy(b-this._x,c-this._y,this.w,this.h);switch(a.type){case "mousedown":case "touchstart":if(0==d.part||1==d.part)this._active=!0,this._tIdx=d.part,this.isOver=!0;break;case "mouseout":case "mouseup":case "touchend":this._active&&(d=Math.min(this._t[0],this._t[1]),b=Math.max(this._t[0],this._t[1]),
this._t[0]=d,this._t[1]=b,this._tIdx=-1,this.action({source:this,p5Event:a,low:this._t2v(d),high:this._t2v(b),final:!0}),this._active=!1,this.invalidateBuffer());break;case "mousemove":case "touchmove":this._active&&(d=this._norm01(b-10,0,this._uiBfr.width-20),this._s2ticks&&(d=this._nearestTickT(d)),this._t[this._tIdx]!=d&&(this._t[this._tIdx]=d,d=Math.max(this._t[0],this._t[1]),this.action({source:this,p5Event:a,low:this._t2v(Math.min(this._t[0],this._t[1])),high:this._t2v(d),final:!1})),this.invalidateBuffer())}return this._active?
this:null}_processEvent(a,...b){b=b[0];this._tIdx=this._active?this._tIdx:this._over-1;switch(a.type){case "mousedown":case "touchstart":0<this._over&&(this._active=!0,this._tIdx=this._over-1,this.invalidateBuffer());break;case "mouseout":case "mouseup":case "touchend":if(this._active){b=Math.min(this._t[0],this._t[1]);let c=Math.max(this._t[0],this._t[1]);this._t[0]=b;this._t[1]=c;this._tIdx=-1;this.action({source:this,p5Event:a,low:this._t2v(b),high:this._t2v(c),final:!0});this._active=!1;this.invalidateBuffer()}break;
case "mousemove":case "touchmove":this._active&&(b=this._norm01(b-10,0,this._uiBfr.width-20),this._s2ticks&&(b=this._nearestTickT(b)),this._t[this._tIdx]!=b&&(this._t[this._tIdx]=b,b=Math.max(this._t[0],this._t[1]),this.action({source:this,p5Event:a,low:this._t2v(Math.min(this._t[0],this._t[1])),high:this._t2v(b),final:!1})),this.invalidateBuffer())}}_updateControlVisual(){let a=this._scheme||this._gui.scheme();var b=a.C_3,c=a.G_7,d=a.G_3,e=a.G_1;const f=a.C_9,h=a.C_6;let g=this._uiBfr,l=g.width-
20,m=Math.round(g.height/2);g.push();g.clear();this._opaque&&(g.noStroke(),g.fill(b),g.rect(0,0,this._w,this._h,...this._c));g.translate(10,m);g.stroke(c);g.strokeWeight(1);c=this._majorTicks*this._minorTicks;if(2<=c){b=l/c;for(var k=0;k<=c;k++){var q=k*b;g.line(q,-7,q,7)}}c=this._majorTicks;if(2<=c)for(b=l/this._majorTicks,k=0;k<=c;k++)q=k*b,g.line(q,-10,q,10);g.fill(d);g.rect(0,-4,l,8);d=l*Math.min(this._t[0],this._t[1]);b=l*Math.max(this._t[0],this._t[1]);g.fill(e);g.rect(d,-4,b-d,8,...this._c);
for(e=0;2>e;e++)g.fill(h),g.noStroke(),(this._active||this.isOver)&&e==this._tIdx&&(g.strokeWeight(2),g.stroke(f)),g.rect(this._t[e]*l-6,-6,12,12,...this._c);this._enabled||this._disable_hightlight(g,a,-10,-this._h/2,this._w,this._h);this._updateRangerPickBuffer(m,l,8,d,b,12);g.pop();this._bufferInvalid=!1}_updateRangerPickBuffer(a,b,c,d,e,f){d=Math.round(d);e=Math.round(e);b=this._gui.pickColor(this);c=this._pkBfr;c.push();c.clear();c.noStroke();c.translate(10,a);c.fill(b.r,b.g,b.b);c.rect(d-f/2,
-f/2,f,f);c.fill(b.r,b.g,b.b+1);c.rect(e-f/2,-f/2,f,f);c.pop()}}Object.assign(CvsRanger.prototype,processMouse,processTouch);
...
class CvsLabel extends CvsTextIcon{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||60,f||16)}_updateControlVisual(){var a=this._textSize||this._gui.textSize(),b=this._scheme||this._gui.scheme();let c=this._p;var d=this._icon,e=this._iconAlign;let f=this._textAlign,h=this._lines,g=this._gap;var l=b.C_3;b=b.C_8;let m=this._uiBfr;m.push();m.clear();this._opaque&&(m.noStroke(),m.fill(l),m.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));if(d){l=0;switch(e){case c.LEFT:l=g;break;
case c.RIGHT:l=this._w-d.width-g}0==h.length&&(l=(this._w-d.width)/2);m.image(this._icon,l,(this._h-d.height+g)/2)}if(0<h.length){m.textSize(a);a=g;l=this._w-g;let k=0;d&&e==c.LEFT&&(a+=d.width);d&&e==c.RIGHT&&(l-=d.width);d=l-a;e=this._tbox.h;e=m.textAscent()+(this._h-e)/2;m.fill(b);for(let q of h){switch(f){case c.LEFT:k=a;break;case c.CENTER:k=a+(d-m.textWidth(q))/2;break;case c.RIGHT:k=l-m.textWidth(q)-g}m.text(q,k,e);e+=m.textLeading()}}m.pop();this._bufferInvalid=!1}}
class CvsButton extends CvsTextIcon{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||80,f||16)}_updateControlVisual(){var a=this._textSize||this._gui.textSize();let b=this._scheme||this._gui.scheme();var c=this._iconAlign;let d=this._textAlign;var e=this._icon;let f=this._lines,h=this._gap;var g=b.C_3;const l=b.C_8,m=b.C_9;let k=this._uiBfr;k.push();k.clear();this._opaque&&(k.noStroke(),k.fill(g),k.rect(1,1,this._w-1,this._h-1,...this._c));if(e){g=0;switch(c){case this._p.LEFT:g=h;break;case this._p.RIGHT:g=
this._w-e.width-h}0==f.length&&(g=(this._w-e.width)/2);k.image(this._icon,g,(this._h-e.height)/2)}if(0<f.length){k.textSize(a);a=h;g=this._w-h;let q=0;e&&c==this._p.LEFT&&(a+=e.width);e&&c==this._p.RIGHT&&(g-=e.width);c=g-a;e=this._tbox.h;e=k.textAscent()+(this._h-e)/2;k.fill(l);for(let n of f){switch(d){case this._p.LEFT:q=a;break;case this._p.CENTER:q=a+(c-k.textWidth(n))/2;break;case this._p.RIGHT:q=g-k.textWidth(n)-h}k.text(n,q,e);e+=k.textLeading()}}this._isOver&&(k.stroke(m),k.strokeWeight(2),
k.noFill(),k.rect(1,1,this._w-2,this._h-2,...this._c));this._enabled||this._disable_hightlight(k,b,0,0,this._w,this._h);this._updateRectControlPB();k.pop();this._bufferInvalid=!1;this._parent instanceof CvsPane&&this._parent.validateTabs()}_doEvent(a,b,c,d){switch(a.type){case "mousedown":case "touchstart":this._clickAllowed=this._active=!0;this._part=d.part;this.isOver=!0;break;case "mouseout":case "mouseup":case "touchend":this._active&&(this._clickAllowed&&this.action({source:this,p5Event:a}),
this.isOver=this._clickAllowed=this._active=!1);break;case "mousemove":case "touchmove":this._clickAllowed=!1,this.isOver=this==d.control}return this._active?this:null}}
...
this._scheme||this._gui.scheme();const b=a.C_3,c=a.G_8,d=a.G_3,e=a.C_9,f=a.C_5;let h=Math.max(this._used*this._TLENGTH,this._MIN_THUMB_WIDTH),g=this._THUMB_HEIGHT,l=this._dvalue*this._TLENGTH,m=this._uiBfr;m.push();m.clear();this._opaque&&(m.noStroke(),m.fill(b),m.rect(0,0,this._w,this._h,...this._c));m.translate(this._BORDER,m.height/2);m.fill(d);m.stroke(c);m.strokeWeight(1);m.rect(0,-this._THEIGHT/2,this._TLENGTH,this._THEIGHT);m.fill(f);m.noStroke();if(this._active||0<this._over)m.strokeWeight(2),
m.stroke(e);m.rect(l-h/2,-g/2,h,g,...this._c);this._enabled||this._disable_hightlight(m,a,0,-this._h/2,this._w-20,this._h);this._updateScrollerPickBuffer(l-h/2,-g/2,h,g);m.pop();this._bufferInvalid=!1}_updateScrollerPickBuffer(a,b,c,d){b=this._gui.pickColor(this);let e=this._pkBfr;e.push();e.clear();e.noStroke();e.fill(b.r,b.g,b.b);e.translate(this._BORDER,0);e.rect(Math.round(a),Math.round((e.height-d)/2),c,d);e.pop()}_minControlSize(){return{w:this._w,h:20}}}
...
this._gui.getOptionGroup(a);this._optGroup.add(this);return this}_doEvent(a,b,c,d){switch(a.type){case "mousedown":case "touchstart":this._clickAllowed=this._active=!0;this._part=d.part;this.isOver=!0;break;case "mouseout":case "mouseup":case "touchend":this._active&&(this._clickAllowed&&!this._selected&&this._optGroup&&(this.select(),this.action({source:this,p5Event:a,selected:!0})),this.isOver=this._clickAllowed=this._active=!1);break;case "mousemove":case "touchmove":this._clickAllowed=!1,this.isOver=
this==d.control}return this._active?this:null}_updateControlVisual(){var a=this._textSize||this._gui.textSize();let b=this._scheme||this._gui.scheme(),c=this._p;var d=c.constrain(.7*Number(a),12,16),e=this._iconAlign;let f=this._textAlign,h=this._lines,g=this._gap;var l=b.C_3;const m=b.C_8;var k=b.G_0;const q=b.G_9,n=b.C_9;let p=this._uiBfr;p.push();p.clear();this._opaque&&(p.noStroke(),p.fill(l),p.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));p.push();p.translate(e==c.RIGHT?
this._w-g-d/2:g+d/2,p.height/2);p.stroke(q);p.fill(k);p.strokeWeight(1.5);p.ellipse(0,0,d,d);this._selected&&(p.fill(q),p.noStroke(),p.ellipse(0,0,d/2,d/2));p.pop();if(0<h.length){p.textSize(a);a=g;l=this._w-g;k=0;e==c.LEFT&&(a+=d+g);e==c.RIGHT&&(l-=d+g);d=l-a;e=this._tbox.h;e=p.textAscent()+(this._h-e)/2;p.fill(m);for(let r of h){switch(f){case c.LEFT:k=a;break;case c.CENTER:k=a+(d-p.textWidth(r))/2;break;case c.RIGHT:k=l-p.textWidth(r)-g}p.text(r,k,e);e+=p.textLeading()}}this.isOver&&(p.stroke(n),
p.strokeWeight(2),p.noFill(),p.rect(1,1,this._w-2,this._h-2,this._c[0],this._c[1],this._c[2],this._c[3]));this._enabled||this._disable_hightlight(p,b,0,0,this._w,this._h);this._updateRectControlPB();p.pop();this._bufferInvalid=!1}_minControlSize(){let a=this._uiBfr,b=this._lines,c=this._tbox,d=0;var e=0;e=this._gap;var f=this._textSize||this._gui.textSize();f=this._p.constrain(.7*Number(f),12,16);if(0<b.length){a||this._validateBuffer();let h=this._textSize||this._gui.textSize();a.textSize(h);c.w=
...
d){switch(a.type){case "mousedown":case "touchstart":this._clickAllowed=this._active=!0;this._part=d.part;this.isOver=!0;break;case "mouseout":case "mouseup":case "touchend":this._active&&(this._clickAllowed&&(this._selected=!this._selected,this.action({source:this,p5Event:a,selected:this._selected})),this.isOver=this._clickAllowed=this._active=!1);break;case "mousemove":case "touchmove":this._clickAllowed=!1,this.isOver=this==d.control}return this._active?this:null}_updateControlVisual(){var a=this._textSize||
this._gui.textSize();let b=this._scheme||this._gui.scheme(),c=this._p;var d=c.constrain(.7*Number(a),12,16),e=this._iconAlign;let f=this._textAlign,h=this._lines,g=this._gap;var l=b.C_3;const m=b.C_8;var k=b.G_0;const q=b.G_9,n=b.C_9;let p=this._uiBfr;p.push();p.clear();this._opaque&&(p.noStroke(),p.fill(l),p.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));p.push();p.translate(e==c.RIGHT?this._w-g-d/2:g+d/2,p.height/2);p.stroke(q);p.fill(k);p.strokeWeight(1.5);p.rect(-d/2,-d/
2,d,d,3);this._selected&&(p.strokeWeight(2.5),p.line(-.281*d,0,-.188*d,.313*d),p.line(.27*d,-.27*d,-.188*d,.313*d));p.pop();if(0<h.length){p.textSize(a);a=g;l=this._w-g;k=0;e==c.LEFT&&(a+=d+g);e==c.RIGHT&&(l-=d+g);d=l-a;e=this._tbox.h;e=p.textAscent()+(this._h-e)/2;p.fill(m);for(let r of h){switch(f){case c.LEFT:k=a;break;case c.CENTER:k=a+(d-p.textWidth(r))/2;break;case c.RIGHT:k=l-p.textWidth(r)-g}p.text(r,k,e);e+=p.textLeading()}}this._isOver&&(p.stroke(n),p.strokeWeight(2),p.noFill(),p.rect(1,
1,this._w-2,this._h-2,this._c[0],this._c[1],this._c[2],this._c[3]));this._enabled||this._disable_hightlight(p,b,0,0,this._w,this._h);this._updateRectControlPB();p.pop();this._bufferInvalid=!1}_minControlSize(){let a=this._uiBfr,b=this._lines,c=this._tbox,d=0;var e=0;e=this._gap;var f=this._textSize||this._gui.textSize();f=this._p.constrain(.7*Number(f),12,16);if(0<b.length){a||this._validateBuffer();let h=this._textSize||this._gui.textSize();a.textSize(h);c.w=h+b.map(g=>a.textWidth(g)).reduce((g,
...
class CvsViewer extends CvsBufferedControl{constructor(a,b,c,d,e,f){super(a,b,c,d,e,f);this._layers=[];this._hidden=new Set;this._wcy=this._wcx=this._lh=this._lw=0;this._wscale=1;this._frameWeight=this._usedY=this._usedX=0;this._handleMouse=function(h){var g=this.getAbsXY();let l=this._p.mouseX-g.x;g=this._p.mouseY-g.y;this._pover=this._over;this._over=this._whereOver(l,g);this._bufferInvalid=this._bufferInvalid||this._pover!=this._over;this._tooltip&&this._tooltip._updateState(this,this._pover,this._over);
this._scaler&&(2==this._over?this._scaler.show():this._scaler.hide());1<=this._over?(1>this._scrH.getUsed()?this._scrH.show():this._scrH.hide(),1>this._scrV.getUsed()?this._scrV.show():this._scrV.hide()):(this._scrH.hide(),this._scrV.hide());this._processEvent(h,l,g);return!1};this._scrH=a.__scroller(this._id+"-scrH",0,f-20,e,20).hide().setAction(h=>{this.view(h.value*this._lw,this._wcy);this.invalidateBuffer()});this._scrV=a.__scroller(this._id+"-scrV",e-20,0,f,20).orient("south").hide().setAction(h=>
...
this._wscale=a;0<this._lw&&0<this._lh&&(this._wcx=this._lw*this._scrH.getValue(),this._wcy=this._lh*this._scrV.getValue(),this.invalidateBuffer())}return this}scale(a){if(!Number.isFinite(a))return this._wscale;this._scaler&&this._scaler.value(a);this._wscale=a;this.view(this._wcx,this._wcy,this._wscale);this.invalidateBuffer();return this}status(){return{cX:this._wcx,cY:this._wcy,scale:this._wscale}}hide(){return super.hide(!0)}show(){return super.show(!0)}hideLayer(a){Number.isInteger(a)&&0<=a&&
a<this._layers.length&&!this._hidden.has(a)&&(this._hidden.add(a),this.invalidateBuffer());return this}showLayer(a){Number.isInteger(a)&&0<=a&&a<this._layers.length&&this._hidden.has(a)&&(this._hidden.delete(a),this.invalidateBuffer());return this}view(a,b,c){if(Number.isFinite(a)&&Number.isFinite(b)){if(this._neq(this._wcx,a)||this._neq(this._wcy,b))this._wcx=this._p.constrain(a,0,this._lw),this._wcy=this._p.constrain(b,0,this._lh),this._scrH.update(a/this._lw),this._scrV.update(b/this._lh),this.invalidateBuffer();
this._neq(this._wscale,c)&&(this._wscale=c,this._scaler&&this._scaler.value(c),this.invalidateBuffer());this.action({source:this,p5Event:void 0,cX:this._wcx,cY:this._wcy,scale:this._wscale})}return this}layers(a){Array.isArray(a)?this._layers=Array.from(a):this._layers[0]=a;a=this._lw=this._layers[0].width;let b=this._lh=this._layers[0].height;for(let c=1;c<this._layers[c];c++){let d=this._layers[c];d.width==a&&d.height==b||d.resize(a,b)}this._wcx=this._scrH.getValue()*this._lw;this._wcy=this._scrV.getValue()*
this._lh;this.invalidateBuffer();return this}frame(a=0){this._frameWeight=0>a?0:a;return this}_whereOver(a,b){if(a>this._w-20&&a<this._w&&0<b&&b<this._h-20||0<a&&a<this._w-20&&b>this._h-20&&b<this._h)return 3;let c=this._w,d=this._h;return this._scaler&&a>.2*c&&a<.8*c&&b>.35*d&&b<.65*d?2:0<a&&a<c&&0<b&&b<d?1:0}_handleTouch(a){a.preventDefault();var b=this.getAbsXY();const c=this._gui._canvas.getBoundingClientRect(),d=a.changedTouches[0];let e=d.clientX-c.left-b.x;b=d.clientY-c.top-b.y;this._pover=
this._over;this._over=this._whereOver(e,b);this._bufferInvalid=this._bufferInvalid||this._pover!=this._over;this._tooltip&&this._tooltip._updateState(this,this._pover,this._over);this._scaler&&(2==this._over?this._scaler.show():this._scaler.hide());1<=this._over?(1>this._scrH.getUsed()?this._scrH.show():this._scrH.hide(),1>this._scrV.getUsed()?this._scrV.show():this._scrV.hide()):(this._scrH.hide(),this._scrV.hide());this._processEvent(a,e,b)}_processEvent(a,...b){let c=b[0];b=b[1];switch(a.type){case "mousedown":case "touchstart":1==
...
b){return(a||b)&&!(a&&b)}_updateControlVisual(){var a=this._scheme||this._gui.scheme();let b=this._wscale;var c=this._wcx,d=this._wcy,e=a.C_2;a=a.C_7;let f=this._uiBfr;f.push();this._opaque?f.background(e):f.clear();e=Math.round(.5*this._w/b);let h=Math.round(.5*this._h/b);c=this._overlap(0,0,this._lw,this._lh,c-e,d-h,c+e,d+h);let [g,l]=[Math.round(c.offsetX*b),Math.round(c.offsetY*b)],[m,k]=[Math.round(c.width*b),Math.round(c.height*b)];if(c.valid)for(let q=0,n=this._layers.length;q<n;q++)!this._hidden.has(q)&&
this._layers[q]&&(d=this._layers[q].get(c.left,c.top,c.width,c.height),.01<Math.abs(b-1)&&d.resize(m,k),f.image(d,c.offsetX*b,c.offsetY*b,d.width,d.height));0<this._frameWeight&&(f.noFill(),f.stroke(a),f.strokeWeight(this._frameWeight),f.rect(0,0,f.width,f.height));this._updateViewerPickBuffer(g,l,m,k);f.pop()}_updateViewerPickBuffer(a,b,c,d){let e=this._gui.pickColor(this),f=this._pkBfr;f.push();f.clear();f.noStroke();f.fill(e.r,e.g,e.b);f.rect(a,b,c,d);f.pop()}_overlap(a,b,c,d,e,f,h,g){var l=Math.min(b,
...
2*this._gap;const f=b.G_9,h=b.C_9,g=b.C_3;let l=b.C_1,m=b.C_9,k=this._uiBfr;k.push();k.textSize(a);k.background(b.G_0);k.noStroke();if(!this._active)l=d?b.C_9:b.C_1,m=d?b.C_3:b.C_9,k.stroke(m),k.strokeWeight(1.5),k.fill(l),k.rect(0,0,this._w,this._h);else if(this._currCsrIdx!=this._prevCsrIdx){d=this._cursorX(k,c,this._prevCsrIdx);let q=this._cursorX(k,c,this._currCsrIdx);k.noStroke();k.fill(g);k.rect(e+Math.min(d,q),1,Math.abs(d-q),this._h-2)}k.fill(l);k.textSize(a);k.textAlign(this._p.LEFT,this._p.TOP);
k.noStroke();k.fill(m);k.text(c,e,(this._h-a)/2);this._activate&&this._cursorOn&&(a=this._cursorX(k,c,this._currCsrIdx),k.stroke(f),k.strokeWeight(1.5),k.line(e+a,4,e+a,this._h-5));0<this._over&&(k.stroke(h),k.strokeWeight(2),k.noFill(),k.rect(1,1,this._w-2,this._h-2,this._c[0],this._c[1],this._c[2],this._c[3]));this._enabled||this._disable_hightlight(k,b,0,0,this._w,this._h);this._updateRectControlPB();k.pop();this._bufferInvalid=!1}}Object.assign(CvsTextField.prototype,processMouse,processTouch);
...
this._dir,this._dead]=[c,a,d,b]}_doEvent(a,b,c,d){function e(m,k,q){return{source:m,p5Event:k,final:q,mag:(m._mag-m._pr0)/(m._pr1-m._pr0),angle:m._ang,dir:m._dir,dead:m._dead}}let [f,h,g,l]=this._orientation.xy(b-this._x,c-this._y,this.w,this.h);f-=g/2;h-=l/2;switch(a.type){case "mousedown":case "touchstart":this._active=!0;this._part=d.part;this.isOver=!0;break;case "mouseout":case "mouseup":case "touchend":this._validateThumbPosition(f,h);this.action(e(this,a,!0));this._active=!1;this.invalidateBuffer();
this._tmrID||(this._tmrID=setInterval(()=>{this._mag-=.07*this._size;0>=this._mag&&(clearInterval(this._tmrID),this._tmrID=void 0,this._mag=0);this.invalidateBuffer()},25));break;case "mousemove":case "touchmove":this._active&&(this._validateThumbPosition(f,h),this.action(e(this,a,!1))),this.isOver=this==d.control,this.invalidateBuffer()}return this._active?this:null}_processEvent(a,...b){function c(e,f,h){return{source:e,p5Event:f,final:h,mag:(e._mag-e._pr0)/(e._pr1-e._pr0),angle:e._ang,dir:e._dir,
dead:e._dead}}let d=b[0];b=b[1];d-=this._w/2;b-=this._h/2;switch(a.type){case "mousedown":case "touchstart":0<this._over&&(this._active=!0,this.invalidateBuffer());break;case "mouseout":case "mouseup":case "touchend":this._active&&(this._validateThumbPosition(d,b),this.action(c(this,a,!0)),this._active=!1,this.invalidateBuffer(),this._tmrID||(this._tmrID=setInterval(()=>{this._mag-=.07*this._size;0>=this._mag&&(clearInterval(this._tmrID),this._tmrID=void 0,this._mag=0);this.invalidateBuffer()},25)));
break;case "mousemove":case "touchmove":this._active&&(this._validateThumbPosition(d,b),this.action(c(this,a,!1)),this.invalidateBuffer())}}_updateControlVisual(){var a=this._scheme||this._gui.scheme();let [b,c]=[this._mag*Math.cos(this._ang),this._mag*Math.sin(this._ang)];var d=a.C_3,e=a.C_1,f=a.T_0;const h=a.C_9,g=a.C_9,l=a.C_4,m=a.C_6,k=a.C_7;var q=a.C_8;a=a.T_5;let n=this._uiBfr;n.push();n.clear();this._opaque&&(n.noStroke(),n.fill(d),n.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],
this._c[3]));n.translate(n.width/2,n.height/2);n.noStroke();n.fill(e);n.ellipse(0,0,2*this._pr1,2*this._pr1);d=.26*this._size;n.fill(f);n.noStroke();n.ellipse(0,0,2*d,2*d);n.ellipse(0,0,1.25*d,1.25*d);n.stroke(q);switch(this._mode){case "X0":f=this._pr1;q=Math.PI/8;n.push();n.strokeWeight(.75);d=.3*this._size;for(e=0;16>e;e++)n.line(f,0,d,0),n.rotate(q);n.pop();break;case "X8":f=this._pr0;d=.33*this._size;q=Math.PI/4;n.push();n.strokeWeight(1);for(e=0;8>e;e++)n.line(f,0,d,0),n.rotate(q);n.pop();case "X4":f=
this._pr0;d=this._pr1;q=Math.PI/2;n.push();n.strokeWeight(1.5);for(e=0;4>e;e++)n.line(f,0,d,0),n.rotate(q);n.pop()}n.stroke(h);n.strokeWeight(Math.max(3,.025*this._size));n.noFill();n.ellipse(0,0,2*this._pr1,2*this._pr1);n.fill(a);n.noStroke();n.ellipse(0,0,2*this._pr0,2*this._pr0);n.stroke(k);n.strokeWeight(.05*this._size);n.line(0,0,b,c);n.strokeWeight(2);n.stroke(g);this._active||0<this._over?n.fill(m):n.fill(l);n.ellipse(b,c,2*this._tSize,2*this._tSize);this._updateJoystickPickBuffer(b,c,this._tSize);
n.pop();this._bufferInvalid=!1}_updateJoystickPickBuffer(a,b,c){let d=this._gui.pickColor(this),e=this._pkBfr;e.push();e.clear();e.translate(e.width/2,e.height/2);e.noStroke();e.fill(d.r,d.g,d.b);e.ellipse(a,b,2*c,2*c);e.pop()}}Object.assign(CvsJoystick.prototype,processMouse,processTouch);
...
f;this.isOver=this._active=!0;this.invalidateBuffer();break;case "mouseout":case "mouseup":case "touchend":b=this._tFromXY(e,f);this._t01=this._s2ticks?this._nearestTickT(b.t):b.t;this.action({source:this,p5Event:a,value:this.value(),final:!0});this._active=!1;this.invalidateBuffer();break;case "mousemove":case "touchmove":this._active&&(b=this._tFromXY(e,f),b=this._s2ticks?this._nearestTickT(b.t):b.t,this._t01!=b&&(this._prevX=e,this._prevY=f,this._t01=b,this.action({source:this,p5Event:a,value:this.value(),
final:!1}))),this.isOver=this==d.control,this.invalidateBuffer()}return this._active?this:null}_whereOver(a,b,c=0){a-=this._w/2;b-=this._h/2;c=this._kRad+c;return a*a+b*b<=c*c?1:0}_updateControlVisual(){var a=this._scheme||this._gui.scheme(),b=a.C_3,c=a.C_7;const d=a.C_8,e=a.C_3,f=a.C_9;var h=a.C_3,g=a.C_1,l=a.G_8;const m=a.G_2,k=a.T_1;a=this._uiBfr;a.clear();this._opaque&&(a.noStroke(),a.fill(b),a.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));b=this._turnArc;var q=(2*Math.PI-
b)/2;let n=this._gRad,p=2*this._kRad,r=2*n;a.push();a.translate(a.width/2,a.height/2);a.rotate(this._gapPos+q);a.noStroke();a.fill(h);a.ellipse(0,0,p,p);a.fill(g);a.arc(0,0,p,p,0,this._turnArc);h=this._majorTicks*this._minorTicks;if(2<=h){g=this._tw;q=.65*g;a.stroke(l);l=b/h;a.push();a.strokeWeight(.9);for(let t=0;t<=h;t++)a.line(n,0,n+q,0),a.rotate(l);a.pop();h=this._majorTicks;if(2<=h){l=b/h;a.push();a.strokeWeight(1);for(q=0;q<=h;q++)a.line(n,0,n+g,0),a.rotate(l);a.pop()}a.noStroke();a.fill(k);
a.arc(0,0,r+g,r+g,0,b);a.fill(m);a.arc(0,0,r+g,r+g,0,this._t01*b)}a.stroke(d);a.strokeWeight(1.5);a.fill(c);a.ellipse(0,0,r,r);a.push();a.rotate(this._t01*b);c=.2*n;a.fill(e);a.noStroke();a.beginShape();a.vertex(-c,0);a.vertex(0,-c);a.vertex(n,0);a.vertex(0,c);a.endShape(this._p.CLOSE);a.pop();this.isOver&&(a.noFill(),a.stroke(f),a.strokeWeight(3),a.arc(0,0,2*this._kRad,2*this._kRad,0,b));this._updateKnobPickBuffer(p);a.pop();this._bufferInvalid=!1}_updateKnobPickBuffer(a){let b=this._gui.pickColor(this),
c=this._pkBfr;c.push();c.clear();c.translate(c.width/2,c.height/2);c.noStroke();c.fill(b.r,b.g,b.b);c.ellipse(0,0,a,a);c.pop()}_minControlSize(){return{w:this._size,h:this._size}}}CvsKnob.X_MODE=1;CvsKnob.Y_MODE=2;CvsKnob.A_MODE=3;
