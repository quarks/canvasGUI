...
this._scheme||this._gui.scheme();var b=a.C_3,c=a.G_7,d=a.G_3,e=a.G_1;const f=a.C_9,h=a.C_6;let g=this._uiBfr,l=g.width-20,q=Math.round(g.height/2);g.push();g.clear();this._opaque&&(g.noStroke(),g.fill(b),g.rect(0,0,this._w,this._h,...this._c));g.translate(10,q);g.stroke(c);g.strokeWeight(1);c=this._majorTicks*this._minorTicks;if(2<=c){b=l/c;for(var m=0;m<=c;m++){var p=m*b;g.line(p,-7,p,7)}}c=this._majorTicks;if(2<=c)for(b=l/this._majorTicks,m=0;m<=c;m++)p=m*b,g.line(p,-10,p,10);g.fill(d);g.rect(0,
...
class CvsButton extends CvsTextIcon{constructor(a,b,c,d,e,f){super(a,b,c||0,d||0,e||80,f||16)}_updateControlVisual(){var a=this._textSize||this._gui.textSize();let b=this._scheme||this._gui.scheme();var c=this._iconAlign;let d=this._textAlign;var e=this._icon;let f=this._lines,h=this._gap;var g=b.C_3;const l=b.C_8,q=b.C_9;let m=this._uiBfr;m.push();m.clear();this._opaque&&(m.noStroke(),m.fill(g),m.rect(1,1,this._w-1,this._h-1,...this._c));if(e){g=0;switch(c){case this._p.LEFT:g=h;break;case this._p.RIGHT:g=
this._w-e.width-h}0==f.length&&(g=(this._w-e.width)/2);m.image(this._icon,g,(this._h-e.height)/2)}if(0<f.length){m.textSize(a);a=h;g=this._w-h;let p=0;e&&c==this._p.LEFT&&(a+=e.width);e&&c==this._p.RIGHT&&(g-=e.width);c=g-a;e=this._tbox.h;e=m.textAscent()+(this._h-e)/2;m.fill(l);for(let k of f){switch(d){case this._p.LEFT:p=a;break;case this._p.CENTER:p=a+(c-m.textWidth(k))/2;break;case this._p.RIGHT:p=g-m.textWidth(k)-h}m.text(k,p,e);e+=m.textLeading()}}this._isOver&&(m.stroke(q),m.strokeWeight(2),
m.noFill(),m.rect(1,1,this._w-2,this._h-2,...this._c));this._enabled||this._disable_hightlight(m,b,0,0,this._w,this._h);this._updateRectControlPB();m.pop();this._bufferInvalid=!1;this._parent instanceof CvsPane&&this._parent.validateTabs()}_doEvent(a,b,c,d,e){switch(a.type){case "mousedown":case "touchstart":this.isOver=this._clickAllowed=this._active=!0;break;case "mouseout":case "mouseup":case "touchend":this.isActive&&(this._clickAllowed&&this.action({source:this,p5Event:a}),this.isOver=this._clickAllowed=
...
this._gui.scheme();const b=a.C_3,c=a.G_8,d=a.G_3,e=a.C_9,f=a.C_5;let [h,g,l,q]=[this._w,this._h,this._inset,this._used],[m,p]=[this._trackWidth,this._trackHeight],k=Math.max(q*m,this._minThumbWidth),n=this._thumbHeight,t=this._dvalue*this._trackWidth,r=this._uiBfr;r.push();r.clear();this._opaque&&(r.noStroke(),r.fill(b),r.rect(0,0,h,g,...this._c));r.translate(l,this._uiBfr.height/2);r.fill(d);r.stroke(c);r.strokeWeight(1);r.rect(0,-p/2,m,p);r.fill(f);r.noStroke();if(this.isActive||this.isOver)r.strokeWeight(2),
r.stroke(e);r.rect(t-k/2,-n/2,k,n,...this._c);this._enabled||this._disable_hightlight(r,a,0,-g/2,h-20,g);this._updateScrollerPickBuffer(t-k/2,-n/2,k,n);r.pop();this._bufferInvalid=!1}_updateScrollerPickBuffer(a,b,c,d){let e=this._gui.pickColor(this),f=this._pkBfr;f.push();f.clear();f.noStroke();f.fill(e.r,e.g,e.b);f.translate(this._inset,this._pkBfr.height/2);f.rect(Math.round(a),Math.round(b),c,d);f.pop()}_minControlSize(){return{w:this._w,h:20}}}
...
this._tooltip?._updateState(e)}return this.isActive?this:null}_updateControlVisual(){var a=this._textSize||this._gui.textSize();let b=this._scheme||this._gui.scheme(),c=this._p;var d=c.constrain(.7*Number(a),12,16),e=this._iconAlign;let f=this._textAlign,h=this._lines,g=this._gap;var l=b.C_3;const q=b.C_8;var m=b.G_0;const p=b.G_9,k=b.C_9;let n=this._uiBfr;n.push();n.clear();this._opaque&&(n.noStroke(),n.fill(l),n.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));n.push();n.translate(e==
c.RIGHT?this._w-g-d/2:g+d/2,n.height/2);n.stroke(p);n.fill(m);n.strokeWeight(1.5);n.ellipse(0,0,d,d);this._selected&&(n.fill(p),n.noStroke(),n.ellipse(0,0,d/2,d/2));n.pop();if(0<h.length){n.textSize(a);a=g;l=this._w-g;m=0;e==c.LEFT&&(a+=d+g);e==c.RIGHT&&(l-=d+g);d=l-a;e=this._tbox.h;e=n.textAscent()+(this._h-e)/2;n.fill(q);for(let t of h){switch(f){case c.LEFT:m=a;break;case c.CENTER:m=a+(d-n.textWidth(t))/2;break;case c.RIGHT:m=l-n.textWidth(t)-g}n.text(t,m,e);e+=n.textLeading()}}this.isOver&&(n.stroke(k),
...
this._textSize||this._gui.textSize();let b=this._scheme||this._gui.scheme(),c=this._p;var d=c.constrain(.7*Number(a),12,16),e=this._iconAlign;let f=this._textAlign,h=this._lines,g=this._gap;var l=b.C_3;const q=b.C_8;var m=b.G_0;const p=b.G_9,k=b.C_9;let n=this._uiBfr;n.push();n.clear();this._opaque&&(n.noStroke(),n.fill(l),n.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));n.push();n.translate(e==c.RIGHT?this._w-g-d/2:g+d/2,n.height/2);n.stroke(p);n.fill(m);n.strokeWeight(1.5);
n.rect(-d/2,-d/2,d,d,3);this._selected&&(n.strokeWeight(2.5),n.line(-.281*d,0,-.188*d,.313*d),n.line(.27*d,-.27*d,-.188*d,.313*d));n.pop();if(0<h.length){n.textSize(a);a=g;l=this._w-g;m=0;e==c.LEFT&&(a+=d+g);e==c.RIGHT&&(l-=d+g);d=l-a;e=this._tbox.h;e=n.textAscent()+(this._h-e)/2;n.fill(q);for(let t of h){switch(f){case c.LEFT:m=a;break;case c.CENTER:m=a+(d-n.textWidth(t))/2;break;case c.RIGHT:m=l-n.textWidth(t)-g}n.text(t,m,e);e+=n.textLeading()}}this._isOver&&(n.stroke(k),n.strokeWeight(2),n.noFill(),
...
b=this._lh/2:this._xor(0>l,d>this._lh)&&(b=0>l?b-l:b+(this._lh-d));this.view(a,b);this.invalidateBuffer()}_updateControlVisual(){var a=this._scheme||this._gui.scheme();let [b,c,d]=[this._wscale,this._wcx,this._wcy],[e,f,h,g]=[this._w,this._h,this._lw,this._lh];var l=a.C_2;a=a.C_7;let q=this._uiBfr;q.push();this._opaque?q.background(l):q.clear();l=Math.round(.5*e/b);var m=Math.round(.5*f/b);l=this._overlap(0,0,h,g,c-l,d-m,c+l,d+m);let [p,k]=[Math.round(l.offsetX*b),Math.round(l.offsetY*b)],[n,t]=[Math.round(l.width*
b),Math.round(l.height*b)];if(l.valid)for(let r=0,u=this._layers.length;r<u;r++)!this._hidden.has(r)&&this._layers[r]&&(m=this._layers[r].get(l.left,l.top,l.width,l.height),.01<Math.abs(b-1)&&m.resize(n,t),q.image(m,l.offsetX*b,l.offsetY*b,m.width,m.height));0<this._frameWeight&&(q.noFill(),q.stroke(a),q.strokeWeight(this._frameWeight),q.rect(0,0,q.width,q.height));this._updateViewerPickBuffer(p,k,n,t);q.pop()}_updateViewerPickBuffer(a,b,c,d){let e=this._gui.pickColor(this),f=this._pkBfr;f.push();
...
for(a=a.toString().replaceAll("\n"," ");0<a.length&&this._uiBfr.textWidth(a)>=this._maxTextWidthPixels();)a=a.substring(0,a.length-1);this._lines=[a];this._validate();this.invalidateBuffer();return this}textSize(a){let b=this._textSize||this._gui.textSize();if(!Number.isFinite(a))return b;a=Number(a);a!=b&&(this._textSize=a,this.invalidateBuffer());return this}textAlign(a){return this}noText(){return this}noIndex(){Number.isFinite(this._linkIndex)&&!this._gui._links&&this._gui._links.delete(this._linkIndex);
this._linkIndex=void 0;return this}isValid(){return!this._textInvalid}hasValidText(){return!this._textInvalid&&0<this._lines.length&&0<this._lines[0].length}clearValid(){this._textInvalid&&(this._textInvalid=!1,this.invalidateBuffer());return this}validation(a){this._validation=a;return this}_validate(){if(this._validation){var a=this._getLine();a=this._validation(a);Array.isArray(a)&&0<a.length&&(this._textInvalid=!a[0],a[1]&&(this._uiBfr.textWidth(a[1])<this._maxTextWidthPixels()?this._lines[0]=
a[1]:this._textInvalid=!0))}else this._textInvalid=!1}_deactivate(){this._cursorOn=this.isOver=this._active=!1;this._validate();this._prevCsrIdx=this._currCsrIdx=this._getLine().length;this._textInvalid&&(this._prevCsrIdx=0);this.invalidateBuffer();this._nextActive=null}_activate(a){this._cursorOn=this._active=!0;setTimeout(()=>this._flashCursor(),550);this.invalidateBuffer();this._nextActive=this}_flashCursor(){this._active?(this._cursorOn=!this._cursorOn,setTimeout(()=>this._flashCursor(),550)):
this._cursorOn=!1;this.invalidateBuffer()}_activateNext(a){let b=this._gui._links,c;if(b){let d=this._linkIndex;do d+=a,c=b.get(d);while(c&&(!c.isEnabled||!c.isVisible));c?._activate();this._nextActive=c;this.invalidateBuffer()}}_getLine(){return 0<this._lines.length?this._lines[0].toString():""}_cursorX(a,b,c){return c&&0!=c?a.textWidth(b.substring(0,c)):0}_doKeyEvent(a){this._nextActive=this;let b=this._maxTextWidthPixels(),c=this._getLine(),d=this._prevCsrIdx!=this._currCsrIdx,e=!(!this._linkIndex||
d||0!=this._currCsrIdx),f=!!(this._linkIndex&&!d&&this._currCsrIdx>=c.length);if("keydown"==a.type){1==a.key.length&&(this._prevCsrIdx!=this._currCsrIdx&&(c=this._removeSelectedText(c)),c=c.substring(0,this._currCsrIdx)+a.key+c.substring(this._currCsrIdx),this._uiBfr.textWidth(c)<b&&(this._currCsrIdx++,this._prevCsrIdx++,this._lines[0]=c),this.invalidateBuffer());switch(a.key){case "ArrowLeft":e?(this._deactivate(),this._activateNext(-1),this.action({source:this,p5Event:a,value:this._getLine(),valid:!this._textInvalid})):
0<this._currCsrIdx&&(!a.shiftKey&&d?this._currCsrIdx=Math.min(this._currCsrIdx,this._prevCsrIdx):this._currCsrIdx--,a.shiftKey||(this._prevCsrIdx=this._currCsrIdx));break;case "ArrowRight":f?(this._deactivate(),this._activateNext(1),this.action({source:this,p5Event:a,value:this._getLine(),valid:!this._textInvalid})):this._currCsrIdx<=c.length&&(!a.shiftKey&&d?this._currCsrIdx=Math.max(this._currCsrIdx,this._prevCsrIdx):this._currCsrIdx++,a.shiftKey||(this._prevCsrIdx=this._currCsrIdx));break;case "ArrowUp":d||
(0!==this._linkOffset&&(this._deactivate(),this._activateNext(-this._linkOffset)),this.action({source:this,p5Event:a,value:this._getLine(),valid:!this._textInvalid}));break;case "ArrowDown":d||(0!==this._linkOffset&&(this._deactivate(),this._activateNext(this._linkOffset)),this.action({source:this,p5Event:a,value:this._getLine(),valid:!this._textInvalid}));break;case "Enter":this._deactivate();this.action({source:this,p5Event:a,value:this._getLine(),valid:!this._textInvalid});break;case "Backspace":this._prevCsrIdx!=
this._currCsrIdx?c=this._removeSelectedText(c):0<this._currCsrIdx&&(c=c.substring(0,this._currCsrIdx-1)+c.substring(this._currCsrIdx),this._currCsrIdx--,this._prevCsrIdx=this._currCsrIdx);this._lines[0]=c;break;case "Delete":this._prevCsrIdx!=this._currCsrIdx?c=this._removeSelectedText(c):this._currCsrIdx<c.length&&(c=c.substring(0,this._currCsrIdx)+c.substring(this._currCsrIdx+1)),this._lines[0]=c}this.invalidateBuffer()}return this._nextActive}_doEvent(a,b,c,d,e){switch(a.type){case "mousedown":case "touchstart":this._activate();
break;case "mousemove":case "touchmove":this.isOver=this==d.control,this._tooltip?._updateState(e),this.invalidateBuffer()}return this._nextActive}_maxTextWidthPixels(){let a=Number(this._textSize||this._gui.textSize());return this._w-2*this._gap-a/2}_removeSelectedText(a){let b=Math.min(this._prevCsrIdx,this._currCsrIdx),c=Math.max(this._prevCsrIdx,this._currCsrIdx);this._prevCsrIdx=this._currCsrIdx=b;return a.substring(0,b)+a.substring(c)}_updateControlVisual(){var a=Number(this._textSize||this._gui.textSize()),
b=this._textFont||this._gui.textFont(),c=this._textStyle||this._gui.textStyle();let d=this._scheme||this._gui.scheme(),e=this._getLine(),f=this._textInvalid,h=2*this._gap;const g=d.G_9,l=d.C_9,q=d.C_3;let m=d.C_1,p=d.C_9,k=this._uiBfr;k.push();k.textFont(b);k.textStyle(c);k.textSize(a);k.background(d.G_0);k.noStroke();this.isActive?this._currCsrIdx!=this._prevCsrIdx&&(b=this._cursorX(k,e,this._prevCsrIdx),c=this._cursorX(k,e,this._currCsrIdx),k.noStroke(),k.fill(q),k.rect(h+Math.min(b,c),1,Math.abs(b-
c),this._h-2)):(m=f?d.C_9:d.C_1,p=f?d.C_3:d.C_9,k.stroke(p),k.strokeWeight(1.5),k.fill(m),k.rect(0,0,this._w,this._h));k.fill(m);k.textSize(a);k.textAlign(this._p.LEFT,this._p.TOP);k.noStroke();k.fill(p);k.text(e,h,(this._h-a)/2);this._active&&this._cursorOn&&(a=this._cursorX(k,e,this._currCsrIdx),k.stroke(g),k.strokeWeight(1.5),k.line(h+a,4,h+a,this._h-5));this.isOver&&(k.stroke(l),k.strokeWeight(2),k.noFill(),k.rect(1,1,this._w-2,this._h-2,this._c[0],this._c[1],this._c[2],this._c[3]));this._enabled||
this._disable_hightlight(k,d,0,0,this._w,this._h);this._updateRectControlPB();k.pop();this._bufferInvalid=!1}}
...
4;k.push();k.strokeWeight(1);for(e=0;8>e;e++)k.line(f,0,d,0),k.rotate(p);k.pop();case "X4":f=this._pr0;d=this._pr1;p=Math.PI/2;k.push();k.strokeWeight(1.5);for(e=0;4>e;e++)k.line(f,0,d,0),k.rotate(p);k.pop()}k.stroke(h);k.strokeWeight(Math.max(3,.025*this._size));k.noFill();k.ellipse(0,0,2*this._pr1,2*this._pr1);k.fill(a);k.noStroke();k.ellipse(0,0,2*this._pr0,2*this._pr0);k.stroke(m);k.strokeWeight(.05*this._size);k.line(0,0,b,c);k.strokeWeight(2);k.stroke(g);this.isActive||this.isOver?k.fill(q):
...
final:!1}))),this.isOver=this==d.control,this._tooltip?._updateState(e),this.invalidateBuffer()}return this.isActive?this:null}_updateControlVisual(){var a=this._scheme||this._gui.scheme(),b=a.C_3,c=a.C_7;const d=a.C_8,e=a.C_3,f=a.C_9;var h=a.C_3,g=a.C_1,l=a.G_8;const q=a.G_2,m=a.T_1;a=this._uiBfr;a.clear();this._opaque&&(a.noStroke(),a.fill(b),a.rect(0,0,this._w,this._h,this._c[0],this._c[1],this._c[2],this._c[3]));b=this._turnArc;var p=(2*Math.PI-b)/2;let k=this._gRad,n=2*this._kRad,t=2*k;a.push();
a.translate(a.width/2,a.height/2);a.rotate(this._gapPos+p);a.noStroke();a.fill(h);a.ellipse(0,0,n,n);a.fill(g);a.arc(0,0,n,n,0,this._turnArc);h=this._majorTicks*this._minorTicks;if(2<=h){g=this._tw;p=.65*g;a.stroke(l);l=b/h;a.push();a.strokeWeight(.9);for(let r=0;r<=h;r++)a.line(k,0,k+p,0),a.rotate(l);a.pop();h=this._majorTicks;if(2<=h){l=b/h;a.push();a.strokeWeight(1);for(p=0;p<=h;p++)a.line(k,0,k+g,0),a.rotate(l);a.pop()}a.noStroke();a.fill(m);a.arc(0,0,t+g,t+g,0,b);a.fill(q);a.arc(0,0,t+g,t+g,
