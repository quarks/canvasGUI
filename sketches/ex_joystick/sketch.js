...
function createJoysticks() {
    ...
    gui.joystick('js1', ...grid.cell(0, 0, 1, 1)).scheme('dark').opaque();
    gui.joystick('js2', ...grid.cell(2, 0, 1, 1)).scheme('light').opaque();
    gui.joystick('js3', ...grid.cell(4, 0, 1, 1)).scheme('blue').opaque();
    gui.joystick('js4', ...grid.cell(0, 2, 1, 1)).scheme('green').opaque();
    gui.joystick('js5', ...grid.cell(2, 2, 1, 1)).scheme('red').opaque();
    gui.joystick('js6', ...grid.cell(4, 2, 1, 1)).scheme('cyan').opaque();
    gui.joystick('js7', ...grid.cell(0, 4, 1, 1)).scheme('yellow').opaque();
    gui.joystick('js8', ...grid.cell(2, 4, 1, 1)).scheme('purple').opaque();
    gui.joystick('js9', ...grid.cell(4, 4, 1, 1)).scheme('orange').opaque();
    js = gui.joystick('js0', 40, 20, 160, 160)
        .setAction((info) => {
