...
export { CvsOption, CvsCheckbox, CvsSlider, CvsRanger, CvsButton, CvsLabel, CvsViewer };
export { CvsText, CvsTextIcon, CvsTextField, CvsJoystick, CvsKnob, GridLayout };
...
class CvsRanger extends CvsSlider {
    ...
    //     let mx = info[0];
    //     this._tIdx = this.isActive ? this._tIdx : this._over - 1;
    //     switch (e.type) {
    //         case 'mousedown':
    //         case 'touchstart':
    //             if (this._over > 0) {
...
class CvsButton extends CvsTextIcon {
    ...
    /** @hidden */
    _doEvent(e, x, y, picked) {
        // CLOG(`Mouse: ${e instanceof MouseEvent}      Touch: ${e instanceof TouchEvent}      `)
        // CLOG(`Mouse: ${e instanceof MouseEvent} `)
        switch (e.type) {
            case 'mousedown':
            case 'touchstart':
                this.isActive = true;
