...
class CvsScrollbar extends CvsBufferedControl {
    ...
    /** @hidden */ protected _dvalue: number;
    /** @hidden */ protected _used: number;
    /** @hidden */ protected _s_value: number;

    /** @hidden */ protected _inset: number;
    /** @hidden */ protected _trackWidth: number;
    /** @hidden */ protected _trackHeight: number;
    /** @hidden */ protected _thumbHeight: number;
    /** @hidden */ protected _minThumbWidth: number;
